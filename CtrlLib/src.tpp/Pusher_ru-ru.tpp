...
[s7;%% [*/ Возвратное значение]-|true when in pushed state.&]
[s3;%% &]
[s4; &]
[s5;:Pusher`:`:IsKeyPush`(`): [@(0.0.255) bool]_[* IsKeyPush]()&]
[s7;%% [*/ Возвратное значение]-|true when in pushed state initiated by keyboard.&]
[s3;%% &]
[s4; &]
...
[s7;%% [*C@3 fnt]-|Font.&]
[s7;%% [*/ Возвратное значение]-|`*this for method chaining.&]
[s3;%% &]
[s4; &]
