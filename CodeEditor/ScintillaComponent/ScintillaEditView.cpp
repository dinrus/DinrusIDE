...
LanguageNameInfo ScintillaEditView::_langNameInfoArray[L_EXTERNAL + 1] = {
    ...
    //
    {TEXT("normal"),        TEXT("Обычный текст"),      TEXT("Обычный текстовый файл"),                             L_TEXT,         "null"},
    {TEXT("php"),           TEXT("PHP"),                TEXT("Файл Препроцессора Гипертекста PHP"),             L_PHP,          "phpscript"},
    {TEXT("c"),             TEXT("C"),                  TEXT("Исходник Си"),                                  L_C,            "cpp"},
    {TEXT("cpp"),           TEXT("C++"),                TEXT("Исходник C++"),                               L_CPP,          "cpp"},
    {TEXT("cs"),            TEXT("C#"),                 TEXT("Исходник C#"),                                    L_CS,           "cpp"},
    {TEXT("objc"),          TEXT("Objective-C"),        TEXT("Исходник Objective-C"),                       L_OBJC,         "objc"},
    {TEXT("java"),          TEXT("Java"),               TEXT("Исходник Java"),                              L_JAVA,         "cpp"},
    {TEXT("rc"),            TEXT("RC"),                 TEXT("Файл ресурса Windows"),                            L_RC,           "cpp"},
    {TEXT("html"),          TEXT("HTML"),               TEXT("Hyper Text Markup Language"),             L_HTML,         "hypertext"},
    {TEXT("xml"),           TEXT("XML"),                TEXT("eXtensible Markup Language"),             L_XML,          "xml"},
    {TEXT("makefile"),      TEXT("Makefile"),           TEXT("Makefile"),                                       L_MAKEFILE,     "makefile"},
    {TEXT("pascal"),        TEXT("Pascal"),             TEXT("Исходник Pascal"),                                L_PASCAL,       "pascal"},
    ...
    {TEXT("udf"),           TEXT("udf"),                TEXT("Файл User Defined language"),                     L_USER,         "user"},
    {TEXT("asp"),           TEXT("ASP"),                TEXT("Файл Active Server Pages script"),                L_ASP,          "hypertext"},
    {TEXT("sql"),           TEXT("SQL"),                TEXT("Файл Structured Query Language"),                 L_SQL,          "sql"},
    {TEXT("vb"),            TEXT("Visual Basic"),       TEXT("Файл Visual Basic"),                              L_VB,           "vb"},
    {TEXT("javascript"),    TEXT("JavaScript"),         TEXT("Файл JavaScript"),                                L_JS,           "cpp"},
    {TEXT("css"),           TEXT("CSS"),                TEXT("Файл Cascade Style Sheets"),                      L_CSS,          "css"},
    {TEXT("perl"),          TEXT("Perl"),               TEXT("Исходник Perl"),                              L_PERL,         "perl"},
    {TEXT("python"),        TEXT("Python"),             TEXT("Файл Python"),                                    L_PYTHON,       "python"},
    {TEXT("lua"),           TEXT("Lua"),                TEXT("Исходник Lua"),                               L_LUA,          "lua"},
    {TEXT("tex"),           TEXT("TeX"),                TEXT("Файл TeX"),                                       L_TEX,          "tex"},
    {TEXT("fortran"),       TEXT("Fortran free form"),  TEXT("Исходник Fortran free form"),                 L_FORTRAN,      "fortran"},
    {TEXT("bash"),          TEXT("Shell"),              TEXT("Файл Unix script"),                               L_BASH,         "bash"},
    {TEXT("actionscript"),  TEXT("ActionScript"),       TEXT("Файл Flash ActionScript"),                        L_FLASH,        "cpp"},
    {TEXT("nsis"),          TEXT("NSIS"),               TEXT("Файл Nullsoft Scriptable Install System script"), L_NSIS,         "nsis"},
    {TEXT("tcl"),           TEXT("TCL"),                TEXT("Файл Tool Command Language"),                     L_TCL,          "tcl"},
    {TEXT("lisp"),          TEXT("Lisp"),               TEXT("Файл List Processing language"),                  L_LISP,         "lisp"},
    {TEXT("scheme"),        TEXT("Scheme"),             TEXT("Файл Scheme"),                                    L_SCHEME,       "lisp"},
    {TEXT("asm"),           TEXT("Assembly"),           TEXT("Исходник ассемблера"),                  L_ASM,          "asm"},
    {TEXT("diff"),          TEXT("Diff"),               TEXT("Файл Diff"),                                      L_DIFF,         "diff"},
    {TEXT("props"),         TEXT("Properties file"),    TEXT("Файл Properties"),                                L_PROPS,        "props"},
    {TEXT("postscript"),    TEXT("PostScript"),         TEXT("Файл PostScript"),                                L_PS,           "ps"},
    {TEXT("ruby"),          TEXT("Ruby"),               TEXT("Файл Ruby"),                                      L_RUBY,         "ruby"},
    {TEXT("smalltalk"),     TEXT("Smalltalk"),          TEXT("Файл Smalltalk"),                                 L_SMALLTALK,    "smalltalk"},
    {TEXT("vhdl"),          TEXT("VHDL"),               TEXT("Файл VHSIC Hardware Description Language"),       L_VHDL,         "vhdl"},
    {TEXT("kix"),           TEXT("KiXtart"),            TEXT("Файл KiXtart"),                                   L_KIX,          "kix"},
    {TEXT("autoit"),        TEXT("AutoIt"),             TEXT("AutoIt"),                                         L_AU3,          "au3"},
    {TEXT("caml"),          TEXT("CAML"),               TEXT("Categorical Abstract Machine Language"),          L_CAML,         "caml"},
    {TEXT("ada"),           TEXT("Ada"),                TEXT("Файл Ada"),                                       L_ADA,          "ada"},
    {TEXT("verilog"),       TEXT("Verilog"),            TEXT("Файл Verilog"),                                   L_VERILOG,      "verilog"},
    ...
    {TEXT("cmake"),         TEXT("CMake"),              TEXT("Файл CMake"),                                     L_CMAKE,        "cmake"},
    ...
    {TEXT("gui4cli"),       TEXT("Gui4Cli"),            TEXT("Файл Gui4Cli"),                                   L_GUI4CLI,      "gui4cli"},
    ...
    {TEXT("jsp"),           TEXT("JSP"),                TEXT("Файл JavaServer Pages script"),                   L_JSP,          "hypertext"},
    {TEXT("coffeescript"),  TEXT("CoffeeScript"),       TEXT("Файл CoffeeScript"),                              L_COFFEESCRIPT, "coffeescript"},
    {TEXT("json"),          TEXT("json"),               TEXT("Файл JSON"),                                      L_JSON,         "json"},
    {TEXT("javascript.js"), TEXT("JavaScript"),         TEXT("Файл JavaScript"),                                L_JAVASCRIPT,   "cpp"},
    {TEXT("fortran77"),     TEXT("Fortran fixed form"), TEXT("Исходник Fortran fixed form"),                    L_FORTRAN_77,   "f77"},
    {TEXT("baanc"),         TEXT("BaanC"),              TEXT("Файл BaanC"),                                     L_BAANC,        "baan"},
    ...
    {TEXT("swift"),         TEXT("Swift"),              TEXT("Файл Swift"),                                     L_SWIFT,        "cpp"},
    {TEXT("asn1"),          TEXT("ASN.1"),              TEXT("Файл Abstract Syntax Notation One"),              L_ASN1,         "asn1"},
    {TEXT("avs"),           TEXT("AviSynth"),           TEXT("Файл AviSynth scripts"),                          L_AVS,          "avs"},
    {TEXT("blitzbasic"),    TEXT("BlitzBasic"),         TEXT("Файл BlitzBasic"),                                L_BLITZBASIC,   "blitzbasic"},
    {TEXT("purebasic"),     TEXT("PureBasic"),          TEXT("Файл PureBasic"),                                 L_PUREBASIC,    "purebasic"},
    {TEXT("freebasic"),     TEXT("FreeBasic"),          TEXT("Файл FreeBasic"),                                 L_FREEBASIC,    "freebasic"},
    {TEXT("csound"),        TEXT("Csound"),             TEXT("Файл Csound"),                                    L_CSOUND,       "csound"},
    {TEXT("erlang"),        TEXT("Erlang"),             TEXT("Файл Erlang"),                                    L_ERLANG,       "erlang"},
    {TEXT("escript"),       TEXT("ESCRIPT"),            TEXT("Файл ESCRIPT"),                                   L_ESCRIPT,      "escript"},
    {TEXT("forth"),         TEXT("Forth"),              TEXT("Файл Forth"),                                     L_FORTH,        "forth"},
    {TEXT("latex"),         TEXT("LaTeX"),              TEXT("Файл LaTeX"),                                     L_LATEX,        "latex"},
    {TEXT("mmixal"),        TEXT("MMIXAL"),             TEXT("Файл MMIXAL"),                                    L_MMIXAL,       "mmixal"},
    {TEXT("nim"),           TEXT("Nim"),                TEXT("Файл Nim"),                                       L_NIM,          "nimrod"},
    {TEXT("nncrontab"),     TEXT("Nncrontab"),          TEXT("extended crontab file"),                          L_NNCRONTAB,    "nncrontab"},
    {TEXT("oscript"),       TEXT("OScript"),            TEXT("Исходник OScript"),                           L_OSCRIPT,      "oscript"},
    {TEXT("rebol"),         TEXT("REBOL"),              TEXT("Файл REBOL"),                                     L_REBOL,        "rebol"},
    {TEXT("registry"),      TEXT("registry"),           TEXT("Файл registry"),                                  L_REGISTRY,     "registry"},
    {TEXT("rust"),          TEXT("Rust"),               TEXT("Файл Rust"),                                      L_RUST,         "rust"},
    {TEXT("spice"),         TEXT("Spice"),              TEXT("Файл spice"),                                     L_SPICE,        "spice"},
    {TEXT("txt2tags"),      TEXT("txt2tags"),           TEXT("Файл txt2tags"),                                  L_TXT2TAGS,     "txt2tags"},
    {TEXT("visualprolog"),  TEXT("Visual Prolog"),      TEXT("Файл Visual Prolog"),                             L_VISUALPROLOG, "visualprolog"},
    {TEXT("typescript"),    TEXT("TypeScript"),         TEXT("Файл TypeScript"),                                L_TYPESCRIPT,   "cpp"},
        ...
        case WM_IME_REQUEST:
        {
            ...
            if (wParam == IMR_RECONVERTSTRING)
            {
                ...
                else
                {
                    ...
                    // are char values, that is, character counts. The members dwStrOffset,
...
void ScintillaEditView::setSpecialStyle(const Style & styleToSet)
{
    ...
    if (!styleToSet._fontName.IsEmpty())
    {
...
void ScintillaEditView::setStyle(Style styleToSet)
{
    ...
    if (go.isEnable())
    {
        ...
        if (pStyle)
        {
            ...
            if (go.enableFont && !pStyle->_fontName.IsEmpty())
...
void ScintillaEditView::setXmlLexer(LangType type)
{
    ...
    else if ((type == L_HTML) || (type == L_PHP) || (type == L_ASP) || (type == L_JSP))
    {
        ...
        const char *htmlKeyWords_generic = NppParameters::getInstance().getWordList(L_HTML, LANG_INDEX_INSTR);
...
void ScintillaEditView::setEmbeddedJSLexer()
{
    ...
    {
        basic_string<wchar> kwlW = pKwArray[LANG_INDEX_INSTR];
...
void ScintillaEditView::setUserLexer(const char *userLangName)
{
    ...
    for (int i = 0 ; i < SCE_USER_KWLIST_TOTAL ; ++i)
    {
        ...
        {
            execute(SCI_SETPROPERTY, reinterpret_cast<WPARAM>(globalMappper().setLexerMapper[i].Begin()), reinterpret_cast<LPARAM>(keyWords_char));
        }
    ...
    sprintf(intBuffer, "%" PRIuPTR, reinterpret_cast<uintptr_t>(userLangContainer->getName())); // use numeric value of char pointer
...
void ScintillaEditView::setExternalLexer(LangType typeDoc)
{
    ...
    if (!externalLexer.fnCL)
        return;
    ILexer5* iLex5 = externalLexer.fnCL(externalLexer._name.Begin());
    if (!iLex5)
        return;
    execute(SCI_SETILEXER, 0, reinterpret_cast<LPARAM>(iLex5));

    WcharMbcsConvertor& wmc = WcharMbcsConvertor::getInstance();
    const wchar* lexerNameW = wmc.char2wchar(externalLexer._name.Begin(), CP_ACP);
...
void ScintillaEditView::setCppLexer(LangType langType)
{
    ...
    {
        basic_string<wchar> kwlW = pKwArray[LANG_INDEX_TYPE];
...
void ScintillaEditView::setJsLexer()
{
    ...
    const char *newLexerName = ScintillaEditView::_langNameInfoArray[L_JAVASCRIPT]._langName;
    ...
    if (pNewStyler) // New js styler is available, so we can use it do more modern styling
    {
        ...
        if (pKwArray[LANG_INDEX_INSTR2])
        {
            basic_string<wchar> kwlW = pKwArray[LANG_INDEX_INSTR2];
    ...
    {
        const char *lexerName = ScintillaEditView::_langNameInfoArray[L_JS]._langName;
...
void ScintillaEditView::setObjCLexer(LangType langType)
{
    ...
    const char *doxygenKeyWordsW = NppParameters::getInstance().getWordList(L_CPP, LANG_INDEX_TYPE2);
    if (doxygenKeyWordsW)
    {
        doxygenKeyWordsString = wstring2string(doxygenKeyWordsW, CP_ACP);
    }
    const char *doxygenKeyWords = doxygenKeyWordsString.Begin();
...
void ScintillaEditView::setTypeScriptLexer()
{
    ...
    auto getKeywordList = [&pKwArray](const int i)
    {
        if (pKwArray[i])
        {
            basic_string<wchar> kwlW = pKwArray[i];
...
{
    const char * lexerName = ScintillaEditView::_langNameInfoArray[language]._langName;
    ...
    if (pStyler)
    {
        for (const Style & style : *pStyler)
        {
            ...
            if (keywordArray)
            {
                if ((style._keywordClass != STYLE_NOT_USED) && (!style._keywords.IsEmpty()))
                    keywordArray[style._keywordClass] = style._keywords.Begin();
            }
        }
    }
}
...
{
    execute(SCI_SETWORDCHARS, 0, reinterpret_cast<LPARAM>(_defaultCharList.Begin()));
}
...
void ScintillaEditView::addCustomWordChars()
{
    ...
    for (size_t i = 0; i < nppGUI._customWordChars.GetLength(); ++i)
    {
        ...
        for (size_t j = 0; j < _defaultCharList.GetLength(); ++j)
        {
...
void ScintillaEditView::setCRLF(long color)
{
    ...
    const wchar* cr = L"\x0d";
    const wchar* lf = L"\x0a";
...
void ScintillaEditView::defineDocType(LangType typeDoc)
{
    ...
    defaultIndicatorStyle._bgColor = Color(0x80, 0x00, 0xFF);
    pStyle = stylers.findByID(defaultIndicatorStyle._styleID);
    setSpecialIndicator(pStyle ? *pStyle : defaultIndicatorStyle);
    ...
    switch (typeDoc)
    {
        ...
        case L_ASCII :
        {
            ...
            SciBuffer * buf = MainFileManager.getBufferByID(_currentBufferID);
...
void ScintillaEditView::restoreCurrentPosPostStep()
{
    ...
    {
        // Abort the position restoring  process. SciBuffer topology may have changed
    ...
    else if (pos._offset > 0)
    {
        ...
        // SciBuffer update may be in progress (in case wrap is enabled)
    ...
    {
        // SciBuffer position is correct, and there is no scroll to apply
        _positionRestoreNeeded = false;
    }
}
...
void ScintillaEditView::activateBuffer(BufferID buffer, bool force)
{
    ...
    if (!force && buffer == _currentBuffer)
        return;
    SciBuffer * newBuf = MainFileManager.getBufferByID(buffer);
    ...
    // Note that the actual reference in the SciBuffer itself is NOT decreased, Notepad_plus does that if neccessary
...
void ScintillaEditView::bufferUpdated(SciBuffer * buffer, int mask)
{
...
String ScintillaEditView::getGenericTextAsString(size_t start, size_t end) const
{
    assert(end > start);
...
void ScintillaEditView::getGenericText(char *dest, size_t destlen, size_t start, size_t end) const
{
    ...
    size_t cp = execute(SCI_GETCODEPAGE);
    const char *destW = wmc.char2wchar(destA, cp);
...
void ScintillaEditView::getGenericText(char *dest, size_t destlen, size_t start, size_t end, intptr_t* mstart, intptr_t* mend) const
{
    ...
    getText(destA, start, end);
    size_t cp = execute(SCI_GETCODEPAGE)    ;
    const char *destW = wmc.char2wchar(destA, cp, mstart, mend);
    _tcsncpy_s(dest, destlen, destW, _TRUNCATE);
    delete [] destA;
}
...
char * ScintillaEditView::getGenericWordOnCaretPos(char * txt, int size)
{
    WcharMbcsConvertor& wmc = WcharMbcsConvertor::getInstance();
    size_t cp = execute(SCI_GETCODEPAGE);
    ...
    const char * txtW = wmc.char2wchar(txtA, cp);
...
char * ScintillaEditView::getGenericSelectedText(char * txt, int size, bool expand)
{
    WcharMbcsConvertor& wmc = WcharMbcsConvertor::getInstance();
    size_t cp = execute(SCI_GETCODEPAGE);
    char *txtA = new char[size + 1];
...
intptr_t ScintillaEditView::searchInTarget(const char * text2Find, size_t lenOfText2Find, size_t fromPos, size_t toPos) const
{
...
void ScintillaEditView::appandGenericText(const char * text2Append) const
{
    WcharMbcsConvertor& wmc = WcharMbcsConvertor::getInstance();
    size_t cp = execute(SCI_GETCODEPAGE);
...
void ScintillaEditView::addGenericText(const char * text2Append) const
{
    WcharMbcsConvertor& wmc = WcharMbcsConvertor::getInstance();
    size_t cp = execute(SCI_GETCODEPAGE);
    const char *text2AppendA =wmc.wchar2char(text2Append, cp);
...
void ScintillaEditView::addGenericText(const char * text2Append, intptr_t* mstart, intptr_t* mend) const
{
    WcharMbcsConvertor& wmc = WcharMbcsConvertor::getInstance();
    size_t cp = execute(SCI_GETCODEPAGE);
...
intptr_t ScintillaEditView::replaceTargetRegExMode(const char * re, intptr_t fromTargetPos, intptr_t toTargetPos) const
{
    if (fromTargetPos != -1 || toTargetPos != -1)
    {
        execute(SCI_SETTARGETRANGE, fromTargetPos, toTargetPos);
...
void ScintillaEditView::showAutoComletion(size_t lenEntered, const char* list)
{
    WcharMbcsConvertor& wmc = WcharMbcsConvertor::getInstance();
    size_t cp = execute(SCI_GETCODEPAGE);
...
void ScintillaEditView::showCallTip(size_t startPos, const char * def)
{
    WcharMbcsConvertor& wmc = WcharMbcsConvertor::getInstance();
    size_t cp = execute(SCI_GETCODEPAGE);
...
String ScintillaEditView::getLine(size_t lineNumber)
{
...
void ScintillaEditView::getLine(size_t lineNumber, char * line, size_t lineBufferLen)
{
    ...
    const char *lineW = wmc.char2wchar(lineA, cp);
...
void ScintillaEditView::performGlobalStyles()
{
    ...
    Color& selectColorBack = grey;
    Color& selectColorFore = black;
    ...
    Color& foldMarginColor = grey;
    Color& foldMarginHiColor = white;
    ...
    Color& bookmarkMarginColor = veryLiteGrey;
    ...
    Color& foldfgColor = white, foldbgColor = grey, activeFoldFgColor = red;
...
intptr_t ScintillaEditView::caseConvertRange(intptr_t start, intptr_t end, TextCase caseToConvert)
{
    ...
    {
        wchar *wideStr = new wchar[wideLen];  // not NUL terminated
...
void ScintillaEditView::changeCase(__inout wchar * const strWToConvert, const int & nbChars, const TextCase & caseToConvert) const
{
...
void ScintillaEditView::convertSelectedTextTo(const TextCase & caseToConvert)
{
    if (execute(SCI_GETSELECTIONS) > 1) // Multi-Selection || Column mode
    {
        ...
        bool reversed = !cmi.IsEmpty() && cmi.back()._selLpos < cmi.front()._selLpos;
...
void ScintillaEditView::columnReplace(ColumnModeInfos & cmi, const char *str)
{
...
void ScintillaEditView::notifyMarkers(SciBuffer * buf, bool isHide, size_t location, bool del)
{
...
void ScintillaEditView::insertNewLineBelowCurrentLine()
{
    ...
    if (current_line == line_count - 1)
    {
        ...
        appandGenericText(newline.Begin());
    }
    else
    {
        const auto eol_length = newline.GetLength();
...
void ScintillaEditView::sortLines(size_t fromLine, size_t toLine, ISorter* pSort)
{
    ...
    const String text = getGenericTextAsString(startPos, endPos);
    Vector<String> splitText = stringSplit(text, getEOLString());
    ...
    const Vector<String> sortedText = pSort->sort(splitText);
    String joined = stringJoin(sortedText, getEOLString());
    if (sortEntireDocument)
    {
        assert(joined.GetLength() == text.GetLength());
    }
    else
    {
        assert(joined.GetLength() + getEOLString().GetLength() == text.GetLength());
        joined += getEOLString();
    }
    if (text != joined)
    {
        replaceTarget(joined.Begin(), startPos, endPos);
    }
}
...
String ScintillaEditView::getEOLString()
{
...
void ScintillaEditView::markedTextToClipboard(int indiStyle, bool doAll /*= false*/)
{
    ...
    std::vector<std::pair<size_t, String>> styledVect;

    const String cr = TEXT("\r");
    const String lf = TEXT("\n");
    ...
    if (styledVect.size() > 0)
    {
        ...
        joined = joined.substr(delim.GetLength());
...
void ScintillaEditView::removeAnyDuplicateLines()
{
    ...
    const auto endPos = execute(SCI_POSITIONFROMLINE, toLine) + execute(SCI_LINELENGTH, toLine);
    const String text = getGenericTextAsString(startPos, endPos);
    Vector<String> linesVect = stringSplit(text, getEOLString());
    const size_t lineCount = execute(SCI_GETLINECOUNT);
    ...
    if (origSize != newSize)
    {
        String joined = stringJoin(linesVect, getEOLString());
        if (!doingEntireDocument)
        {
            joined += getEOLString();
        }
