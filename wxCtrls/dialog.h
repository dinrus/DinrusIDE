...
private:
    ...
    #include <wxCtrls/univ/dialog.h>
#else
    #if defined(__WXPALMOS__)
        #include <wxCtrls/palmos/dialog.h>
    #elif defined(__WXMSW__)
        #include <wxCtrls/msw/dialog.h>
    #elif defined(__WXMOTIF__)
        #include <wxCtrls/motif/dialog.h>
    #elif defined(__WXGTK20__)
        #include <wxCtrls/gtk/dialog.h>
    #elif defined(__WXGTK__)
        #include <wxCtrls/gtk1/dialog.h>
    #elif defined(__WXMAC__)
        #include <wxCtrls/mac/dialog.h>
    #elif defined(__WXCOCOA__)
        #include <wxCtrls/cocoa/dialog.h>
    #elif defined(__WXPM__)
        #include <wxCtrls/os2/dialog.h>
    #endif
#endif
