...
class АсинхРабота {
	...
	struct Imp {
		...
		проц        делай(Функция&& f, Арги&&... арги) { co.делай([=, this]() { ret = f(арги...); }); }
	...
	struct ImpVoid {
		...
		template<class Функция, class... Арги>
		проц        делай(Функция&& f, Арги&&... арги) { co.делай([=, this]() { f(арги...); }); }
		проц        дай()                            {}
		проц        подбери()                           {}
	};
...
public:
	...
	Функция прокси() const                     { return [=, this] (ТипыАрг... арги) { return (*this)(арги...); }; }
