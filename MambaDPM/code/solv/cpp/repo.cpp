...
namespace mamba::solv
{
    ...
    namespace aux
    {
        ...
        {
            return aux::ptr_to_strview(::repo_lookup_str(const_cast<::Repo*>(repo), SOLVID_META, key));
        }
    ...
    {
        return aux::repo_lookup_str(raw(), SOLVABLE_URL);
    }

    void ObjRepoView::set_url(raw_str_view str) const
    {
        return aux::repo_set_str(raw(), SOLVABLE_URL, str);
    }
    ...
    {
        return aux::repo_lookup_str(raw(), etag_key(raw()));
    }

    void ObjRepoView::set_etag(raw_str_view str) const
    {
        return aux::repo_set_str(raw(), etag_key(raw()), str);
    }
    ...
    {
        return aux::repo_lookup_str(raw(), mod_key(raw()));
    }

    void ObjRepoView::set_mod(raw_str_view str) const
    {
        return aux::repo_set_str(raw(), mod_key(raw()), str);
    }
    ...
    {
        return aux::repo_lookup_str(raw(), SOLVABLE_MEDIABASE);
    }

    void ObjRepoView::set_channel(raw_str_view str) const
    {
        return aux::repo_set_str(raw(), SOLVABLE_MEDIABASE, str);
    }
    ...
    {
        return aux::repo_lookup_str(raw(), SOLVABLE_MEDIADIR);
    }
    ...
    {
        return aux::repo_lookup_bool(raw(), pip_added_key(raw()));
    }

    void ObjRepoView::set_pip_added(bool b) const
    {
        return aux::repo_set_bool(raw(), pip_added_key(raw()), b);
    }

    auto ObjRepoViewConst::tool_version() const -> std::string_view
    {
        return aux::repo_lookup_str(raw(), REPOSITORY_TOOLVERSION);
    }

    void ObjRepoView::set_tool_version(raw_str_view str) const
    {
        return aux::repo_set_str(raw(), REPOSITORY_TOOLVERSION, str);
    }
    ...
    {
        return aux::repo_set_str(raw(), SOLVABLE_MEDIADIR, str);
    }
