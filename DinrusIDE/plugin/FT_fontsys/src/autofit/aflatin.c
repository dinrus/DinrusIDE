...
#define FT_COMPONENT  trace_aflatin
  ...
  /* найди segments and links, compute all stem widths, and initialize */
                                ...
                                FT_ULong         charcode )
  {
...

    {
      ...
      for ( dim = 0; dim < AF_DIMENSION_MAX; dim++ )
      {
        ...
        Ошибка = af_latin_hints_compute_segments( hints,
                                                 (AF_Dimension)dim );
        if ( Ошибка )
          goto Exit;
...
#define AF_LATIN_MAX_TEST_CHARACTERS  12
  ...
  /* найди all blue zones.  Flat segments give the reference points, */
  ...
  /* Adjust scaling значение, then scale and shift widths   */
                                ...
                                AF_Dimension   dim )
  {
    ...
    for ( seg = segments; seg < segment_limit; seg++ )
    {
      ...
      if ( !found )
      {
        ...
        Ошибка = af_axis_hints_new_edge( axis, seg->pos,
                                  ...
                                  AF_Dimension   dim )
  {
    ...
    Ошибка = af_latin_hints_compute_segments( hints, dim );
    if ( !Ошибка )
    {
      af_latin_hints_link_segments( hints, dim );

      Ошибка = af_latin_hints_compute_edges( hints, dim );
    }
                        ...
                        AF_LatinMetrics  metrics )
  {
...
#endif
    {
      Ошибка = af_latin_hints_detect_features( hints, AF_DIMENSION_HORZ );
      if ( Ошибка )
        goto Exit;
    }
    ...
    {
      Ошибка = af_latin_hints_detect_features( hints, AF_DIMENSION_VERT );
      if ( Ошибка )
        goto Exit;
