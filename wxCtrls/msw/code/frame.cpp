...
#include <wxCtrls/msw/private.h>
    ...
    #include <ole2.h>
    #include <aygshell.h>
    #include <wxCtrls/msw/winundef.h>
#endif

#include <wxCtrls/generic/statusbr.h>

#ifdef __WXUNIVERSAL__
    #include <wxCtrls/univ/theme.h>
    #include <wxCtrls/univ/colschem.h>
...
IMPLEMENT_DYNAMIC_CLASS_XTI(wxFrame, wxTopLevelWindow,<<wxCtrls//frame.h>)
...
bool wxFrame::HandlePaint()
{
    ...
    if ( ::GetUpdateRect(GetHwnd(), &rect, FALSE) )
    {
        ...
        if ( m_iconized )
        {
            ...
            MSWDefWindowProc(WM_ICONERASEBKGND, (WORD)(WXLPARAM)ps.hdc, 0L);
