...
[s2; Возвращает the minimum index of element equal to [%-*@3 x] or negative 
number if not found.&]
[s3; &]
[s4; &]
...
[s2; Возвращает element at index [%-*@3 i].&]
[s3; &]
[s4; &]
[s5;:SortedIndex`:`:GetCount`(`)const:%- [@(0.0.255) int]_[* GetCount]()_[@(0.0.255) const]&]
[s2; Возвращает the cound of elements.&]
[s3; &]
[s4; &]
...
onst]&]
[s2; Возвращает the last element.&]
[s3; &]
[s4; &]
