...
#include <plugin/boost/concept_archetype.hpp>
#include <plugin/boost/concept_check.hpp>
#include <plugin/boost/type_traits/is_enum.hpp>
#include <plugin/boost/type_traits/is_base_and_derived.hpp>
#include <plugin/boost/static_assert.hpp>
#ifndef BOOST_TEST_TR1_REGEX
#include <plugin/boost/regex.hpp>
#endif
#include <bitset>
#include <vector>
#include <ostream>
