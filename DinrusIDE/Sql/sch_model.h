...
#ifndef VAR_
#define VAR_(тип, x)               DOID(x) VAR(тип, x)
#endif
...
#ifndef COLUMN_
#define COLUMN_(тип, ctype, имя, width, prec)   DOID(имя) COLUMN(тип, ctype, имя, width, prec)
#endif
...
#define COLUMN_ARRAY_(тип, ctype, имя, width, prec, items) \
        DOID(имя) COLUMN_ARRAY(тип, ctype, имя, width, prec, items)
#endif
