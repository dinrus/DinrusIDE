...
#if wxUSE_TOOLBAR
    #include <wxCtrls/tbarbase.h>     // the base class for all toolbars

    #if defined(__WXUNIVERSAL__)
       #include <wxCtrls/univ/toolbar.h>
    #elif defined(__WXPALMOS__)
       #include <wxCtrls/palmos/toolbar.h>
    #elif defined(__WXMSW__) && (!defined(_WIN32_WCE) || (_WIN32_WCE >= 400 && !defined(__POCKETPC__) && !defined(__SMARTPHONE__)))
       #include <wxCtrls/msw/tbar95.h>
    #elif defined(__WXWINCE__)
       #include <wxCtrls/msw/wince/tbarwce.h>
    #elif defined(__WXMOTIF__)
       #include <wxCtrls/motif/toolbar.h>
    #elif defined(__WXGTK20__)
        #include <wxCtrls/gtk/tbargtk.h>
    #elif defined(__WXGTK__)
        #include <wxCtrls/gtk1/tbargtk.h>
    #elif defined(__WXMAC__)
       #include <wxCtrls/mac/toolbar.h>
    #elif defined(__WXCOCOA__)
       #include <wxCtrls/cocoa/toolbar.h>
    #elif defined(__WXPM__)
       #include <wxCtrls/os2/toolbar.h>
    #endif
#endif // wxUSE_TOOLBAR
