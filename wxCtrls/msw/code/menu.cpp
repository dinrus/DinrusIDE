...
#ifndef WX_PRECOMP
    #include <wxCtrls/msw/wrapcctl.h> // include <commctrl.h> "properly"
...
#include <wxCtrls/msw/wince/missing.h>
...
IMPLEMENT_DYNAMIC_CLASS_XTI(wxMenu, wxEvtHandler,<<wxCtrls//menu.h>)
...
IMPLEMENT_DYNAMIC_CLASS_XTI_CALLBACK(wxMenuBar, wxWindow ,<<wxCtrls//menu.h>,wxMenuBarStreamingCallback)

IMPLEMENT_DYNAMIC_CLASS_XTI(wxMenuInfo, wxObject , <wxCtrls/menu.h> )
...
bool wxMenu::DoInsertOrAppend(wxMenuItem *pItem, size_t pos)
{
    ...
    if ( submenu != NULL ) {
        ...
        id = (UINT)(WXLPARAM)submenu->GetHMenu();
...
void wxMenuBar::SetLabelTop(size_t pos, const wxString& label)
{
    ...
    if ( flagsOld & MF_POPUP )
    {
        ...
        flagsOld &= 0xff;
        id = (UINT)(WXLPARAM)::GetSubMenu((HMENU)m_hMenu, mswpos);
    }
    else
    {
        id = pos;
...
wxMenu *wxMenuBar::Replace(size_t pos, wxMenu *menu, const wxString& title)
{
...
#endif
    {
        ...
        if ( !::InsertMenu(GetHmenu(), (UINT)mswpos,
                           ...
                           (UINT)(WXLPARAM)GetHmenuOf(menu), title) )
        {
            wxLogLastError(wxT("InsertMenu"));
        }
