...
Вектор <Индекс<Ткст> > CSyntax::keyword;
Вектор <Индекс<Ткст> > CSyntax::имя;
Индекс<Ткст>           CSyntax::kw_upp;
...
void CSyntax::InitKeywords()
{
	...
	static const char *upp[] = {
		...
		"INTERLOCKED_", "INTERLOCKED", "ONCELOCK", "ONCELOCK_", "ИНИЦБЛОК", "ЭКЗИТБЛОК",
		"rval_", "rval_default", "size_t", "intptr_t", "uintptr_t", "ИНИЦИАЛИЗАТОР", "ИНИЦИАЛИЗУЙ",
		"hash_t",
		NULL
	};
	static const char *usc[] = {
		...
		"фн", "группа", "ctrl", "subctrl", "template", "enum_property",
		"raw", "int", "double", "Ткст", "bool",
		"устТекст", "Qtf", "Doc", "Шрифт", "Цвет", "macro",
		"true", "false", "namespace",
		NULL
	};
	static const char *usclib[] = {
		"Цвет", "Точка", "Размер", "Прям", "RectC",
		"StdFont", "Arial", "Roman", "Courier", "GetImageSize",
		"дайРазмТекста", "print", "чёрный", "серый", "светлоСерый",
		"белоСерый", "белый", "красный", "зелёный", "коричневый", "синий",
		"магента", "цыан", "жёлтый", "светлоКрасный", "светлоЗелёный", "светлоЖёлтый",
		"светлоСиний", "светлоМагента", "светлоЦыан", "SBlack", "SGray", "SLtGray",
	...
	static const char *css[] = {
		...
		"counter-reset", "cue-after", "cue-before", "cue", "cursor", "direction", "дисплей", "elevation", "empty-cells",
		"float", "font-family", "font-size", "font-style", "font-variant", "font-weight", "font", "height", "left",
		"letter-spacing", "line-height", "list-style-image", "list-style-position", "list-style-тип", "list-style",
		...
		"animation-iteration-count", "animation-имя", "animation-timing-function", "animation-play-state",
		"backface-visibility", "perspective", "perspective-origin", "transform", "transform-origin", "transform-style",
		"transition", "transition-property", "transition-duration", "transition-timing-function", "transition-delay",
		"box-sizing", "nav-down", "nav-Индекс", "nav-left", "nav-right", "nav-up", "outline-offset", "resize", "text-overflow",
	...
	static const char *cssn[] = {
		...
		"list-элт", "inline-block", "table", "inline-table", "table-row-группа", "table-header-группа",
		"table-footer-группа", "table-row", "table-column-группа", "table-column", "table-cell", "table-caption",
		...
		"georgian", "lower-alpha", "upper-alpha", "list-style-тип", "list-style-position", "list-style-image",
	...
	static const char *upp_macros[] = {
		"ИМЯ_КЛАССА", "THISBACK", "THISBACK1", "THISBACK2", "THISBACK3", "THISBACK4",
		"PTEBACK", "PTEBACK1", "PTEBACK2",  "PTEBACK3",  "PTEBACK4",
		"QUOTE", "XASSERT", "NEVER", "XNEVER", "CHECK", "XCHECK", "ПРОВЕРЬ", "ПРОВЕРЬ_",
	...
	static const char *sql_base[] = {
		"выдели", "Update", "вставь", "Delete", "From",
	...
	static const char *sql_func[] = {
		...
		"SqlMax", "SqlMin", "Sqlсумма", "Avg", "Stddev", "Variance",
		"Greatest", "Least", "преобразуйНабСим", "ConvertAscii",
	...
	static const char *sql_bool[] = {
		"SqlIsNull", "неПусто", "Like", "LikeUpperAscii", "NotLike", "Between",
	...
	static const char *sch[] = {
		...
		"PRIMARY_KEY", "Индекс", "PARTIAL_INDEX", "UNIQUE", "SQLDEFAULT", "REFERENCES", "REFERENCES_",
	...
	static const char *sql[] = {
		...
		"IN", "Индекс", "INITIALLY", "INNER", "INSERT", "INSTEAD", "INTERSECT", "INTO",
	...
	static const char *dinrus[] = {
		...
		"catch", "char", "char", "шим", "дим", "ткст", "шткст", "юткст", "class", "const", "continue",
	...
	LoadSyntax(cpp, upp); // Порядок here is important, must be the same as enum
...
{
	Индекс<Ткст>& ключ = keyword.добавь();
	while(*keywords)
		ключ.добавь(*keywords++);
	Индекс <Ткст>& nam = имя.добавь();
	while(*names)
		nam.добавь(*names++);
	return keyword.дайСчёт() - 1;
}
