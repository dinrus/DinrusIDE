...
/* Signed 64-bit тип formatter */
#define TIFF_INT64_FORMAT "%I64d"

/* Unsigned 64-bit тип formatter */
...
/* Define to `__inline__' or `__inline' if that's what the C compiler
   calls it, or to nothing if 'inline' is not supported under any имя.  */
#ifndef __cplusplus
# ifndef inline
