...
bool цпбММХ()        { проверьПроцессор(); return sHasMMX; }
bool цпбССЕ()        { проверьПроцессор(); return sHasSSE; }
bool цпбССЕ2()       { проверьПроцессор(); return sHasSSE2; }
bool цпбССЕ3()       { проверьПроцессор(); return sHasSSE3; }
bool цпбАВХ()        { проверьПроцессор(); return sHasAVX; }
bool цпбГипервизор() { проверьПроцессор(); return sHypervisor; }
...
void эндианРазворот(word *v, size_t count) ЭНДИАН_РАЗВОРОТ
void эндианРазворот(int16 *v, size_t count) ЭНДИАН_РАЗВОРОТ
void эндианРазворот(dword *v, size_t count) ЭНДИАН_РАЗВОРОТ
void эндианРазворот(int *v, size_t count) ЭНДИАН_РАЗВОРОТ
void эндианРазворот(int64 *v, size_t count) ЭНДИАН_РАЗВОРОТ
void эндианРазворот(uint64 *v, size_t count) ЭНДИАН_РАЗВОРОТ
