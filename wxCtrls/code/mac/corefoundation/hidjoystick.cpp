...
//---------------------------------------------------------------------------
    ...
    #include <wxCtrls/event.h>   //joystick wxEvents
    #include <wxCtrls/window.h>  //for wxWindow to "capture" joystick
#endif

#include <wxCtrls/joystick.h>    //...
#include <wxCtrls/thread.h>      //wxThread for polling thread/ wxCriticalSection

//private headers
#include <wxCtrls/mac/corefoundation/hid.h> //private mac hid stuff
