...
private:
    ...
    #include <wxCtrls/univ/radiobox.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/radiobox.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/radiobox.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/radiobox.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/radiobox.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/radiobox.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/radiobox.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/radiobox.h>
#elif defined(__WXPALMOS__)
    #include <wxCtrls/palmos/radiobox.h>
#endif
