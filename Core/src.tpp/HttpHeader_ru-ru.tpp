...
[s2;%RU-RU This simple structure simplifies parsing of HTTP request 
and response headers. It is also capable of parsing SCGI requests.&]
[s3;%RU-RU &]
[s4; &]
[s5;:HttpHeader`:`:first`_line: [_^String^ String]_[* first`_line]&]
[s2;%RU-RU The first line of request/response `- the content of this 
line is different for response and request.&]
[s3; &]
[s4; &]
[s5;:HttpHeader`:`:f3: [_^String^ String]_[* f1, f2, f3]&]
[s2;%RU-RU First, second and third part of the first line. Content 
is different for response and request.&]
[s3; &]
[s4; &]
[s5;:HttpHeader`:`:fields: [_^VectorMap^ VectorMap]<[_^String^ String], 
[_^String^ String]>_[* fields]&]
[s2;%RU-RU Http fields as key`-value pairs. Keys are converted to 
lower`-case. Note that the same key can be present multiple times.&]
[s3; &]
[s4; &]
[s5;:HttpHeader`:`:cookies: [_^VectorMap^ VectorMap]<[_^String^ String], 
[_^HttpCookie^ HttpCookie]>_[* cookies]&]
[s2;%RU-RU Set of http response http cookies (filled based on Set`-Cookie 
headers during parsing).&]
[s3; &]
[s4; &]
[s5;:HttpHeader`:`:scgi: [@(0.0.255) bool]_[* scgi]&]
[s2;%RU-RU Indicates that this header is a result of parsing scgi.&]
[s3; &]
[s4; &]
[s5;:HttpHeader`:`:operator`[`]`(const char`*`)const: [_^String^ String]_[* operator`[`]](
[@(0.0.255) const]_[@(0.0.255) char]_`*[*@3 id])_[@(0.0.255) const]&]
[s2;%RU-RU Возвращает the first http header field with 
key [%-*@3 id] (must be lower`-case) or empty string if such field 
is not present.&]
[s3;%RU-RU &]
[s4; &]
[s5;:HttpHeader`:`:GetCookie`(const char`*`)const: [_^String^ String]_[* GetCookie]([@(0.0.255) c
onst]_[@(0.0.255) char]_`*[*@3 id])_[@(0.0.255) const]&]
[s2;%RU-RU Возвращает the value of first cookie of response 
(set by Set`-Cookie) with name [%-*@3 id].&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Возвращает first line fields of http response.&]
[s3;%RU-RU &]
[s4; &]
...
header or 0 if not specified or header not yet loaded.&]
[s3; &]
[s4; &]
[s5;:HttpHeader`:`:Clear`(`): [@(0.0.255) void]_[* Clear]()&]
[s2;%RU-RU Clears data.&]
[s3; &]
[s4; &]
[s5;:HttpHeader`:`:ParseAdd`(const String`&`): [@(0.0.255) bool]_[* ParseAdd]([@(0.0.255) c
onst]_[_^String^ String][@(0.0.255) `&]_[*@3 hdrs])&]
[s2;%RU-RU Parses the header (all lines of header) into [* first`_line 
]and [* fields].&]
[s3;%RU-RU &]
[s4; &]
[s5;:HttpHeader`:`:Parse`(const String`&`): [@(0.0.255) bool]_[* Parse]([@(0.0.255) const]_
[_^String^ String][@(0.0.255) `&]_[*@3 hdrs])&]
[s2;%RU-RU Вызывает Clear and parses the header (all lines 
of header) into [* first`_line ]and [* fields].&]
[s3;%RU-RU &]
[s4; &]
[s5;:HttpHeader`:`:ParseSCGI`(const String`&`): [@(0.0.255) bool]_[* ParseSCGI]([@(0.0.255) c
onst]_[_^String^ String][@(0.0.255) `&]_[*@3 scgi`_hdr])&]
[s2;%RU-RU Parse SCGI header, resulting state is as if the header 
parsed was normal HTTP.&]
[s3;%RU-RU &]
[s4; &]
[s5;:HttpHeader`:`:Read`(TcpSocket`&`): [@(0.0.255) bool]_[* Read]([_^TcpSocket^ TcpSocket][@(0.0.255) `&
]_[*@3 socket])&]
[s2;%RU-RU Reads the header from [%-*@3 socket] and parses it. Method 
detects SCGI requests based on first character of request `- 
if it is a digit, SCGI is assumed and the header is parsed as 
SCGI.&]
[s3;%RU-RU &]
[s4; &]
