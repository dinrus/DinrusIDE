...
class СоединениеФтп: Telnet 
{
    ...
    public т_мера размер(ткст путь, ПФорматФтп фмт = ПФорматФтп.образ);

    public проц тип(ПФорматФтп фмт) ;
    ...
    public проц помести(ткст путь, ткст локальн_файл,
            ХодФтп ход = пусто, ПФорматФтп фмт = ПФорматФтп.образ);

    /********************************************************************************
     Store данные из_ a поток on the сервер.
     
     Calling this function will change the текущ данные перемести фмт.
     ...
     фмт =          что фмт в_ шли the данные in
     ********************************************************************************/
    ...
    /**********************************************************************************
     ...
     ход =        a delegate в_ вызов with ход information
     фмт =          что фмт в_ читай the данные in
     **********************************************************************************/
