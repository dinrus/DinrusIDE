...
[*@4 T][@(0.0.255) `&]_[*@3 b])&]
[s2;%RU-RU Переворачивает зачения. Специфичные 
...
[s2;%RU-RU Переворачивает значения, на которые 
...
[s2;%RU-RU Возращает 1, если  [%-*@3 a]. больше 
...
][*@3 b][%RU-RU , `-1, если ][*@3 a][%RU-RU  меньше ][*@3 b][%RU-RU  
и ноль, если ][*@3 a][%RU-RU  равно ][*@3 b.]&]
[s3;%RU-RU &]
[s4; &]
...
Например., если [%-*@3 pred] является std`::less, 
находит минимум. Если [%-*@3 r] пустой, 
возвращает `-1.&]
[s3;%RU-RU &]
[s4; &]
