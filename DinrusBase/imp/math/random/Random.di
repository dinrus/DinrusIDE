/*******************************************************************************
    ...
    $(UL
      ...
      $(LI  гамма distribued numbers uses a метод recently proposed by Marsaglia и
            ...
            My (Fawzi's) feeling is that the transformation в(x)=(1+d*x)^3 might lose
...
import rt.core.stdc.stdio:
    ...
    /// very simple statistal тест, mean внутри maxOffset, и maximum/минимум at least minmax/maxmin
