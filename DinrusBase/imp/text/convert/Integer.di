...
T[] фмт(T, U=дол) (T[] приёмн, U i, T[] фмт = пусто)
{return фмт!(T)(приёмн, cast(дол) i, фмт);}

T[] фмт(T) (T[] приёмн, дол i, T[] фмт = пусто)
{
        сим    пре,
                тип;
        цел     ширина;
...
/******************************************************************************
        ...
        Для мейнстримного применения больше подойдёт фмт().
