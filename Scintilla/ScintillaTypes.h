 ...
 ** Типы, используемые для коммуникации с Scintilla.
 **/
...
// Функции для манипуляции полями из MarkerOutline

inline int operator<<(int i, MarkerOutline marker) noexcept {
	return i << static_cast<int>(marker);
}

// Функции для манипуляции полями из FindOption
...
// Функции для получения и манипуляции полями из FoldLevel
...
// Функции для манипуляции полями из FoldFlag
...
// Функции для манипуляции полями из FontQuality
...
// Функции для манипуляции полями из DocumentOption
...
// Функции для манипуляции полями из CaretPolicy
...
// Функции для манипуляции полями из CaretStyle
...
// Функции для манипуляции полями из LineEndType
...
// Функции для манипуляции полями из RepresentationAppearance
...
// Функции для манипуляции полями из LineCharacterIndexType
...
// Функции для манипуляции полями из ModificationFlags
...
// Тестирует на наличие у значения класса-перечня  битфлага(-ов) тестового набора.
template <typename T>
