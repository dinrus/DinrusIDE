...
using namespace ДинрусРНЦП;

struct f32x4 {
	float32x4_t данные;

	f32x4& грузи(const ук укз)   { данные = vld1q_f32((float *)укз); return *this; }
	f32x4& Load64(const ук укз) { данные = vcombine_f32(vld1_f32((float *)укз), vdup_n_f32(0)); return *this; }
	f32x4& Load32(const ук укз) { данные = vsetq_lane_f32(*(float *)укз, vdupq_n_f32(0), 0); return *this; }
	...
	f32x4(дво f)              { данные = vsetq_lane_f32((float)f, vdupq_n_f32(0), 0); }
	f32x4(float f)               { данные = vsetq_lane_f32((float)f, vdupq_n_f32(0), 0); }
	f32x4(цел f)                 { данные = vsetq_lane_f32((float)f, vdupq_n_f32(0), 0); }
...
force_inline f32x4  f32all(дво f) { return vdupq_n_f32((float)f); }
...
force_inline бул   AllTrue(uint32x4_t v) {
    uint32x2_t tmp = vand_u32(vget_low_u32(v), vget_high_u32(v));
    return vget_lane_u32(vpmin_u32(tmp, tmp), 0) == 0xffffffff;;
}

force_inline бул   AllTrue(f32x4 a) {
	return AllTrue(vreinterpretq_u32_f32(a));
}

force_inline f32x4 мин(f32x4 a, f32x4 b)          { return vminq_f32(a, b); }
force_inline f32x4 макс(f32x4 a, f32x4 b)          { return vmaxq_f32(a, b); }
...
struct i16x8 { // 8xint16
	...
	i16x8& грузи(const ук укз)   { данные = vld1q_s16((int16_t *)укз); return *this; }
	i16x8& Load64(const ук укз) { данные = vcombine_s16(vld1_s16((int16_t *)укз), vdup_n_s16(0)); return *this; }
	i16x8& Load32(const ук укз) { данные = vreinterpretq_s16_s32(vsetq_lane_s32(*(int32_t *)укз, vdupq_n_s32(0), 0)); return *this; }
...
force_inline i16x8  i16all(цел v)                  { return vdupq_n_s16(v); }
...
force_inline i16x8  operator>>(i16x8 a, цел b)     { return vreinterpretq_s16_u16(vshlq_u16(vreinterpretq_u16_s16(a), vdupq_n_s16(-b))); }
force_inline i16x8& operator>>=(i16x8& a, цел b)   { return a = a >> b; }
force_inline i16x8  operator<<(i16x8 a, цел b)     { return vshlq_s16(a, vdupq_n_s16(b)); }
force_inline i16x8& operator<<=(i16x8& a, цел b)   { return a = a << b; }
...
force_inline бул   AllTrue(i16x8 a) {
...
struct i32x4 { // 4xint32
	...
	i32x4& грузи(const ук укз)   { данные = vld1q_s32((int32_t *)укз); return *this; }
	i32x4& Load64(const ук укз) { данные = vcombine_s32(vld1_s32((int32_t *)укз), vdup_n_s32(0)); return *this; }
	i32x4& Load32(const ук укз) { данные = vsetq_lane_s32(*(int32_t *)укз, vdupq_n_s32(0), 0); return *this; }
...
force_inline i32x4  i32all(цел v)                 { return vdupq_n_s32(v); }
...
force_inline i32x4  operator>>(i32x4 a, цел b)     { return vshlq_s32(a, vdupq_n_s32(-b)); }
...
force_inline бул   AllTrue(i32x4 a) {
...
struct i8x16 { // 16*байт
	...
	i8x16& грузи(const ук укз)   { данные = vld1q_s8((int8_t *)укз); return *this; }
	i8x16& Load64(const ук укз) { данные = vcombine_s8(vld1_s8((int8_t *)укз), vdup_n_s8(0)); return *this; }
	i8x16& Load32(const ук укз) { данные = vreinterpretq_s8_s32(vsetq_lane_s32(*(int32_t *)укз, vdupq_n_s32(0), 0)); return *this; }
...
force_inline i8x16  i8all(цел v)                  { return vdupq_n_s8(v); }
...
force_inline i16x8 Unpack8L(i16x8 a)              { return vzipq_s8(vreinterpretq_s8_s16(a), vdupq_n_s8(0)).знач[0]; }
force_inline i16x8 Unpack8H(i16x8 a)              { return vzipq_s8(vreinterpretq_s8_s16(a), vdupq_n_s8(0)).знач[1]; }

force_inline i32x4 Unpack16L(i16x8 a)             { return vzipq_s16(a, vdupq_n_s16(0)).знач[0]; }
force_inline i32x4 Unpack16H(i16x8 a)             { return vzipq_s16(a, vdupq_n_s16(0)).знач[1]; }

force_inline i8x16 пакуй16(i16x8 l, i16x8 h)       { return vreinterpretq_s8_u8(vcombine_u8(vqmovun_s16(l), vqmovun_s16(h))); }
force_inline i8x16 пакуй16(i16x8 l)                { return vreinterpretq_s8_u8(vcombine_u8(vqmovun_s16(l), vdup_n_u8(0))); }
...
force_inline i16x8 i64all(qword данные)             { return vreinterpretq_s16_u64(vdupq_n_u64(данные)); }
