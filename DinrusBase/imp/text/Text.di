/*******************************************************************************
        ...
        class Текст(T) : ТекстОбзор!(T)
        {
                ...
                // фмт аргументы behind текущ выделение
                Текст фмт (T[] фмт, ...);
...
class Текст(T) : ТекстОбзор!(T)
{
    ...
    ***********************************************************************/
    ...
    final Текст фмт (T[] фмт, ...)
    {
        ...
        ШВыкладка.экземпляр.преобразуй (&излей, _arguments, _argptr, фмт);
        return this;
    }
    ...
    ***********************************************************************/
    ...
    {
        T[64] врем =void;
        return добавь (Целое.фмт(врем, знач, фмт));
    }
    ...
    ***********************************************************************/
    ...
    {
        T[64] врем =void;
        return добавь (Float.фмт(врем, знач, десятки, e));
    }
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            контент. The срез is clИПped в_ the минимум of either
...
class ТекстОбзор(T) : ЮниТекст
{
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            срез is clИПped в_ the минимум of either the length
...
debug (UnitTest)
{
    ...
    unittest
    {
        ...
        assert (s.очисть.фмт("{:f4}", 1.2345) == "1.2345");

        assert (s.очисть.фмт("{:b}", 0xf0) == "11110000");
