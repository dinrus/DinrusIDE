...
//#define EnumTaskWindows(в, f, p) EnumThreadWindows((DWORD)в, f, p)
//#define PostAppMessageA(t, m, ш, l) PostThreadMessageA((DWORD)t, m, ш, l)
//#define PostAppMessageW(t, m, ш, l) PostThreadMessageW((DWORD)t, m, ш, l)
//#define GetSysModalWindow() (NULL)
//#define SetSysModalWindow(в) (NULL)
//#define GetWindowTask(hWnd) ((HANDLE)GetWindowThreadProcessId(hWnd, NULL))
//#define DefHookProc(c, p, lp, в) CallNextHookEx((HHOOK)*в, c, p, lp)
...
HWND CreateDialogA(HINSTANCE в, LPCSTR n, HWND ш, DLGPROC f)
{
	return CreateDialogParamA(в, n, ш, f, 0);
}

HWND CreateDialogW(HINSTANCE в, LPCWSTR n, HWND ш, DLGPROC f)
{
	return CreateDialogParamW(в, n, ш, f, 0);
}

HWND CreateDialogIndirectA(HINSTANCE в, LPCDLGTEMPLATE t, HWND ш , DLGPROC f)
{
	return CreateDialogIndirectParamA(в, t, ш, f, 0);
}

HWND CreateDialogIndirectW(HINSTANCE в, LPCDLGTEMPLATE t, HWND ш , DLGPROC f)
{
	return CreateDialogIndirectParamW(в, t, ш, f, 0);
}


HWND CreateWindowA(LPCSTR a, LPCSTR b, DWORD c, int d, int e, int f, int g, HWND в, HMENU i, HINSTANCE j, LPVOID k)
{
	return CreateWindowExA(0, a, b, c, d, e, f, g, в, i, j, k);
}

HWND CreateWindowW(LPCWSTR a, LPCWSTR b, DWORD c, int d, int e, int f, int g, HWND в, HMENU i, HINSTANCE j, LPVOID k)
{
	return CreateWindowExW(0, a, b, c, d, e, f, g, в, i, j, k);
}
