...
#include <plugin/boost/exception/exception.hpp>
#include <plugin/boost/exception/info.hpp>
#include <plugin/boost/exception/diagnostic_information.hpp>
#ifndef BOOST_NO_EXCEPTIONS
#   include <plugin/boost/exception/detail/clone_current_exception.hpp>
#endif
#include <plugin/boost/exception/detail/type_info.hpp>
#ifndef BOOST_NO_RTTI
#include <plugin/boost/core/demangle.hpp>
#endif
#include <plugin/boost/shared_ptr.hpp>
#include <plugin/boost/make_shared.hpp>
#include <stdexcept>
#include <new>
#include <ios>
#include <stdlib.h>
