...
#include <wxCtrls/treebase.h>
#include <wxCtrls/textctrl.h> // wxTextCtrl::ms_classinfo used through CLASSINFO macro
...
// ----------------------------------------------------------------------------
    ...
    #include <wxCtrls/generic/treectlg.h>
#elif defined(__WXPALMOS__)
    #include <wxCtrls/palmos/treectrl.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/treectrl.h>
