...
#	Ошибка "GLM_MODEL undefined, your compiler may not be supported by GLM. добавь #define GLM_MODEL 0 to ignore this message."
#endif//GLM_MODEL
...
#	define GLM_ALIGNED_TYPEDEF(тип, имя, alignment) typedef __declspec(align(alignment)) тип имя
#elif GLM_COMPILER & (GLM_COMPILER_GCC | GLM_COMPILER_CLANG | GLM_COMPILER_INTEL)
#	define GLM_DEPRECATED __attribute__((__deprecated__))
#	define GLM_ALIGNED_TYPEDEF(тип, имя, alignment) typedef тип имя __attribute__((aligned(alignment)))
#elif GLM_COMPILER & GLM_COMPILER_CUDA
#	define GLM_DEPRECATED
#	define GLM_ALIGNED_TYPEDEF(тип, имя, alignment) typedef тип имя __align__(x)
#else
#	define GLM_DEPRECATED
#	define GLM_ALIGNED_TYPEDEF(тип, имя, alignment) typedef тип имя
#endif
...
///////////////////////////////////////////////////////////////////////////////////
// длина тип: all length functions returns a length_t тип.
...
namespace detail
{
	...
	{
		typedef unsigned char тип;
	};

	template<>
	struct make_unsigned<short>
	{
		typedef unsigned short тип;
	};

	template<>
	struct make_unsigned<int>
	{
		typedef unsigned int тип;
	};

	template<>
	struct make_unsigned<long>
	{
		typedef unsigned long тип;
	};
...
///////////////////////////////////////////////////////////////////////////////////
// Only use x, y, z, w as vector тип components
...
#	Ошибка "GLM Ошибка: A different version of GLM is already included. Define GLM_FORCE_IGNORE_VERSION before including GLM headers to ignore this Ошибка."
...
#	if defined GLM_FORCE_XYZW_ONLY
#		pragma message("GLM: GLM_FORCE_XYZW_ONLY is defined. Only x, y, z and w component are available in vector тип. This define disables swizzle operators and SIMD instruction sets.")
#	endif
...
#		pragma message("GLM: GLM_FORCE_SWIZZLE is defined, swizzling functions enabled. вкл compiler C++ language extensions to enable swizzle operators.")
#	else
