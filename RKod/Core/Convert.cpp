...
ПреобрДво::ПреобрДво(double минзнач, double максзнач, bool notnull)
...
ПреобрДату::ПреобрДату(Дата минзнач, Дата максзнач, bool notnull)
: минзнач(минзнач), максзнач(максзнач), notnull(notnull) {
	defaultval = Null;
}
...
ПреобрВремя::ПреобрВремя(Время минзнач, Время максзнач, bool notnull)
