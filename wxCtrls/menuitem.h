...
#include <wxCtrls/object.h>  // base class
...
// ----------------------------------------------------------------------------
    ...
    #include <wxCtrls/univ/menuitem.h>
#elif defined(__WXPALMOS__)
    #include <wxCtrls/palmos/menuitem.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/menuitem.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/menuitem.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/menuitem.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/menuitem.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/menuitem.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/menuitem.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/menuitem.h>
#endif
