...
struct DlgInfo
{
	...
	DlgInfo(Window *dlg, const char *name, const char *internalName = TEXT("")): _dlg(dlg), _name(name), _internalName(internalName) {};
};
...
public :
	...
	void renameTab(size_t index, const char *newName);
