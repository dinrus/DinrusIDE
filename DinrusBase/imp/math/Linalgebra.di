...
$(UL
    ...
    $(LI Под матрицы Helix используется column-major memory layout. Т.е. матрица
        ...
        в памяти выглядит как: a, d, g, b, e, в, c, f, i. Порядок этот аналогичен порядку в
...
private template ЛинейнаяАлгебра(т_плав)
{
    ...
    *************************************************************************************/
    struct Вектор4
    {
        ...
        ------------
        */
        static Вектор4 opCall(т_плав x, т_плав y, т_плав z, т_плав ш)
        {
            Вектор4 знач;
            знач.установи(x, y, z, ш);
            return знач;
        }

        /** описано */
        static Вектор4 opCall(Вектор3 xyz, т_плав ш)
        {
            Вектор4 знач;
            знач.установи(xyz, ш);
            return знач;
        ...
        проц установи(т_плав x, т_плав y, т_плав z, т_плав ш)
        {
            this.x = x;
            this.y = y;
            this.z = z;
        ...
        /** описано */
        проц установи(Вектор3 xyz, т_плав ш)
        {
            this.x = xyz.x;
            this.y = xyz.y;
            this.z = xyz.z;
        ...
        */
        ...
        {
            реал n = нормаль;
            return Вектор4(x / n, y / n, z / n, ш / n);
        }
        ...
        */
        Орт доминирующаяОсь()
        {
            ...
            {
                if (x > z)
                    return (x > ш) ? Орт.X : Орт.W;
                else
                    return (z > ш) ? Орт.Z : Орт.W;
            }
            else
            {
                if (y > z)
                    return (y > ш) ? Орт.Y : Орт.W;
                else
                    return (z > ш) ? Орт.Z : Орт.W;
            }
        }
        ...
        бул нормален_ли()
        {
            return stdrus.нормален_ли(x) && stdrus.нормален_ли(y) && stdrus.нормален_ли(z) && stdrus.нормален_ли(ш);
        }
        ...
        */
        ...
        {
            return x == знач.x && y == знач.y && z == знач.z && ш == знач.ш;
        }

        /** описано */
        Вектор4 opNeg()
        {
            return Вектор4(-x, -y, -z, -ш);
        }

        /** описано */
        Вектор4 opAdd(Вектор4 знач)
        {
            return Вектор4(x + знач.x, y + знач.y, z + знач.z, ш + знач.ш);
        }
        ...
        {
            return Вектор4(x * ключ, y * ключ, z * ключ, ш * ключ);
        }
        ...
        Вектор4п вВектор4п()
        {
            return Вектор4п(cast(плав)x, cast(плав)y, cast(плав)z, cast(плав)ш);
        }

        /** Возвращает: Copy of this вектор with дво type components */
        Вектор4д вВектор4д()
        {
            return Вектор4д(cast(дво)x, cast(дво)y, cast(дво)z, cast(дво)ш);
        }

        /** Возвращает: Copy of this вектор with реал type components */
        Вектор4р вВектор4р()
        {
            return Вектор4р(cast(реал)x, cast(реал)y, cast(реал)z, cast(реал)ш);
        }
    ...
    public
    {
        ...
        {
            return a.x * b.x + a.y * b.y + a.z * b.z + a.ш * b.ш;
        }

        /** Возвращает: Outer product between passed vectors. */
        Матрица44 внешн(Вектор4 a, Вектор4 b)
        {
            return Матрица44( a.x * b.x,  a.x * b.y,  a.x * b.z, a.x * b.ш,
            a.y * b.x,  a.y * b.y,  a.y * b.z, a.y * b.ш,
            a.z * b.x,  a.z * b.y,  a.z * b.z, a.z * b.ш,
            a.ш * b.x,  a.ш * b.y,  a.ш * b.z, a.ш * b.ш);
        }
    ...
    *************************************************************************************/
    struct Кватернион
    {
        ...
        static Кватернион нч = { x: т_плав.nan, y: т_плав.nan, z: т_плав.nan, ш: т_плав.nan };
        ...
        ------------
        */
        static Кватернион opCall(т_плав x, т_плав y, т_плав z, т_плав ш)
        {
            Кватернион q;
            q.установи(x, y, z, ш);
            return q;
        ...
        */
        ...
        body
        {
            ...
            if ( след > 0 )
            {
                // |ш| > 1/2, may as well choose ш > 1/2
        ...
        Order of _rotation application is: roll (Z ось), питч (X ось), yaw (Y ось).
        */
        static Кватернион вращение(т_плав yaw, т_плав питч, т_плав roll)
        {
            return Кватернион.вращИгрек(yaw) * Кватернион.вращИкс(питч) * Кватернион.вращЗэт(roll);
        }
        ...
        */
        ...
        Кватернион нормализованный()
        {
            т_плав n = нормаль();
            assert( больше(n, 0) );
            return Кватернион(x / n, y / n, z / n, ш / n);
        }
        ...
        */
        реал yaw()
        {
            return атан2(2 * (ш*y + x*z), ш*ш - x*x - y*y + z*z);
        }

        /** описано */
        реал питч()
        {
            return асин(2 * (ш*x - y*z));
        }

        /** описано */
        реал roll()
        {
            return атан2(2 * (ш*z + x*y), ш*ш - x*x + y*y - z*z);
        }
        ...
        */
        ...
        {
            return x == q.x && y == q.y && z == q.z && ш == q.ш;
        }

        /** описано */
        Кватернион opNeg()
        {
            return Кватернион(-x, -y, -z, -ш);
        }

        /** описано */
        Кватернион opAdd(Кватернион q)
        {
            return Кватернион(x + q.x, y + q.y, z + q.z, ш + q.ш);
        }
        ...
        {
            return Кватернион(x * ключ, y * ключ, z * ключ, ш * ключ);
        }
        ...
        */
        ...
        {
            return Кватернион(
                       ш * q.x + x * q.ш + y * q.z - z * q.y,
                       ш * q.y + y * q.ш + z * q.x - x * q.z,
                       ш * q.z + z * q.ш + x * q.y - y * q.x,
                       ш * q.ш - x * q.x - y * q.y - z * q.z );
        }

        /** описано */
        проц opMulAssign(Кватернион q)
        {
            установи(ш * q.x + x * q.ш + y * q.z - z * q.y,
                             ш * q.y + y * q.ш + z * q.x - x * q.z,
                             ш * q.z + z * q.ш + x * q.y - y * q.x,
                             ш * q.ш - x * q.x - y * q.y - z * q.z );
        }
        ...
        {
            return Кватернионп(cast(плав)x, cast(плав)y, cast(плав)z, cast(плав)ш);
        }

        /** Возвращает: Copy of this вектор with дво type components. */
        Кватернионд вКватернионд()
        {
            return Кватернионд(cast(дво)x, cast(дво)y, cast(дво)z, cast(дво)ш);
        }

        /** Возвращает: Copy of this вектор with реал type components. */
        Кватернионр вКватернионр()
        {
            return Кватернионр(cast(реал)x, cast(реал)y, cast(реал)z, cast(реал)ш);
        }
    ...
    */
    ...
    {
        реал cosTheta = q0.x * q1.x + q0.y * q1.y + q0.z * q1.z + q0.ш * q1.ш;
    ...
    *************************************************************************************/
    struct Матрица33
    {
        ...
        */
        ...
        Order of _rotation application is: roll (Z ось), питч (X ось), yaw (Y ось).
        */
        static Матрица33 вращение(т_плав yaw, т_плав питч, т_плав roll)
        {
            return Матрица33.вращИгрек(yaw) * Матрица33.вращИкс(питч) * Матрица33.вращЗэт(roll);
        }
    ...
    *************************************************************************************/
    struct Матрица44
    {
        ...
        */
        ...
        Order of _rotation application is: roll (Z ось), питч (X ось), yaw (Y ось).
        */
        static Матрица44 вращение(т_плав yaw, т_плав питч, т_плав roll)
        {
            return Матрица44.вращИгрек(yaw) * Матрица44.вращИкс(питч) * Матрица44.вращЗэт(roll);
        }
        ...
        */
        ...
        Вектор3 is implicitl expanded to Вектор4 with ш=1.
        ...
        */
        ...
        {
            return Вектор4(знач.x * m00 + знач.y * m01 + знач.z * m02 + знач.ш * m03,
                                 знач.x * m10 + знач.y * m11 + знач.z * m12 + знач.ш * m13,
                                 знач.x * m20 + знач.y * m21 + знач.z * m22 + знач.ш * m23,
                                 знач.x * m30 + знач.y * m31 + знач.z * m32 + знач.ш * m33);
        }
...
unittest
{
    ...
    Кватернион q = Кватернион( Матрица33.вращение(yaw, питч, roll) );
    assert( равны(q.yaw, yaw) );
    assert( равны(q.питч, питч) );
