...
#include <wxCtrls/event.h>       // for the base class
#include <wxCtrls/build.h>
#include <wxCtrls/init.h>        // we must declare wxEntry()
...
// ----------------------------------------------------------------------------
        ...
        #include <wxCtrls/palmos/app.h>
    #elif defined(__WXMSW__)
        #include <wxCtrls/msw/app.h>
    #elif defined(__WXMOTIF__)
        #include <wxCtrls/motif/app.h>
    #elif defined(__WXMGL__)
        #include <wxCtrls/mgl/app.h>
    #elif defined(__WXDFB__)
        #include <wxCtrls/dfb/app.h>
    #elif defined(__WXGTK20__)
        #include <wxCtrls/gtk/app.h>
    #elif defined(__WXGTK__)
        #include <wxCtrls/gtk1/app.h>
    #elif defined(__WXX11__)
        #include <wxCtrls/x11/app.h>
    #elif defined(__WXMAC__)
        #include <wxCtrls/mac/app.h>
    #elif defined(__WXCOCOA__)
        #include <wxCtrls/cocoa/app.h>
    #elif defined(__WXPM__)
        #include <wxCtrls/os2/app.h>
    #endif
#else // !GUI
