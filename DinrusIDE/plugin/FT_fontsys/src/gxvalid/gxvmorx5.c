...
#define FT_COMPONENT  trace_gxvmorx
   ...
   * has формат of a StateTable with insertion-glyph-list
   * without имя.  However, the 32bit offset from the head
   * of subtable to the i-g-l is given after `entryTable',
   * without variable имя specification (the existence of
