 ...
 * data значение.  The encoding gives raw data, runs of
 * pixels, or pixel values encoded as a delta from the
 * previous pixel значение.  For the latter, either 2-bit
	...
	static const char module[] = "ThunderSetupDecode";
        ...
        if( tif->tif_dir.td_bitspersample != 4 )
        {
                TIFFErrorExt(tif->tif_clientdata, module,
                             "Wrong bitspersample значение (%d), Thunder decoder only supports 4bits per sample.",
