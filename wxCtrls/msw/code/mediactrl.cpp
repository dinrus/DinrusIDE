...
#include <wxCtrls/mediactrl.h>

#ifndef WX_PRECOMP
    #include <wxCtrls/log.h>
    #include <wxCtrls/dcclient.h>
    #include <wxCtrls/timer.h>
    #include <wxCtrls/math.h>        // log10 & pow
#endif

#include <wxCtrls/msw/private.h> // user info and wndproc setting/getting
...
//---------------------------------------------------------------------------
#include <wxCtrls/msw/ole/activex.h>
...
bool wxMCIMediaBackend::Play()
{
    ...
    playParms.dwCallback = (WXLPARAM)m_hNotifyWnd;

    bool bOK = (mciSendCommand(m_hDev, MCI_PLAY, MCI_NOTIFY,
                            (WXLPARAM)(LPVOID)&playParms) == 0);
...
#include <wxCtrls/html/forcelnk.h>
