...
protected:
    ...
    #include <wxCtrls/univ/button.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/button.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/button.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/button.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/button.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/button.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/button.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/button.h>
#elif defined(__WXPALMOS__)
    #include <wxCtrls/palmos/button.h>
#endif
