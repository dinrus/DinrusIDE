...
#  define BOOST_ABI_PREFIX <plugin/boost/config/abi/msvc_prefix.hpp>
#endif
#ifndef BOOST_ABI_SUFFIX
#  define BOOST_ABI_SUFFIX <plugin/boost/config/abi/msvc_suffix.hpp>
#endif
...
#include <plugin/boost/config/pragma_message.hpp>
