...
#include <wxCtrls/msw/glcanvas.h>
#elif defined(__WXMOTIF__)
#include <wxCtrls/x11/glcanvas.h>
#elif defined(__WXGTK20__)
#include <wxCtrls/gtk/glcanvas.h>
#elif defined(__WXGTK__)
#include <wxCtrls/gtk1/glcanvas.h>
#elif defined(__WXX11__)
#include <wxCtrls/x11/glcanvas.h>
#elif defined(__WXMAC__)
#include <wxCtrls/mac/glcanvas.h>
#elif defined(__WXCOCOA__)
#include <wxCtrls/cocoa/glcanvas.h>
#else
