...
public:
/**
 * Find the минимум значение of the function функц().
 *
 * Возвращает the значение of x such that функц(x) is minimised. Uses Brent's метод,
 * which uses a parabolic fit в_ rapопрly approach the минимум but reverts в_ a
 * Golden Section ищи where necessary.
 *
 * The минимум is located в_ an accuracy of отнравх(min, truemin) <
 * реал.mant_dig/2.
 *
 * Параметры:
 ...
 *     funcMin      The минимум значение of функц(x).
 */
...
debug(UnitTest)
{
    ...
    unittest
    {
        ...
        // This имеется a минимум of кубкор(0.5).
