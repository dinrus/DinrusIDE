...
[s2;%% Устанавливаетthe UHD mode if current GUI font is bigger than 27 pixels 
...
[s2;%% Возвращает 2 `* [%-*@3 a] if UHD is active and [%-*@3 a] otherwise.&]
[s3;%% &]
[s4; &]
[s5;:Upp`:`:DPI`(Upp`:`:Size`): [_^Upp`:`:Size^ Size]_[* DPI]([_^Upp`:`:Size^ Size]_[*@3 sz])
&]
[s2;%% Возвращает 2 `* [%-*@3 sz] if UHD is active and [%-*@3 sz] otherwise.&]
[s3;%% &]
[s0;%% ]]