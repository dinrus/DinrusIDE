...
*/
    ...
    #include <wxCtrls/msw/ole/dataform.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/dataform.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/dataform.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/dataform.h>
#elif defined(__WXX11__)
    #include <wxCtrls/x11/dataform.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/dataform.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/dataform.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/dataform.h>
#endif
...
#if defined(__WXMSW__)
    #include <wxCtrls/msw/ole/dataobj.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/dataobj.h>
#elif defined(__WXX11__)
    #include <wxCtrls/x11/dataobj.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/dataobj.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/dataobj.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/dataobj.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/dataobj.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/dataobj.h>
#endif
...
#if defined(__WXMSW__)
    #include <wxCtrls/msw/ole/dataobj2.h>

    // wxURLDataObject defined in msw/ole/dataobj2.h
#else // !__WXMSW__
    #if defined(__WXGTK20__)
        #include <wxCtrls/gtk/dataobj2.h>
    #elif defined(__WXGTK__)
        #include <wxCtrls/gtk1/dataobj2.h>
    #elif defined(__WXX11__)
        #include <wxCtrls/x11/dataobj2.h>
    #elif defined(__WXMOTIF__)
        #include <wxCtrls/motif/dataobj2.h>
    #elif defined(__WXMAC__)
        #include <wxCtrls/mac/dataobj2.h>
    #elif defined(__WXCOCOA__)
        #include <wxCtrls/cocoa/dataobj2.h>
    #elif defined(__WXPM__)
        #include <wxCtrls/os2/dataobj2.h>
    #endif
