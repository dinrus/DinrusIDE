...
protected:
    ...
    #include <wxCtrls/msw/stdpaths.h>
// We want CoreFoundation paths on both CarbonLib and Darwin (for all ports)
#elif defined(__WXMAC__) || defined(__DARWIN__)
    #include <wxCtrls/mac/corefoundation/stdpaths.h>
#elif defined(__OS2__)
    #include <wxCtrls/os2/stdpaths.h>
#elif defined(__UNIX__)
    #include <wxCtrls/unix/stdpaths.h>
#elif defined(__PALMOS__)
    #include <wxCtrls/palmos/stdpaths.h>
#else
