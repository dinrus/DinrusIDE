...
/*  ftcglyph.c                                                             */
/*                                                                         */
/*    FreeType Glyph Рисунок (FT_Glyph) cache (body).                        */
/*                                                                         */
...
#include "ftcerror.h"
  ...
  ftc_gcache_init( FTC_Cache  ftccache )
  {
    ...
    Ошибка = FTC_Cache_Init( FTC_CACHE( cache ) );
    if ( !Ошибка )
    {
                     ...
                     FTC_Node    *anode )
  {
    ...
    FTC_MRULIST_LOOKUP( &cache->families, query, query->family, Ошибка );
    if ( !Ошибка )
    {
      ...
      Ошибка = FTC_Cache_Lookup( FTC_CACHE( cache ), hash, query, anode );
