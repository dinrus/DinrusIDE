...
unittest {
    ...
    static ткст[] test1 = ["--h2", "-в", "-bb", "-b", "-n=4349", "-бул=да", "ordinalTest1", "ordinalTest2", "-dashTest1", "-dashTest2", "@atTest"];
    ...
    static ткст[] test2 = ["-n=4349", "ordinalTest1", "@atTest", "--h2", "-b", "-bb", "-в", "-dashTest1", "-dashTest2", "ordinalTest2", "-бул=да"];

    парсер.разбор(test2, да);
    assert(h2 && в && b && bb && булево && (n ==4349));
    assert(ordinalCount == 1);
    assert(dashOrdinalCount == 1);
    ...
    static ткст[] test3 = ["-n=4349", "ordinalTest1", "@atTest", "--h2", "-b", "-bb", "-в", "-dashTest1", "-dashTest2", "ordinalTest2", "-бул=да"];
