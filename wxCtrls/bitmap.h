...
#include <wxCtrls/gdicmn.h>  // for wxBitmapType
...
protected:
    ...
    #include <wxCtrls/palmos/bitmap.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/bitmap.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/x11/bitmap.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/bitmap.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/bitmap.h>
#elif defined(__WXX11__)
    #include <wxCtrls/x11/bitmap.h>
#elif defined(__WXMGL__)
    #include <wxCtrls/mgl/bitmap.h>
#elif defined(__WXDFB__)
    #include <wxCtrls/dfb/bitmap.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/bitmap.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/bitmap.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/bitmap.h>
#endif
...
// we must include generic mask.h after wxBitmap definition
    ...
    #include <wxCtrls/generic/mask.h>
#endif
