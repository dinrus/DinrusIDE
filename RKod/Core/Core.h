...
#ifdef _MSC_VER
	#ifndef _CPPRTTI
		#error  RTTI должно быть активировано !!!
	#endif  //_CPPRTTI
#endif
...
// #define atof @ // atof is broken, as it depends on setlocale - might want ',' instead of '.' breaking a lot of код_
...
//Place it to the begining of each file to be the first ФУНКЦИЯ called in whole executable...
