...
#define TOPICFILE <DinrusIDE2/app.tpp/all.i>
...
#endif
	if(items.GetCount())
		h << "CodeBase: " << classes.GetCount() << " классов, " << items.GetCount() << " элементов\n";
	if(IsUHDMode())
		h << "Режим UHD\n";
	v1 = h;
...
public:
	AboutDlg()
	{
		...
		about.SetQTF(GetTopic("DinrusIDE2/app/About_ru-ru"), Zoom(DPI(120), 1024));
