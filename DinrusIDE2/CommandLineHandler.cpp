...
#include <Draw/Draw.h>
#include <DinrusIDE2/Common/CommandLineOptions.h>
#include <DinrusIDE2/Debuggers/GdbUtils.h>
...
bool BaseCommandLineHandler::HandleHelp() const
{
	...
	Cout() << "Использование:\n"
			  "    DinrusIDE2 [файл..]             - открывает данный файл в режиме редактора (режим автодетекции).\n"
			  "    DinrusIDE2 [сборка] [пакет] - открывает данный пакет из данной сборки.\n\n";
