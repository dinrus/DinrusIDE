...
void AlphaBlend(КЗСА *t, const КЗСА& c, int alpha);
void AlphaBlend(КЗСА *t, const КЗСА *s, int alpha, int len);
void AlphaBlend(КЗСА *t, const КЗСА& c, int alpha, int len);
...
force_inline
void AlphaBlend1(КЗСА *t, i16x8 s, i16x8 alpha)
{
	StoreRGBA(t, AlphaBlendSIMD(LoadRGBA(t), s, alpha));
}

force_inline
void AlphaBlend2(КЗСА *t, i16x8 s, i16x8 alpha)
{
	StoreRGBA2(t, AlphaBlendSIMD(LoadRGBA2(t), s, alpha));
}

force_inline
void AlphaBlend4(КЗСА *t, i16x8 sl, i16x8 al, i16x8 sh, i16x8 ah)
{
	i16x8 t4(t);
	PackRGBA(
...
force_inline
void AlphaBlend(КЗСА *t, const КЗСА& c)
{
	i16x8 s = LoadRGBA(&c);
...
force_inline
void AlphaBlend__(КЗСА& t, const КЗСА& c)
{
...
force_inline
void AlphaBlend__(КЗСА& t, const КЗСА& c, int cover)
{
	int a = c.a * cover >> 8;
	int alpha = 256 - a - (a >> 7);
