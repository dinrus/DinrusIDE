...
#define LAYOUTFILE <DinrusIDE/ide.lay>
#include <CtrlCore/lay.h>

#define IMAGECLASS IdeImg
#define IMAGEFILE  <DinrusIDE/ide.iml>
...
struct SpecialFolders : WithSpecialFolders<StaticRect> {
    ...
    class SysInfoGui : public TabDlg {
    public:
    ...
    class ScreenShot: public TabDlg {
    public:
        typedef ScreenShot CLASSNAME;
