...
#include "pshglob.h"
  ...
  /* org_width is is font units, result in device pixels, 26.6 формат */
  FT_LOCAL_DEF( FT_Pos )
                         ...
                         FT_Pos     delta )
  {
    ...
    /* parameter to the raw bluescale значение.  Here is why:    */
    /*                                                        */
    /*   We need to suppress overshoots for all pointsizes.   */
    /*   по 300dpi that satisfies:                            */
    /*                                                        */
    ...
    /* значение, and that `scale' converts from font units to    */
    /* fractional pixels.                                     */
    /*                                                        */
