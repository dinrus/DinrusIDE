...
/***************************************************************************/
   ...
   * ---------------------------
   *  table: Of тип FT_Bytes, pointing to the start of this table/subtable.
   *  limit: Of тип FT_Bytes, pointing to the end of this table/subtable,
   *         including padding for alignment.
   *  offset: Of тип FT_UInt, the number of octets from the start to target.
   *  length: Of тип FT_UInt, the number of octets from the start to the
...
#define GXV_NAME_ENTER( имя )  do { } while ( 0 )
