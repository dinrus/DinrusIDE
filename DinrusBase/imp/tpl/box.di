...
class РазбоксИскл : Исключение
{
    ...
    this(Бокс объект, ИнфОТипе типВывода, ткст файл = "Неизвестно", т_мера строка = 0)
    {
        ...
        super(фмт("Не удалось разбоксирование из типа %s в тип %s.", объект.тип, типВывода), файл, строка);
		//шим* soob =cast(шим*)(вЮ16(фмт("Не удалось разбоксирование из типа %s в %s.", объект.тип, типВывода)));
...
//скажинс("начинаю работать...");
    ...
    else
	{
        ...
        //скажинс(фмт("выдаю рез...%s", результат.вТкст));
		//скажинс(фмт("входный тип...%s", тип.вТкст));
		//скажинс(фмт("размер входных данных...%s", данные.sizeof));
    return результат;
}
