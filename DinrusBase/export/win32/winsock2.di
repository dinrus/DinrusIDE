...
struct FD_SET {
	...
	/* this differs from the define in winsock.в and in cygwin sys/types.в */
...
struct HOSTENT {
	...
	char* h_addr(char* в) { return h_addr_list[0] = в; }
}
...
/* Portable IPv6/IPv4 version of sockaddr.
   Uses padding to принудить 8 byte alignment
   and maximum size of 128 bytes */
struct SOCKADDR_STORAGE {
    short     ss_family;
    char[6]   __ss_pad1;   // pad to 8
    long      __ss_align;  // принудить alignment
...
// import win32.nspapi;
//#ifndef __CSADDR_T_DEFINED /* also in nspapi.в */
...
//#ifndef __BLOB_T_DEFINED /* also in wtypes.в and nspapi.в */
