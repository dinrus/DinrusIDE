...
[s2;%% То же, что и Wait(WAIT`_READ).&]
[s3;%% &]
[s4;%% &]
[s5;:TcpSocket`:`:WaitWrite`(`): [@(0.0.255) bool]_[* WaitWrite]()&]
[s2;%% То же, что и Wait(WAIT`_WRITE).&]
[s3;%% &]
[s4;%% &]
