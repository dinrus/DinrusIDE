...
[s2;%% То же, что и GetInfo() `& DOTS. True for physical device.&]
[s3;%% &]
[s4;%% &]
[s5;:Draw`:`:Pixels`(`)const: [@(0.0.255) bool]_[* Pixels]()_[@(0.0.255) const]&]
[s2;%% То же, что и !Dots(). True for screen output.&]
[s3;%% &]
[s4;%% &]
[s5;:Draw`:`:IsPrinter`(`)const: [@(0.0.255) bool]_[* IsPrinter]()_[@(0.0.255) const]&]
[s2;%% То же, что и GetInfo() `& PRINTER. True if output is printer.&]
[s3;%% &]
[s4;%% &]
[s5;:Draw`:`:IsNative`(`)const: [@(0.0.255) bool]_[* IsNative]()_[@(0.0.255) const]&]
[s2;%% То же, что и GetInfo() `& NATIVE. True if native resolution mode 
is active.&]
[s3;%% &]
[s4;%% &]
