...
[s2;%% То же, что и FromUnicodeBuffer([%-*@3 src] , wstrlen([%-*@3 src])).&]
[s3;%% &]
[s4;%% &]
...
&]
[s2;%% То же, что и ToUpper(ToAscii([%-*@3 c]) (but faster).&]
[s3;%% &]
[s4; &]
[s5;:Upp`:`:ToLowerAscii`(int`): [@(0.0.255) char]_[* ToLowerAscii]([@(0.0.255) int]_[*@3 c])
&]
[s2;%% То же, что и ToLower(ToAscii([%-*@3 c]) (but faster).&]
[s3;%% &]
[s4;%% &]
...
[s2;%% То же, что и ToUpper(ToAscii([%-*@3 src]) but faster.&]
[s3;%% &]
[s4; &]
...
[s2;%% То же, что и ToLower(ToAscii([%-*@3 src]) but faster.&]
[s3;%% &]
[s4;%% &]
...
[s2;%% То же, что и ToUpper(ToAscii([%-*@3 s]), [%-*@3 charset]), but faster.&]
[s3;%% &]
[s4; &]
...
[_^Upp`:`:byte^ byte]_[*@3 charset])&]
[s2;%% То же, что и ToLower(ToAscii([%-*@3 s]), [%-*@3 charset]), but faster.&]
[s3;%% &]
[s4;%% &]
