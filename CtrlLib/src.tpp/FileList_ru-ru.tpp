...
[{_} 
[ {{10000@3 [s0;%RU-RU [*@7;4 Класс ][*@(229)4 FileList]]}}&]
[s3; &]
...
&]
[s2;%RU-RU &]
[s9;%RU-RU This class is the ColumnList specialization for displaying 
...
[s2;%RU-RU This callback is called when filename was renamed by user. 
First argument is the original filename, second one is the new 
filename.&]
[s3; &]
[s4; &]
[s5;:FileList`:`:StartEdit`(`): [@(0.0.255) void]_[* StartEdit]()&]
[s2;%RU-RU Starts the editation of the current item for rename.&]
[s3; &]
[s4; &]
[s5;:FileList`:`:EndEdit`(`): [@(0.0.255) void]_[* EndEdit]()&]
[s2;%RU-RU Ends the editation of item.&]
[s3; &]
[s4; &]
[s5;:FileList`:`:IsEdit`(`)const: [@(0.0.255) bool]_[* IsEdit]()_[@(0.0.255) const]&]
[s2;%RU-RU True if editation is active.&]
[s3; &]
[s4; &]
[s5;:FileList`:`:OkEdit`(`): [@(0.0.255) void]_[* OkEdit]()&]
[s2;%RU-RU Ends the editation and calls WhenRename to actually rename 
the filename.&]
[s2;%RU-RU &]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Replaces an icon of file item.&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Adds a new file item at the end of list.&]
[s3;%RU-RU &]
[s4; &]
[s5;:FileList`:`:Get`(int`)const: [@(0.0.255) const]_[_^FileList`:`:File^ File][@(0.0.255) `&
]_[* Get]([@(0.0.255) int]_[*@3 i])_[@(0.0.255) const]&]
[s2;%RU-RU Возвращает the file item structure at specified index.&]
[s3; &]
[s4; &]
...
[_^Color^ Color]_[*@3 underline]_`=_Null, [@(0.0.255) bool]_[*@3 unixexe]_`=_[@(0.0.255) fa
lse], [@(0.0.255) bool]_[*@3 hidden]_`=_[@(0.0.255) false])&]
[s2;%RU-RU Inserts a new file item at specified position.&]
[s3;%RU-RU &]
[s4; &]
...
[_^Color^ Color]_[*@3 underline]_`=_Null, [@(0.0.255) bool]_[*@3 unixexe]_`=_[@(0.0.255) fa
lse], [@(0.0.255) bool]_[*@3 hidden]_`=_[@(0.0.255) false])&]
[s2;%RU-RU Replaces an information about a file item at specified 
position.&]
[s3;%RU-RU &]
[s4; &]
...
onst]&]
[s2;%RU-RU Возвращает the filename of item with cursor. If there is 
no cursor, returns empty String.&]
[s3; &]
[s4; &]
[s5;:FileList`:`:Find`(const char`*`): [@(0.0.255) int]_[* Find]([@(0.0.255) const]_[@(0.0.255) c
har]_`*[*@3 name])&]
[s2;%RU-RU The index of the item with specified [%-*@3 name] or negative 
...
[s2;%RU-RU If item with [%-*@3 name].is in the list, sets the cursor 
to it and returns true, otherwise returns false.&]
[s3; &]
[s4; &]
[s5;:FileList`:`:Sort`(const FileList`:`:Order`&`): [@(0.0.255) void]_[* Sort]([@(0.0.255) c
onst]_[_^FileList`:`:Order^ Order][@(0.0.255) `&]_[*@3 order])&]
[s2;%RU-RU Sorts the list. Order contains single virtual method for 
ordering File structures.&]
[s3; &]
[s4; &]
[s5;:FileList`:`:IconWidth`(int`): [_^FileList^ FileList][@(0.0.255) `&]_[* IconWidth]([@(0.0.255) i
nt]_[*@3 w])&]
[s2;%RU-RU Устанавливаетthe space reserved for painting the file icon.&]
[s3; &]
[s4; &]
[s5;:FileList`:`:GetIconWidth`(`)const: [@(0.0.255) int]_[* GetIconWidth]()_[@(0.0.255) con
st]&]
[s2;%RU-RU Возвращает  значение, установленное посредством  IconWidth.&]
[s3; &]
[s4; &]
[s5;:FileList`:`:Renaming`(bool`): [_^FileList^ FileList][@(0.0.255) `&]_[* Renaming]([@(0.0.255) b
ool]_[*@3 b]_`=_[@(0.0.255) true])&]
[s2;%RU-RU In renaming mode, user is allowed to edit the name of 
item (by holding mouse button over the item). WhenRename callback 
is called when user accepts the new name.&]
[s3; &]
[s4; &]
[s5;:FileList`:`:JustName`(bool`): [_^FileList^ FileList][@(0.0.255) `&]_[* JustName]([@(0.0.255) b
ool]_[*@3 b]_`=_[@(0.0.255) true])&]
[s2;%RU-RU In JustName mode, if filename contains [* `\] or [* /] characters, 
...
ool]_[*@3 b]_`=_[@(0.0.255) true])&]
[s2;%RU-RU AccelKey activates searching for file starting on key 
press (first letter of filename is matched).&]
[s3;%RU-RU &]
[s4; &]
[s5;:FileList`:`:SelectDir`(bool`): [@(0.0.255) void]_[* SelectDir]([@(0.0.255) bool]_[*@3 b]_
`=_[@(0.0.255) true])&]
[s2;%RU-RU In SelectDir mode, directories can be selected (important 
for multiselecting directories in FileSel).&]
[s0;%RU-RU &]
[s0;%RU-RU &]
[s0; &]
[ {{10000@3 [s0;%RU-RU [*@(229)4 FileList`::File]]}}&]
[s3;%RU-RU &]
[s1;:FileList`:`:File`:`:struct: [@(0.0.255)3 struct][3 _][*3 File]&]
[s9;%RU-RU Structure used to hold information about the item. Some 
...
[s2;%RU-RU Если true, item contains directory.&]
[s3;%RU-RU &]
[s4; &]
[s5;:FileList`:`:File`:`:unixexe: [@(0.0.255) bool]_[* unixexe]&]
[s2;%RU-RU Если true, item in POSIX has executable rights.&]
[s3; &]
[s4; &]
[s5;:FileList`:`:File`:`:hidden: [@(0.0.255) bool]_[* hidden]&]
[s2;%RU-RU Если true, item is hidden.&]
[s3; &]
[s4; &]
...
[s2;%RU-RU This function loads [%-*@3 list] with file items in [%-*@3 dir]. 
...
style])&]
[s2;%RU-RU Возвращает the OS dependent icon of [%-*@3 drive`_style].&]
[s3;%RU-RU &]
[s4; &]
[s5;:Upp`:`:Sort`(Upp`:`:FileList`&`,int`): [@(0.0.255) void]_[* Sort]([_^Upp`:`:FileList^ F
ileList][@(0.0.255) `&]_[*@3 list], [@(0.0.255) int]_[*@3 kind])&]
[s0;l288;%RU-RU Sorts the [%-*@3 list] of files by criterion [%-*@3 kind]. 
