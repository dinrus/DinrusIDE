...
// ----------------------------------------------------------------------------
    ...
    #include <wxCtrls/palmos/taskbar.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/taskbar.h>
#elif defined(__WXGTK__) || defined(__WXX11__) || defined(__WXMOTIF__)
    #include <wxCtrls/unix/taskbarx11.h>
#elif defined (__WXMAC__) && defined(__WXMAC_OSX__)
    #include <wxCtrls/mac/taskbarosx.h>
#elif defined (__WXCOCOA__)
    #include <wxCtrls/cocoa/taskbar.h>
#endif
