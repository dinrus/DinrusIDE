...
// ----------------------------------------------------------------------------
    ...
    #include <wxCtrls/msw/clipbrd.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/clipbrd.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/clipbrd.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/clipbrd.h>
#elif defined(__WXX11__)
    #include <wxCtrls/x11/clipbrd.h>
#elif defined(__WXMGL__)
    #include <wxCtrls/mgl/clipbrd.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/clipbrd.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/clipbrd.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/clipbrd.h>
#endif
