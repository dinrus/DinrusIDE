...
#define GXV_BSLN_DATA( field )  GXV_TABLE_DATA( bsln, field )
                                 ...
                                 GXV_Validator        valid )
  {
    ...
    GXV_NAME_ENTER( "lookup значение" );
  ...
  */
                     ...
                     FT_Validator  ftvalid )
  {
    ...
    /* only формат 1, 2, 3 are defined (1996) */
    GXV_TRACE(( " (формат = %d)\n", формат ));
    if ( формат > 3 )
      FT_INVALID_FORMAT;
    ...
    fmt_funcs_table[формат]( p, limit, valid );
