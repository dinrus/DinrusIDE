...
[s2;%% Возвращает  true, если the last received message had flag FIN set.&]
[s3;%% &]
[s4;%% &]
[s5;:WebSocket`:`:IsText`(`)const: [@(0.0.255) bool]_[* IsText]()_[@(0.0.255) const]&]
[s2;%% Возвращает  true, если the last received message was text.&]
[s3;%% &]
[s4;%% &]
...
[s2;%% Возвращает  true, если the socket is open.&]
[s3; &]
[s4;%% &]
[s5;:WebSocket`:`:IsClosed`(`)const: [@(0.0.255) bool]_[* IsClosed]()_[@(0.0.255) const]&]
[s2;%% Возвращает  true, если the socket is closed.&]
[s4; &]
