...
using namespace РНЦПДинрус;

struct f32x4 {
	float32x4_t данные;

	f32x4& грузи(const void *ptr)   { данные = vld1q_f32((float *)ptr); return *this; }
	f32x4& Load64(const void *ptr) { данные = vcombine_f32(vld1_f32((float *)ptr), vdup_n_f32(0)); return *this; }
	f32x4& Load32(const void *ptr) { данные = vsetq_lane_f32(*(float *)ptr, vdupq_n_f32(0), 0); return *this; }

	void   сохрани(void *ptr)        { vst1q_f32((float32_t *)ptr, данные); }
	void   Store64(void *ptr)      { vst1_f32((float32_t *)ptr, vget_low_f32(данные)); }
	void   Store32(void *ptr)      { *(float32_t *)ptr = vgetq_lane_f32(данные, 0); }
	
	f32x4()                      {}
	f32x4(const void *ptr)       { грузи(ptr); }
	f32x4(float32x4_t d)         { данные = d; }

	f32x4(double f)              { данные = vsetq_lane_f32((float)f, vdupq_n_f32(0), 0); }
	f32x4(float f)               { данные = vsetq_lane_f32((float)f, vdupq_n_f32(0), 0); }
	f32x4(int f)                 { данные = vsetq_lane_f32((float)f, vdupq_n_f32(0), 0); }
...
struct i16x8 { // 8xint16
	...
	i16x8& грузи(const void *ptr)   { данные = vld1q_s16((int16_t *)ptr); return *this; }
	i16x8& Load64(const void *ptr) { данные = vcombine_s16(vld1_s16((int16_t *)ptr), vdup_n_s16(0)); return *this; }
	i16x8& Load32(const void *ptr) { данные = vreinterpretq_s16_s32(vsetq_lane_s32(*(int32_t *)ptr, vdupq_n_s32(0), 0)); return *this; }

	void   сохрани(void *ptr)      { vst1q_s16((int16_t *)ptr, данные); }
	void   Store64(void *ptr)    { vst1_s16((int16_t *)ptr, vget_low_s16(данные)); }
	void   Store32(void *ptr)    { *(int32_t *)ptr = vgetq_lane_s32(vreinterpretq_s32_s16(данные), 0); }
	...
	i16x8(int v)                 { данные = vsetq_lane_s16(v, vdupq_n_s16(0), 0); }
...
struct i32x4 { // 4xint32
	...
	i32x4& грузи(const void *ptr)   { данные = vld1q_s32((int32_t *)ptr); return *this; }
	i32x4& Load64(const void *ptr) { данные = vcombine_s32(vld1_s32((int32_t *)ptr), vdup_n_s32(0)); return *this; }
	i32x4& Load32(const void *ptr) { данные = vsetq_lane_s32(*(int32_t *)ptr, vdupq_n_s32(0), 0); return *this; }

	void   сохрани(void *ptr)      { vst1q_s32((int32_t *)ptr, данные); }
	void   Store64(void *ptr)    { vst1_s32((int32_t *)ptr, vget_low_s32(данные)); }
	void   Store32(void *ptr)    { *(int32_t *)ptr = vgetq_lane_s32(данные, 0); }
...
struct i8x16 { // 16*int8
	...
	i8x16& грузи(const void *ptr)   { данные = vld1q_s8((int8_t *)ptr); return *this; }
	i8x16& Load64(const void *ptr) { данные = vcombine_s8(vld1_s8((int8_t *)ptr), vdup_n_s8(0)); return *this; }
	i8x16& Load32(const void *ptr) { данные = vreinterpretq_s8_s32(vsetq_lane_s32(*(int32_t *)ptr, vdupq_n_s32(0), 0)); return *this; }

	void   сохрани(void *ptr)      { vst1q_s8((int8_t *)ptr, данные); }
	void   Store64(void *ptr)    { vst1_s32((int32_t *)ptr, vget_low_s32(vreinterpretq_s32_s8(данные))); }
	void   Store32(void *ptr)    { *(int32_t *)ptr = vgetq_lane_s32(vreinterpretq_s32_s8(данные), 0); }
	...
	i8x16(int v)                 { данные = vsetq_lane_s8(v, vdupq_n_s8(0), 0); }
