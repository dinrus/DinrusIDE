...
#include <wxCtrls/msw/seh.h>

#include <wxCtrls/except.h>
...
THREAD_RETVAL wxThreadInternal::DoThreadStart(wxThread *thread)
{
    ...
    wxTRY
    {
        ...
        rc = (THREAD_RETVAL)(WXLPARAM)thread->Entry();
    }
    wxCATCH_ALL( wxTheApp->OnUnhandledException(); )
...
#define QS_ALLPOSTMESSAGE 0
    ...
    for ( ;; )
    {
        ...
        if ( (DWORD)(WXLPARAM)rc != STILL_ACTIVE )
            break;
