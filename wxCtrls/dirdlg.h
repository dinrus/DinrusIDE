...
// Universal and non-port related switches with need for generic implementation
    ...
    #include <wxCtrls/generic/dirdlgg.h>
    ...
    #include <wxCtrls/generic/dirdlgg.h>     // MS PocketPC or MS Smartphone
    #define wxDirDialog wxGenericDirDialog
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/dirdlg.h>  // Native MSW
#elif defined(__WXGTK24__)
    #include <wxCtrls/gtk/dirdlg.h>  // Native GTK for gtk2.4
#elif defined(__WXGTK__)
    #include <wxCtrls/generic/dirdlgg.h>
    #define wxDirDialog wxGenericDirDialog
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/dirdlg.h>      // Native Mac
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/dirdlg.h>    // Native Cocoa
#elif defined(__WXMOTIF__) || \
      defined(__WXX11__)   || \
      defined(__WXMGL__)   || \
      defined(__WXCOCOA__) || \
      defined(__WXPM__)
    #include <wxCtrls/generic/dirdlgg.h>     // Other ports use generic implementation
    #define wxDirDialog wxGenericDirDialog
#endif
