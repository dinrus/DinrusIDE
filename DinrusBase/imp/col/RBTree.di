    ...
    Узел удали(Узел конец)
    {
        ...
        if(цвет == цвет.Чёрный)
        {
            ...
            while(x._родитель !is конец && x.цвет == Узел.Цвет.Чёрный)
            {
                ...
                {
                    // лево Узел
                    Узел ш = x._родитель._право;
                    if(ш.цвет == Узел.Цвет.Красный)
                    {
                        ш.цвет = Узел.Цвет.Чёрный;
                        x._родитель.цвет = Узел.Цвет.Красный;
                        x._родитель.вращайЛ();
                        ш = x._родитель._право;
                    }
                    Узел wl = ш.лево;
                    Узел wr = ш.право;
                    ...
                    else
                    {
                        ...
                        ш.цвет = x._родитель.цвет;
                        x._родитель.цвет = Узел.Цвет.Чёрный;
                        ш._право.цвет = Узел.Цвет.Чёрный;
                        x._родитель.вращайЛ();
                        x = конец.лево; // x = root
                    }
                }
