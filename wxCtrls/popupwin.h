...
// include the real class declaration
    ...
    #include <wxCtrls/msw/popupwin.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/popupwin.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/popupwin.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/popupwin.h>
#elif defined(__WXX11__)
    #include <wxCtrls/x11/popupwin.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/popupwin.h>
#elif defined(__WXMGL__)
    #include <wxCtrls/mgl/popupwin.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/popupwin.h>
#else
