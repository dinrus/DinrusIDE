...
[{_} 
[ {{10000@(113.42.0) [s0;%RU-RU [*@7;4 Класс DropTree]]}}&]
[s1;@(0.0.255)3 &]
...
&]
[s2;%RU-RU This class is similar to DropList (widget traditionally 
named `"ComboBox`"), but instead of single list of elements it 
provides the list with tree hierarchy.&]
[s3; &]
...
[s2;%RU-RU Triggers when the tree is about to drop. Can be used to 
populate the tree just before it is displayed.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:DropTree`:`:Clear`(`): [@(0.0.255) void]_[* Clear]()&]
[s2;%RU-RU Clears the tree and assigns Null as value.&]
[s3; &]
[s4; &]
...
[s2;%RU-RU Access to TreeCtrl methods.&]
[s3; &]
[s4; &]
...
[s2;%RU-RU Changes the width of popup TreeCtrl to [%-*@3 w] pixels 
(normally it is equal to the width of DropTree widget).&]
[s3;%RU-RU &]
[s4; &]
