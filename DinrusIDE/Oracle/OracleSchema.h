...
#define STRING(x, n)               COLUMN("varchar2(" #n ")", Ткст, x, n, 0)
#define STRING_ARRAY(x, n, items)  COLUMN_ARRAY("varchar2(" #n ")", Ткст, x, n, 0, items)
#define STRING_(x, n)              COLUMN_("varchar2(" #n ")", Ткст, x, n, 0)
#define STRING_ARRAY_(x, n, items) COLUMN_ARRAY_("varchar2(" #n ")", Ткст, x, n, 0, items)
...
#define TIME(x)                    COLUMN("date", Время, x, 0, 0)
#define TIME_ARRAY(x, items)       COLUMN_ARRAY("date", Время, x, 0, 0, items)
#define TIME_(x)                   COLUMN_("date", Время, x, 0, 0)
#define TIME_ARRAY_(x, items)      COLUMN_ARRAY_("date", Время, x, 0, 0, items)
...
#define LONG(x)                    COLUMN("long", Ткст, x, 0, 0)
#define LONG_(x)                   COLUMN_("long", Ткст, x, 0, 0)

#define LONGRAW(x)                 COLUMN("long raw", Ткст, x, 0, 0)
#define LONGRAW_(x)                COLUMN_("long raw", Ткст, x, 0, 0)

#define BLOB(x)                    COLUMN("blob", Ткст, x, INT_MAX/2, 0)
#define BLOB_(x)                   COLUMN_("blob", Ткст, x, INT_MAX/2, 0)

#define CLOB(x)                    COLUMN("clob", Ткст, x, INT_MAX/2, 0)
#define CLOB_(x)                   COLUMN_("clob", Ткст, x, INT_MAX/2, 0)
