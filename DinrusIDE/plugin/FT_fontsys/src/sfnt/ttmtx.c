...
/*  ttmtx.c                                                                */
/*                                                                         */
/*    грузи the metrics tables common to TTF and OTF fonts (body).          */
/*                                                                         */
...
#define FT_COMPONENT  trace_ttmtx
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    грузи the `hmtx' or `vmtx' table into a face object.                */
  /*                                                                       */
  /* <Input>                                                               */
                     ...
                     FT_Bool    vertical )
  {
    ...
    Ошибка = face->goto_table( face, tag, stream, &table_size );
    if ( Ошибка )
      goto Fail;
                     ...
                     FT_Bool    vertical )
  {
    ...
    if ( vertical )
    {
      ...
      Ошибка = face->goto_table( face, TTAG_vmtx, stream, &table_len );
      if ( Ошибка )
        goto Fail;
    ...
    else
    {
      ...
      Ошибка = face->goto_table( face, TTAG_hmtx, stream, &table_len );
      if ( Ошибка )
        goto Fail;
...
#if 0
      Ошибка = vertical ? SFNT_Err_Invalid_Vert_Metrics
    ...
    /* do we have an inconsistent number of metric values? */
    {
      ...
      /* last valid значение.  Since this will occur for buggy CJK */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    грузи the `hhea' or 'vhea' table into a face object.                */
  /*                                                                       */
  /* <Input>                                                               */
  /*    face     :: A handle to the target face object.                    */
  /*                                                                       */
...
#define FT_STRUCTURE  TT_HoriHeader
    ...
    if ( vertical )
    {
      ...
      Ошибка = face->goto_table( face, TTAG_vhea, stream, 0 );
      if ( Ошибка )
        goto Fail;
    ...
    {
      Ошибка = face->goto_table( face, TTAG_hhea, stream, 0 );
      if ( Ошибка )
        goto Fail;
