...
IMPLEMENT_DYNAMIC_CLASS_XTI_CALLBACK(wxMenuItem, wxObject,<<wxCtrls//menuitem.h>,wxMenuItemStreamingCallback)
...
{
    return m_subMenu ? (int)(WXLPARAM)m_subMenu->GetHMenu() : GetId();
}
