...
#include <wxCtrls/renderer.h> // this is needed for wxCONTROL_XXX flags
#include <wxCtrls/bitmap.h> // wxBitmap used by-value
...
// ----------------------------------------------------------------------------
    ...
    #include <wxCtrls/msw/combo.h>
#endif

// Any ports may need generic as an alternative
#include <wxCtrls/generic/combo.h>
