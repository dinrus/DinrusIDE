...
///
///
/// @defgroup core_vector Вектор types
///
/// Вектор types of two to four components with an exhaustive set of operators.
///
/// @ingroup core
///
///
/// @defgroup core_vector_precision Вектор types with precision qualifiers
///
/// @brief Вектор types with precision qualifiers which may result in various precision in term of ULPs
///
