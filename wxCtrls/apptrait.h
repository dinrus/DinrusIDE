...
// ABX: check __WIN32__ instead of __WXMSW__ for the same MSWBase in any Win32 port
    ...
    #include <wxCtrls/palmos/apptbase.h>
#elif defined(__WIN32__)
    #include <wxCtrls/msw/apptbase.h>
#elif defined(__UNIX__) && !defined(__EMX__)
    #include <wxCtrls/unix/apptbase.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/apptbase.h>
#elif defined(__OS2__)
    #include <wxCtrls/os2/apptbase.h>
...
// ABX: check __WIN32__ instead of __WXMSW__ for the same MSWBase in any Win32 port
#if defined(__WXPALMOS__)
    #include <wxCtrls/palmos/apptrait.h>
#elif defined(__WIN32__)
    #include <wxCtrls/msw/apptrait.h>
#elif defined(__OS2__)
    #include <wxCtrls/os2/apptrait.h>
#elif defined(__UNIX__)
    #include <wxCtrls/unix/apptrait.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/apptrait.h>
#elif defined(__DOS__)
    #include <wxCtrls/msdos/apptrait.h>
#else
    #if wxUSE_GUI
