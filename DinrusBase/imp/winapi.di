...
struct _RTL_CRITICAL_SECTION
{
    ...
    ULONG_PTR SpinCount;        // принудить size on 64-bit systems when packed
}
...
// devioctl.в as FILE_READ_ACCESS and FILE_WRITE_ACCESS. The values for these
// константы *MUST* всегда be in sync.
// The values are redefined in devioctl.в because they must be available to
// both DOS and NT.
//
...
enum
{
    ...
    THREAD_BASE_PRIORITY_MIN =    -2,  // минимум thread base priority boost
