...
#include <wxCtrls/defs.h>            // for wxUSE_FONTDLG

#if wxUSE_FONTDLG

#include <wxCtrls/dialog.h>          // the base class
#include <wxCtrls/cmndata.h>         // wxFontData
...
#define USE_NATIVE_FONT_DIALOG_FOR_MACOSX 0
    ...
    #include <wxCtrls/generic/fontdlgg.h>
    #define wxFontDialog wxGenericFontDialog
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/fontdlg.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/fontdlg.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/fontdlg.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/fontdlg.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/fontdlg.h>
#endif
