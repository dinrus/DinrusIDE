...
{
    pragma(mangle, FPUTC.mangleof) int trustedFPUTC(int ch, _iobuf* h) @trusted;

    version (DIGITAL_MARS_STDIO)
        pragma(mangle, _FPUTWC.mangleof) int trustedFPUTWC(int ch, _iobuf* h) @trusted;
  //  else
       // pragma(mangle, FPUTWC.mangleof) int trustedFPUTWC(wchar_t ch, _iobuf* h) @trusted;
}
 ...
 */
    ...
    version (MSVC_Crt) {} else // Not implemented
