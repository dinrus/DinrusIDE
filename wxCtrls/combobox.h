...
// ----------------------------------------------------------------------------
    ...
    #include <wxCtrls/univ/combobox.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/combobox.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/combobox.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/combobox.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/combobox.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/combobox.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/combobox.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/combobox.h>
#endif
