 ...
 *   Algorithms with 11 Multiplications", Proc. Цел'l. Conf. on Acoustics,
 ...
 * have BITS_IN_JSAMPLE + CONST_BITS + PASS1_BITS <= 26.  Ошибка analysis
		 ...
		 JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  for (ctr = DCTSIZE; ctr > 0; ctr--) {
    ...
    z2 <<= CONST_BITS;
    z3 <<= CONST_BITS;
    /* добавь fudge factor here for final descale. */
  ...
  for (ctr = 0; ctr < DCTSIZE; ctr++) {
    ...
    /* добавь range center and fudge factor for final descale and range-limit. */
    z2 = (INT32) wsptr[0] +
 ...
 * average pixel значение, which is one-eighth of the DC coefficient.
 */
	       ...
	       JSAMPARRAY output_buf, JDIMENSION output_col)
{
  ...
  /* добавь range center and fudge factor for descale and range-limit. */
