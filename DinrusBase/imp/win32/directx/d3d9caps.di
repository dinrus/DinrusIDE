...
const D3DPMISCCAPS_FOGANDSPECULARALPHA = 0x00010000L; /* Device supports separate fog and specular альфа (many devices
                                                          use the specular альфа channel to store fog factor) */
const D3DPMISCCAPS_SEPARATEALPHABLEND = 0x00020000L; /* Device supports separate blend settings for the альфа channel */
...
const D3DPRASTERCAPS_COLORPERSPECTIVE = 0x00400000L; /* Device iterates цвета perspective correct */
...
const D3DPTEXTURECAPS_ALPHAPALETTE = 0x00000080L; /* Device can draw альфа from texture palettes */
