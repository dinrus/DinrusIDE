...
inline void wxBitmapButtonBase::SetLabel(const wxBitmap& bitmap)
{
    ...
    #include <wxCtrls/univ/bmpbuttn.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/bmpbuttn.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/bmpbuttn.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/bmpbuttn.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/bmpbuttn.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/bmpbuttn.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/bmpbuttn.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/bmpbuttn.h>
#endif
