...
#include <wxCtrls/ctrlsub.h>         // base class
...
// ----------------------------------------------------------------------------
    ...
    #include <wxCtrls/motif/listbox.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/listbox.h>
#elif defined(__WXGTK__)
  #include <wxCtrls/gtk1/listbox.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/listbox.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/listbox.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/listbox.h>
#endif
