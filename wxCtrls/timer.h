...
#include <wxCtrls/longlong.h>
#include <wxCtrls/event.h>
#include <wxCtrls/stopwatch.h> // for backwards compatibility
#include <wxCtrls/window.h>    // only for NewControlId()
...
// ----------------------------------------------------------------------------
    ...
    #include <wxCtrls/msw/timer.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/timer.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/timer.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/timer.h>
#elif defined(__WXX11__) || defined(__WXMGL__) || defined(__WXDFB__)
    #include <wxCtrls/generic/timer.h>
#elif defined (__WXCOCOA__)
    #include <wxCtrls/cocoa/timer.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/timer.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/timer.h>
#endif
