...
[{_} 
[ {{10000@(113.42.0) [s0;%RU-RU [*@7;4 ColumnList]]}}&]
[s0; &]
...
&]
[s2; &]
[s2;%RU-RU Этот виджет отображает однотипные 
элементы в несколько колонок. Число 
колонок может изменяться пользовательским 
действием. Как правило, виджет используется 
для отображения списка файлов.&]
[s3; &]
[ {{10000F(128)G(128)@1 [s0;%RU-RU [* Список Публичных Методов]]}}&]
[s3; &]
[s5;:Upp`:`:ColumnList`:`:WhenLeftClick: [_^Upp`:`:Event^ Event]<>_[* WhenLeftClick]&]
[s2;%RU-RU Это событие `"отправляется`" при 
нажатии пользователем этого виджета, 
левой кнопкой мыши. Курсор имеется 
у `"кликнутого`" элемента.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:ColumnList`:`:WhenLeftClickPos: [_^Upp`:`:Event^ Event]<[_^Upp`:`:Point^ Poin
t]>_[* WhenLeftClickPos]&]
[s2;%RU-RU Подобно WhenLeftClick, но также даёт 
и координаты внутри `"кликнутого`" 
элемента.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:ColumnList`:`:WhenLeftDouble: [_^Upp`:`:Event^ Event]<>_[* WhenLeftDouble]&]
[s2;%RU-RU Это событие отправляется при 
двойном клике пользователя на виджете, 
левой кнопкой мыши.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:ColumnList`:`:WhenBar: [_^Upp`:`:Event^ Event]<Bar[@(0.0.255) `&]>_[* WhenBar]&]
[s2;%RU-RU Это событие отправляется при 
клике пользователем на виджете, правой 
кнопкой мыши. Клиентский код может 
использовать это событие для установки 
контекстного меню.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:ColumnList`:`:WhenSel: [_^Upp`:`:Event^ Event]<>_[* WhenSel]&]
[s2;%RU-RU Это событие отправляется когда 
курсор, или выделенный статус виджета, 
изменены.&]
[s3; &]
[s4; &]
...
[s2;%RU-RU Устанавливает текущую позицию 
курсора. Если [%-*@3 c] не попадает в диапазон 
(out of range), она `"фиксируется`" (отрицательное 
становится 0, >GetCount() становится GetCount() 
`- 1).&]
[s3;%RU-RU &]
[s4; &]
[s5;:Upp`:`:ColumnList`:`:KillCursor`(`): [@(0.0.255) void]_[* KillCursor]()&]
[s2;%RU-RU Отменяет курсор.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:ColumnList`:`:IsCursor`(`)const: [@(0.0.255) bool]_[* IsCursor]()_[@(0.0.255) c
onst]&]
[s2;%RU-RU Проверяет, есть ли курсор в любом 
из элементов. То же, что и [C GetCursor() >`= 
0].&]
[s3; &]
[s4; &]
...
[*@3 y])&]
[s2;%RU-RU Устанавливает позицию полосы 
прокрутки в [%-*@3 y].&]
[s3;%RU-RU &]
[s4; &]
...
[*@3 a])&]
[s2;%RU-RU `"Проматывает`" до позиции [%-*@3 a].&]
[s3;%RU-RU &]
[s4; &]
[s5;:Upp`:`:ColumnList`:`:SetFrame`(Upp`:`:CtrlFrame`&`): [@(0.0.255) void]_[* SetFrame](
[_^Upp`:`:CtrlFrame^ CtrlFrame][@(0.0.255) `&]_[*@3 frame])&]
[s2;%RU-RU Устанавливает декоративный фрейм 
ColumnList`'а в [%-*@3 frame]. Это необходимо по 
той причине, что ColumnList имеет особый, 
с нулевым индексом, (декоративный) 
фрейм, чтобы обеспечивать опцию RoundSize. 
Установленный этим методом декоративный 
фрейм используется особым фреймом 
`"раундинга`".&]
[s3;%RU-RU &]
[s4; &]
[s5;:Upp`:`:ColumnList`:`:Clear`(`): [@(0.0.255) void]_[* Clear]()&]
[s2;%RU-RU `"Опустошает`" ColumnList.&]
[s3; &]
[s4; &]
...
[@(0.0.255) const]_[_^Upp`:`:Display^ Display][@(0.0.255) `&]_[*@3 display], 
[@(0.0.255) bool]_[*@3 canselect]_`=_[@(0.0.255) true])&]
[s2;%RU-RU Добавляет элемент в этот ColumnList. 
Дополнительно этому элементу может 
присваиваться ключ [%-*@3 key]. Если [%-*@3 canselect] 
равно false, то элемент нельзя выделить. 
Если задан [%-*@3 display], то он используется 
для отображения этого элемента (иначе 
используется общий дисплей, установленный 
методом SetDisplay).&]
[s3;%RU-RU &]
[s4; &]
...
находящегося в позиции [%-*@3 ii]. Дополнительно 
этому элементу может быть присвоен 
ключ [%-*@3 key]. Если [%-*@3 canselect] равно false, 
то элемент нельзя выделить. Если задан 
[%-*@3 display], он используется для отображения 
элемента (иначе используется общий 
дисплей, установленный методом SetDisplay).&]
[s3;%RU-RU &]
[s4;%RU-RU &]
...
[@(0.0.255) bool]_[*@3 canselect]_`=_[@(0.0.255) true])&]
[s2;%RU-RU Устанавливает значение элемента 
с данным ключом [%-*@3 key]. Если [%-*@3 canselect] 
равно false, то элемент нельзя выделить. 
Если задан [%-*@3 display], он используется 
для отображения элемента (иначе используетс
я общий дисплей, установленный методом 
SetDisplay).&]
[s3;%RU-RU &]
[s4; &]
...
[@(0.0.255) const]_[_^Upp`:`:Display^ Display][@(0.0.255) `&]_[*@3 display], 
[@(0.0.255) bool]_[*@3 canselect]_`=_[@(0.0.255) true])&]
[s2;%RU-RU Вставляет элемент в позиции [%-*@3 ii]. 
Дополнительно этому элементу может 
быть присвоен ключ [%-*@3 key]. Если [%-*@3 canselect] 
равно false, то элемент нельзя выделить. 
Если задан [%-*@3 display], он используется 
для отображения элемента (иначе используетс
я общий дисплей, установленный методом 
...
[s2;%RU-RU Если в виджете есть выделение, 
возврат true означает, что [%-*@3 i] выделен, 
иначе возвращается true, если курсор 
находится в позиции [%-*@3 i].&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU При успехе возвращает позицию 
элемента с ключом [%-*@3 key], при неуспехе 
`- отрицательное значение.&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Сортирует элементы списка.&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Устанавливает число колонок на 
[%-*@3 n]. (Также число колонок можно изменять 
перетягиванием границы колонки пользовател
ем).  Возвращает `*this для сцепки методов.&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Устанавливает высоту элемента 
в пикселях. Возвращает `*this для сцепки 
методов.&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Устанавливает ширину элемента 
в пикселях. Возвращает `*this для сцепки 
методов.&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU В этом режиме, когда пользователь 
кликает в зоне обзора, где нет элементов, 
курсор отменяется. По дефолту выключено. 
...
[s2;%RU-RU Устанавливает этот виджет в прозрачный 
режим: фон не отрисовывается и активируется 
Transparent. В итоге видно то, что находится 
позади виджета, а клиентский код может 
предоставлять всё, что требуется, 
в виде фона. Возвращает `*this для сцепки 
методов.&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Если активен, появляется увеличенное 
небольшое всплывающее окошко, когда 
мышь проходит над областью, полностью 
не помещающейся на экране (эта область 
уменьшена в отношении Display`::GetMinSize). 
По умолчанию (дефолт) активен.&]
[s3;%RU-RU &]
[s4; &]
