...
[s2;%% То же, что и AsJSON([%-*@3 v], String(), [%-*@3 pretty]).&]
[s3;%% &]
[s0; &]
...
[s3;%% &]
[s5;:Json`:`:Json`(`): [* Json]()&]
[s2; Дефолтный конструктор. Создаёт empty JSON object.&]
[s3;%% &]
[s4; &]
...
[s2;%% Возвращает current JSON formatted text.&]
[s3;%% &]
[s4; &]
