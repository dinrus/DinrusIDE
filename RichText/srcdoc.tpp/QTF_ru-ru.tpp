...
::= [s0; Шрифт Courier.]
::^ [s0;%- [C@(128.0.255) G]]
::= [s0; Шрифт Standard GUI.]
::^ [s0;%- [C@(128.0.255) g]]
::= [s0; Шрифт Standard GUI со стандартной высотой.]
::^ [s0;%- [C@(128.0.255) S]]
::= [s0; Шрифт Symbol.]
::^ [s0;%- [C@(128.0.255) .][/C@(0.0.255) число]]
...
[s0; ]
::= [s0; Набор символов. Есго можно определить 
одним знаком&]
[s0; &]
