 ...
 * TIFF Library.
 *
 * ZIP (aka дефлируй) Compression Support
 *
 ...
 *
 * The data формат used by the zlib library is described in the files
...
#Ошибка "Antiquated ZLIB software; you must use version 1.0 or later"
#endif
...
TIFFInitZIP(TIFF* tif, int scheme)
{
	...
	if (!_TIFFMergeFields(tif, zipFields, TIFFArrayCount(zipFields))) {
		TIFFErrorExt(tif->tif_clientdata, module,
			     "Merging дефлируй codec-specific tags failed");
		return 0;
	}
