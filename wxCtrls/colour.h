...
protected:
    ...
    #include <wxCtrls/generic/colour.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/colour.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/colour.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/colour.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/colour.h>
#elif defined(__WXMGL__)
    #include <wxCtrls/generic/colour.h>
#elif defined(__WXDFB__)
    #include <wxCtrls/generic/colour.h>
#elif defined(__WXX11__)
    #include <wxCtrls/x11/colour.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/colour.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/colour.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/colour.h>
#endif
