...
FT_BEGIN_HEADER
  ...
  typedef struct  TT_GraphicsState_
  {
    ...
    /* integer; the high-word part holds the SCANTYPE значение, the low-word */
    /* part the SCANCTRL значение.  We separate it into two fields.          */
...
#define TT_MAX_CODE_RANGES  3
  ...
  /*                                                                       */
  /*   Reading a cvt значение returns                                         */
  /*     ratio * cvt[Индекс]                                                */
  /*                                                                       */
  /*   Writing a cvt значение in pixels:                                      */
  /*     cvt[Индекс] / ratio                                                */
  /*                                                                       */
  ...
  typedef struct  TT_SizeRec_
  {
    ...
    FT_ULong           cvt_size;      /* the scaled control значение table */
    FT_Long*           cvt;
