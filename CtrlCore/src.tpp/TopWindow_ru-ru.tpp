...
[s7;%% [%-*C@3 ID]-|Exit code.&]
[s7;%% [*/ Возвратное значение]-|True if all child Ctrls were accepted and 
...
[s2;%% То же, что и m <<`= [* Breaker](ID) `- assigns [* Breaker] callback 
...
[s2;%% То же, что и m <<`= [* Acceptor](ID) `- assigns [* Acceptor] callback 
to WhenAction method of specified Ctrl.&]
[s7;%% [%-*C@3 m]-|Ctrl.&]
[s7;%% [%-*C@3 ID]-|Message loop exit code.&]
[s7;%% [*/ Возвратное значение]-|`*this.&]
...
tor]([_^Ctrl^ Ctrl][@(0.0.255) `&]_[*@3 m], [@(0.0.255) int]_[*@3 ID])&]
[s2;%% То же, что и m <<`= [* Rejector](ID) `- assigns [* Rejector] callback 
to WhenAction method of specified Ctrl.&]
[s7;%% [%-*C@3 m]-|Ctrl.&]
[s7;%% [%-*C@3 ID]-|Message loop exit code.&]
[s7;%% [*/ Возвратное значение]-|`*this.&]
...
[s2;%% То же, что и Execute but return true if button OK was pressed.&]
[s7;%% [*/ Возвратное значение]-|Result true if OK otherwise false.&]
[s3;%% &]
[s4; &]
[s5;:TopWindow`:`:ExecuteCancel`(`): [@(0.0.255) bool]_[* ExecuteCancel]()&]
[s2;%% То же, что и Execute but return true if button Cancel was pressed.&]
[s7;%% [*/ Возвратное значение]-|Result true if Cancel otherwise false.&]
[s3;%% &]
[s4; &]
...
st]&]
[s7;%% [*/ Возвратное значение]-|True if TopWindow is maximized.&]
[s3;%% &]
[s4; &]
[s5;:TopWindow`:`:IsMinimized`(`)const: [@(0.0.255) bool]_[* IsMinimized]()_[@(0.0.255) con
st]&]
[s7;%% [*/ Возвратное значение]-|True if TopWindow is minimized.&]
[s3;%% &]
[s4; &]
[s5;:TopWindow`:`:IsOverlapped`(`)const: [@(0.0.255) bool]_[* IsOverlapped]()_[@(0.0.255) c
onst]&]
[s7;%% [*/ Возвратное значение]-|True if TopWindow is in normal (overlapped) 
state.&]
[s3;%% &]
[s4; &]
...
[s7;%% [*/ Возвратное значение]-|Current title of window.&]
[s3;%% &]
[s4; &]
...
[s2;%% То же, что и Zoomable(false).&]
[s7;%% [*/ Возвратное значение]-|`*this.&]
[s3;%% &]
[s4; &]
[s5;:TopWindow`:`:IsZoomable`(`)const: [@(0.0.255) bool]_[* IsZoomable]()_[@(0.0.255) const
]&]
[s7;%% [*/ Возвратное значение]-|Value of Zoomable flag.&]
[s3;%% &]
[s4; &]
...
[s2;%% То же, что и ToolWindow(false).&]
[s7;%% [*/ Возвратное значение]-|`*this.&]
[s3;%% &]
[s4; &]
[s5;:TopWindow`:`:IsToolWindow`(`)const: [@(0.0.255) bool]_[* IsToolWindow]()_[@(0.0.255) c
onst]&]
[s7;%% [*/ Возвратное значение]-|Value of ToolWindow flag.&]
[s3;%% &]
[s4; &]
...
onst]&]
[s2;%% [*/ Возвратное значение]-|True if window is in fullscreen mode.&]
[s3; &]
[s4; &]
...
[s2;%% [*/ Возвратное значение]-|True if window tries to catch users attention 
by flashing.&]
[s3; &]
[s4; &]
