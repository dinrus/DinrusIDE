...
inline int ZCompress(Поток& out, Поток& in, Gate2<int, int> progress)        { return (int)ZCompress(out, in, AsGate64(progress)); }
inline Ткст ZCompress(const void *данные, int len, Gate2<int, int> progress)   { return ZCompress(данные, len, AsGate64(progress)); }
inline Ткст ZCompress(const Ткст& s, Gate2<int, int> progress)             { return ZCompress(s, AsGate64(progress)); }

inline int    ZDecompress(Поток& out, Поток& in, Gate2<int, int> progress)   { return (int)ZDecompress(out, in, AsGate64(progress)); }
inline Ткст ZDecompress(const Ткст& s, Gate2<int, int> progress)           { return ZDecompress(s, AsGate64(progress)); }
inline Ткст ZDecompress(const void *данные, int len, Gate2<int, int> progress) { return ZDecompress(данные, len, AsGate64(progress)); }

inline int    GZCompress(Поток& out, Поток& in, int size, Gate2<int, int> progress) { return (int)GZCompress(out, in, size, AsGate64(progress)); }
inline int    GZCompress(Поток& out, Поток& in, Gate2<int, int> progress)           { return (int)GZCompress(out, in, AsGate64(progress)); }
inline Ткст GZCompress(const void *данные, int len, Gate2<int, int> progress)         { return GZCompress(данные, len, AsGate64(progress)); }
inline Ткст GZCompress(const Ткст& s, Gate2<int, int> progress)                   { return GZCompress(s, AsGate64(progress)); }

inline int    GZDecompress(Поток& out, Поток& in, int size, Gate2<int, int> progress) { return (int)GZDecompress(out, in, size, AsGate64(progress)); }
inline int    GZDecompress(Поток& out, Поток& in, Gate2<int, int> progress)           { return (int)GZDecompress(out, in, AsGate64(progress)); }
inline Ткст GZDecompress(const void *данные, int len, Gate2<int, int> progress)         { return GZDecompress(данные, len, AsGate64(progress)); }
inline Ткст GZDecompress(const Ткст& s, Gate2<int, int> progress)                   { return GZDecompress(s, AsGate64(progress)); }
