...
///
/// добавь std::hash support for glm types

#pragma once

#ifndef GLM_ENABLE_EXPERIMENTAL
#	Ошибка "GLM: GLM_GTX_hash is an experimental extension and may change in the future. Use #define GLM_ENABLE_EXPERIMENTAL before including it, if you really want to use it."
#endif
...
#	Ошибка "GLM_GTX_hash requires C++11 standard library support"
#endif
