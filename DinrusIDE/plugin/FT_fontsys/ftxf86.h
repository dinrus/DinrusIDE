...
FT_BEGIN_HEADER
  ...
  /*                                                                       */
  /* <Abstract>                                                            */
  /*   Getting the font формат.                                            */
  /*                                                                       */
  /* <Description>                                                         */
  /*   The single function in this section can be used to get the font     */
  /*   формат.  Note that this information is not needed normally;         */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*   Return a string describing the формат of a given face, using values */
  ...
  /*                                                                       */
  /* <Return>                                                              */
  /*   Шрифт формат string.  NULL in case of Ошибка.                         */
  /*                                                                       */
