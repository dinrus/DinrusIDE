...
#include <wxCtrls/cmdline.h>
#include <wxCtrls/evtloop.h>
#include <wxCtrls/msgout.h>
#include <wxCtrls/thread.h>
#include <wxCtrls/vidmode.h>
#include <wxCtrls/ptr_scpd.h>

#ifdef __WXDEBUG__
    #if wxUSE_STACKWALKER
        #include <wxCtrls/stackwalk.h>
    #endif // wxUSE_STACKWALKER
#endif // __WXDEBUG__

#if defined(__WXMSW__)
    #include  <wxCtrls/msw/private.h>  // includes windows.h for LOGFONT
#endif
...
void wxGUIAppTraitsBase::RemoveFromPendingDelete(wxObject *object)
{
    ...
    #include <wxCtrls/msw/gsockmsw.h>
#elif defined(__UNIX__) || defined(__DARWIN__) || defined(__OS2__)
    #include <wxCtrls/unix/gsockunx.h>
    ...
    #include <wxCtrls/mac/gsockmac.h>
#else
