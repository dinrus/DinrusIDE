...
#define FT_ADVANCE_FLAG_FAST_ONLY  0x20000000UL
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    Retrieve the advance значение of a given glyph outline in an          */
  ...
  /* <Output>                                                              */
  /*    padvance :: The advance значение, in either font units or 16.16       */
  /*                формат.                                                */
  /*                                                                       */
  ...
  /*                                                                       */
  /*    A scaled advance is returned in 16.16 формат but isn't transformed */
  ...
  /*                                                                       */
  /* <Output>                                                              */
  /*    padvance :: The advances, in either font units or 16.16 формат.    */
  ...
  /*    retrieve the advances.                                             */
  /*                                                                       */
  /*    Scaled advances are returned in 16.16 формат but aren't            */
