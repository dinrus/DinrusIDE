...
#include <wxCtrls/defs.h> // headers should include this before first wxUSE_XXX check

#if wxUSE_LISTCTRL

#include <wxCtrls/listbase.h>
...
// ----------------------------------------------------------------------------
    ...
    #include <wxCtrls/msw/listctrl.h>
#elif defined(__WXMAC__) && !defined(__WXUNIVERSAL__)
    #include <wxCtrls/mac/carbon/listctrl.h>
#else
    #include <wxCtrls/generic/listctrl.h>
#endif
