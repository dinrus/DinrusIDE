...
[s2; 
@@image:1350&150
‚ѓШЂЂЂЂѓияЂЂЂЂшЇњн™БЌВ°МЊЕ™ЅЃЂЌъАЬБвЃ¤ЋЊАЉИЭЃ¬ОФаДоТє›Ћ“юл‰Гљэкюю—ѓФсБхњЃЂЂьЩ
тџОЂФЃдрхЌВ™——Гкп“ЩћУр„р†ЪЭ‘Г§цмшЦётиКЋНюЉПНбоїёеЫЉ—–Ао¦выуД»’…·®ЛєррУ«ы­ојњнЮВ©
ћ›че±Ре‚цебњдд°Љ–ќ–ПР…ѕтЁИЋ¬б€‹Ю•вЦ€дўЅм†КѕЁиЗФшчґх¬ґџ¤зГ°‰у№ьјОЁ»буиЇ·И‚ЦИћЕ»д­
БіВ”­«ДКхяГБ”•оЉщуРҐ‡т¶ў‡¦«з°є¤ќЫТБјМЉДъ®жОе¶тЁвЅ“ЃИЎв№¬‰ьъ«нђМЙп™бЉ–•ўѓшњОцьћЛЬ
јб”ЅД­ђц¤б еЁЪЎЛ›’ҐН§­жФрЌОќЙэ­ПРРДУ•ЮўЬ»тёАЋрК–№—¦ҐјЬчСјЯцвЗж…Ш‹№ьЬЇЂ‡Берц™Ђ°
¤Гё—СЁЛВЂЋСћЉ№ДщЕЁ©‡џ°њЩЂё
&]
[s2; &]
...
[s4; [*/ Возвратное значение]-|rectangular tab bounding box within the HeaderCtrl.&]
[s0;* &]
...
[s4; [*/ Возвратное значение]-|a (constant) reference to the [* Column] structure 
describing the tab.&]
[s0;3 &]
...
[s4; [*C@3 i]-|Tab index (zero based).&]
[s4; [*/ Возвратное значение]-|a non`-constant reference to the [* Column] structure 
for the given tab.&]
[s0;3 &]
...
[s4; [*C@3 i]-|Tab index (zero based).&]
[s4; [*/ Возвратное значение]-|a constant reference to the given header tab.&]
[s0;3 &]
...
[s4; [*C@3 i]-|tab index (zero based).&]
[s4; [*/ Возвратное значение]-|[* false] `= hidden, [* true] `= shown.&]
[s0;3 &]
...
[s4; [*C@3 i]-|tab index (zero based)&]
[s4; [*/ Возвратное значение]-|current logical tab width&]
[s0;3 &]
...
[s4; [*C@3 i]-|tab index (zero based)&]
[s4; [*/ Возвратное значение]-|physical (pixel) tab width. Note that this function 
...
bounding box).&]
[s4; [*/ Возвратное значение]-|Index of tab break (in the range `[0..GetCount()`]) 
...
side of parent view).&]
[s4; [*/ Возвратное значение]-|Number of pixels by which the header control 
...
[s4; [*/ Возвратное значение]-|[* true] `= scrolling header, [* false ]`= non`-scrolling 
header.&]
[s0;3 &]
