...
#include <wxCtrls/spinbutt.h>        // should make wxSpinEvent visible to the app
...
// ----------------------------------------------------------------------------
    ...
    #include <wxCtrls/generic/spinctlg.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/spinctrl.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/spinctrl.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/spinctrl.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/spinctrl.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/generic/spinctlg.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/spinctrl.h>
