...
#if defined(__WXPALMOS__)
    #include <wxCtrls/palmos/region.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/region.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/region.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/region.h>
#elif defined(__WXMOTIF__) || defined(__WXX11__)
    #include <wxCtrls/x11/region.h>
#elif defined(__WXMGL__)
    #include <wxCtrls/mgl/region.h>
#elif defined(__WXDFB__)
    #include <wxCtrls/dfb/region.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/region.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/region.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/region.h>
#endif
