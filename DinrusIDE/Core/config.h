...
#include <main.conf.h>
	...
	#define COMPILER_CLANG 1
		...
		//BF toolchain has no support for __thread (TLS), so U++ Куча not possible
		#define flagUSEMALLOC
	#else
		#Ошибка Неизвестная архитектура ЦПБ
	#endif
#endif
	...
	#if _MSC_VER <= 1300
		#Ошибка  MSC 6.0 больше не поддерживается
	#endif
...
#define WCHAR32 1 // this версия of U++ has 32 bit wchar
