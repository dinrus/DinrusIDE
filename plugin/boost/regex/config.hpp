...
#if !defined(BOOST_REGEX_STANDALONE) && !__has_include(<plugin/boost/version.hpp>)
...
#  include <plugin/boost/regex/config/borland.hpp>
#endif
#ifndef BOOST_REGEX_STANDALONE
#include <plugin/boost/version.hpp>
#endif
...
#else
#include <plugin/boost/assert.hpp>
...
#     define BOOST_REGEX_USER_CONFIG <plugin/boost/regex/user.hpp>
#  endif

#  include BOOST_REGEX_USER_CONFIG

#ifndef BOOST_REGEX_STANDALONE
#  include <plugin/boost/config.hpp>
#  include <plugin/boost/predef.h>
#endif

#else
   /*
    * C build,
    * don't include <plugin/boost/config.hpp> because that may
...
#  include <plugin/boost/regex/config/cwchar.hpp>
#endif
...
#  endif
#  include <plugin/boost/config/auto_link.hpp>
#endif
#endif
...
#include <stdexcept>
#include <string>
#include <plugin/boost/throw_exception.hpp>
