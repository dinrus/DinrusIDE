...
#include <wxCtrls/event.h>           // the base class

#include <wxCtrls/list.h>            // defines wxWindowList

#include <wxCtrls/cursor.h>          // we have member variables of these classes
#include <wxCtrls/font.h>            // so we can't do without them
#include <wxCtrls/colour.h>
#include <wxCtrls/region.h>
#include <wxCtrls/utils.h>
#include <wxCtrls/intl.h>

#include <wxCtrls/validate.h>        // for wxDefaultValidator (always include it)
...
#if wxUSE_ACCEL
    #include <wxCtrls/accel.h>
#endif // wxUSE_ACCEL

#if wxUSE_ACCESSIBILITY
#include <wxCtrls/access.h>
#endif
...
// include the declaration of the platform-specific class
    ...
    #endif // wxUniv/!wxUniv
    #include <wxCtrls/palmos/window.h>
    ...
    #endif // wxUniv/!wxUniv
    #include <wxCtrls/msw/window.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/window.h>
    ...
    #endif // wxUniv
    #include <wxCtrls/x11/window.h>
#elif defined(__WXMGL__)
    #define wxWindowNative wxWindowMGL
    #include <wxCtrls/mgl/window.h>
#elif defined(__WXDFB__)
    #define wxWindowNative wxWindowDFB
    #include <wxCtrls/dfb/window.h>
    ...
    #endif // wxUniv
    #include <wxCtrls/cocoa/window.h>
