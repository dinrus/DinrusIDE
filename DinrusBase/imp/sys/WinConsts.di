...
/***
***/
// MinGW: also in ddk/windamigos.dk.в
const бцел
...
/+
PIMAGE_SECTION_HEADER IMAGE_FIRST_SECTION(PIMAGE_NT_HEADERS в) {
	return cast(PIMAGE_SECTION_HEADER)
		(&в.OptionalHeader + в.FileHeader.SizeOfOptionalHeader);
}
...
///////////////////////////////////////////////////////////
// MinGW: Также в ddk/windamigos.dk.в	
...
enum ПФлагиАИ: цел
{
         ...
         В4Картир = 0x00000800,              /// On v6 failure, query v4 and преобразуй на_это V4MAPPED фмт
