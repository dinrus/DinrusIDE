...
protected:
    ...
    #include <wxCtrls/univ/gauge.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/gauge95.h>
    #define wxGauge wxGauge95
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/gauge.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/gauge.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/gauge.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/gauge.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/gauge.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/gauge.h>
#endif
