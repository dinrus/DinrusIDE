...
#include <wxCtrls/control.h>         // the base class
#include <wxCtrls/dynarray.h>        // wxArrayInt
#include <wxCtrls/gdicmn.h>          // wxPoint
...
// ----------------------------------------------------------------------------
    ...
    #include <wxCtrls/x11/textctrl.h>
#elif defined(__WXUNIVERSAL__)
    #include <wxCtrls/univ/textctrl.h>
#elif defined(__SMARTPHONE__) && defined(__WXWINCE__)
    #include <wxCtrls/msw/wince/textctrlce.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/textctrl.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/textctrl.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/textctrl.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/textctrl.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/textctrl.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/textctrl.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/textctrl.h>
#endif
