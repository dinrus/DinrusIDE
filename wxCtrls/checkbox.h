...
private:
    ...
    #include <wxCtrls/univ/checkbox.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/checkbox.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/checkbox.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/checkbox.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/checkbox.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/checkbox.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/checkbox.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/checkbox.h>
#elif defined(__WXPALMOS__)
    #include <wxCtrls/palmos/checkbox.h>
#endif
