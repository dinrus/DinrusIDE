...
#define GXV_KERN_SUBTABLE_HEADER_SIZE  ( KERN_IS_NEW( valid ) ? 8 : 6 )
                                         ...
                                         GXV_Validator  valid )
  {
    ...
    GXV_NAME_ENTER( "kern формат 0 pairs" );
                                   ...
                                   GXV_Validator  valid )
  {
    ...
    GXV_NAME_ENTER( "kern subtable формат 0" );
                                   ...
                                   GXV_Validator  valid )
  {
    ...
    GXV_NAME_ENTER( "kern subtable формат 1" );
...
#define GXV_KERN_FMT2_DATA( field )                         \
                                          ...
                                          GXV_Validator       valid )
  {
    ...
    GXV_NAME_ENTER( "kern формат 2 classTable" );
                                   ...
                                   GXV_Validator  valid )
  {
    ...
    GXV_NAME_ENTER( "kern subtable формат 2" );
                                   ...
                                   GXV_Validator  valid )
  {
    ...
    GXV_NAME_ENTER( "kern subtable формат 3" );
    ...
    if ( flags != 0 )
      GXV_TRACE(( "kern subtable fmt3 has nonzero значение"
                  " (%d) in unused flag\n", flags ));
    /*
                                        ...
                                        GXV_Validator  valid )
  {
    ...
    *формат = (FT_UShort)( coverage & 0x0003 );

    GXV_TRACE(( "new Apple-dialect: "
                "horizontal=%d, cross-stream=%d, variation=%d, формат=%d\n",
                 !kernVertical, kernCrossStream, kernVariation, *формат ));

    GXV_TRACE(( "kerning values in Apple формат subtable are ignored\n" ));
                                            ...
                                            GXV_Validator  valid )
  {
    ...
    *формат = (FT_UShort)( coverage & 0x0003 );
    ...
    GXV_TRACE(( "classic Apple-dialect: "
                "horizontal=%d, cross-stream=%d, формат=%d\n",
                 horizontal, cross_stream, *формат ));

    /* формат 1 requires GX State Machine, too new for classic */
    if ( *формат == 1 )
      return FALSE;
                                                ...
                                                GXV_Validator  valid )
  {
    ...
    *формат = (FT_UShort)( ( coverage >> 8 ) & 0x0003 );

    GXV_TRACE(( "classic Microsoft-dialect: "
                "horizontal=%d, minimum=%d, cross-stream=%d, "
                "override=%d, формат=%d\n",
                horizontal, minimum, cross_stream, override, *формат ));

    if ( *формат == 2 )
      GXV_TRACE((
        "kerning values in Microsoft формат 2 subtable are ignored\n" ));
                              ...
                              GXV_Validator  valid )
  {
...
#endif
    FT_UShort  u16[2];
    FT_UShort  формат = 255;   /* subtable формат */
    ...
    switch ( gxv_kern_coverage_validate( coverage, &формат, valid ) )
    {
