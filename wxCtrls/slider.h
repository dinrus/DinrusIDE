...
// ----------------------------------------------------------------------------
    ...
    #include <wxCtrls/univ/slider.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/slider95.h>
    #if WXWIN_COMPATIBILITY_2_4
         #define wxSlider95 wxSlider
    #endif
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/slider.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/slider.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/slider.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/slider.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/slider.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/slider.h>
#elif defined(__WXPALMOS__)
    #include <wxCtrls/palmos/slider.h>
#endif
