...
// ----------------------------------------------------------------------------
    ...
    #include <wxCtrls/msw/ole/dropsrc.h>
    #include <wxCtrls/msw/ole/droptgt.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/dnd.h>
#elif defined(__WXX11__)
    #include <wxCtrls/x11/dnd.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/dnd.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/dnd.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/dnd.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/dnd.h>
#endif
