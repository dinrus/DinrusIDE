...
#define  FT_STROKE_TAG_BEGIN_END  ( FT_STROKE_TAG_BEGIN | FT_STROKE_TAG_END )
                           ...
                           FT_Bool          movable )
  {
    ...
    else
    {
      ...
      /* add one point */
      Ошибка = ft_stroke_border_grow( border, 1 );
      if ( !Ошибка )
      {
                            ...
                            FT_Vector*       to )
  {
    ...
    Ошибка = ft_stroke_border_grow( border, 2 );
    if ( !Ошибка )
    {
      FT_Vector*  vec = border->points + border->num_points;
      FT_Byte*    tag = border->tags   + border->num_points;
                            ...
                            FT_Vector*       to )
  {
    ...
    Ошибка = ft_stroke_border_grow( border, 3 );
    if ( !Ошибка )
    {
      FT_Vector*  vec = border->points + border->num_points;
      FT_Byte*    tag = border->tags   + border->num_points;
...
#define FT_ARC_CUBIC_ANGLE  ( FT_ANGLE_PI / 2 )
                          ...
                          FT_Angle         angle_diff )
  {
    ...
    while ( total != 0 )
    {
      ...
      /* add cubic arc */
      Ошибка = ft_stroke_border_cubicto( border, &a2, &b2, &b );
      if ( Ошибка )
        break;
...
#define FT_SIDE_TO_ROTATE( s )   ( FT_ANGLE_PI2 - (s) * FT_ANGLE_PI )
                  ...
                  FT_Fixed             miter_limit )
  {
    ...
    /* ensure miter limit has sensible значение */
                    ...
                    FT_Int      side )
  {
    ...
    Ошибка = ft_stroke_border_arcto( border,
                                    &stroker->center,
                                    radius,
                  ...
                  FT_Int      side )
  {
    ...
    if ( stroker->line_cap == FT_STROKER_LINECAP_ROUND )
    {
      ...
      Ошибка = ft_stroker_arcto( stroker, side );
    }
    else if ( stroker->line_cap == FT_STROKER_LINECAP_SQUARE )
    {
      ...
      Ошибка = ft_stroke_border_lineto( border, &delta, FALSE );
      if ( Ошибка )
        goto Exit;
                             ...
                             FT_Fixed    line_length )
  {
    ...
    Ошибка = ft_stroker_inside( stroker, inside_side, line_length );
    if ( Ошибка )
      goto Exit;

    /* process the outside side */
    Ошибка = ft_stroker_outside( stroker, 1 - inside_side, line_length );
                            ...
                            FT_Fixed    line_length )
  {
    ...
    Ошибка = ft_stroke_border_moveto( border, &point );
    if ( Ошибка )
      goto Exit;
                     ...
                     FT_Vector*  to )
  {
    ...
    if ( stroker->first_point )
    {
      ...
      /* point locations.                                        */
      Ошибка = ft_stroker_subpath_start( stroker, angle, line_length );
      if ( Ошибка )
        goto Exit;
    }
    else
    {
      ...
      Ошибка = ft_stroker_process_corner( stroker, line_length );
      if ( Ошибка )
        goto Exit;
    }
    ...
    for ( border = stroker->borders, side = 1; side >= 0; side--, border++ )
    {
      ...
      Ошибка = ft_stroke_border_lineto( border, &point, TRUE );
      if ( Ошибка )
        goto Exit;
                      ...
                      FT_Vector*  to )
  {
    ...
    while ( arc >= bez_stack )
    {
      ...
      if ( first_arc )
      {
        ...
        /* process corner if necessary */
        if ( stroker->first_point )
          Ошибка = ft_stroker_subpath_start( stroker, angle_in, 0 );
        else
        {
          stroker->angle_out = angle_in;
          Ошибка = ft_stroker_process_corner( stroker, 0 );
        }
      }
              ...
              side++, border++ )
        {
          ...
          if ( stroker->handle_wide_strokes )
          {
                   ...
                   FT_ANGLE_PI / 2                             )
            {
              ...
              if ( Ошибка )
                goto Exit;
              Ошибка = ft_stroke_border_lineto( border, &end, FALSE );
              if ( Ошибка )
                goto Exit;
              Ошибка = ft_stroke_border_conicto( border, &ctrl, &start );
              if ( Ошибка )
                goto Exit;
          ...
          /* simply add an arc */
          Ошибка = ft_stroke_border_conicto( border, &ctrl, &end );
          if ( Ошибка )
            goto Exit;
        }
      }
              ...
              side++, border++ )
        {
          ...
          if ( stroker->handle_wide_strokes )
          {
                   ...
                   FT_ANGLE_PI / 2                             )
            {
              ...
              if ( Ошибка )
                goto Exit;
              Ошибка = ft_stroke_border_cubicto( border,
                                                &ctrl2,
                                                &ctrl1,
                                                &start );
              if ( Ошибка )
          ...
          /* simply add an arc */
          Ошибка = ft_stroke_border_cubicto( border, &ctrl1, &ctrl2, &end );
          if ( Ошибка )
            goto Exit;
        }
      }
                               ...
                               FT_Bool     open )
  {
    ...
    if ( new_points > 0 )
    {
      Ошибка = ft_stroke_border_grow( right, (FT_UInt)new_points );
      if ( Ошибка )
        goto Exit;
  ...
  FT_Stroker_EndSubPath( FT_Stroker  stroker )
  {
    ...
    if ( stroker->subpath_open )
    {
      ...
      /* between left & right.                                           */
      Ошибка = ft_stroker_cap( stroker, stroker->angle_in, 0 );
      if ( Ошибка )
        goto Exit;

      /* add reversed points from `left' to `right' */
      Ошибка = ft_stroker_add_reverse_left( stroker, TRUE );
      if ( Ошибка )
        goto Exit;

      /* now add the final cap */
      stroker->center = stroker->subpath_start;
      Ошибка = ft_stroker_cap( stroker,
    ...
    else
    {
      ...
      {
         Ошибка = FT_Stroker_LineTo( stroker, &stroker->subpath_start );
         if ( Ошибка )
           goto Exit;
      }
      ...
      if ( turn != 0 )
      {
        ...
        Ошибка = ft_stroker_inside( stroker,
                                   inside_side,
        ...
        /* process the outside side */
        Ошибка = ft_stroker_outside( stroker,
                                    1 - inside_side,
                                    stroker->subpath_line_length );
        if ( Ошибка )
          goto Exit;
                              ...
                              FT_UInt          *anum_contours )
  {
    ...
    Ошибка = ft_stroke_border_get_counts( stroker->borders + border,
                        ...
                        FT_UInt    *anum_contours )
  {
    ...
    Ошибка = ft_stroke_border_get_counts( stroker->borders + 0,
                                         &count1, &count2 );
    if ( Ошибка )
      goto Exit;

    Ошибка = ft_stroke_border_get_counts( stroker->borders + 1,
                                         &count3, &count4 );
    if ( Ошибка )
      goto Exit;
                           ...
                           FT_Bool      opened )
  {
    ...
    for ( n = 0; n < outline->n_contours; n++ )
    {
      ...
      Ошибка = FT_Stroker_BeginSubPath( stroker, &v_start, opened );
      if ( Ошибка )
        goto Exit;
      ...
      while ( point < limit )
      {
        ...
        case FT_CURVE_TAG_ON:  /* emit a single line_to */
          {
            ...
            Ошибка = FT_Stroker_LineTo( stroker, &vec );
            if ( Ошибка )
              goto Exit;
            continue;
          }
        ...
        Do_Conic:
          if ( point < limit )
          {
            ...
            {
              Ошибка = FT_Stroker_ConicTo( stroker, &v_control, &vec );
              if ( Ошибка )
                goto Exit;
              continue;
            }
            ...
            Ошибка = FT_Stroker_ConicTo( stroker, &v_control, &v_middle );
            if ( Ошибка )
              goto Exit;
          ...
          Ошибка = FT_Stroker_ConicTo( stroker, &v_control, &v_start );
          goto Close;
        ...
        default:  /* FT_CURVE_TAG_CUBIC */
          {
            ...
            if ( point <= limit )
            {
              ...
              Ошибка = FT_Stroker_CubicTo( stroker, &vec1, &vec2, &vec );
              if ( Ошибка )
                goto Exit;
              continue;
            }

            Ошибка = FT_Stroker_CubicTo( stroker, &vec1, &vec2, &v_start );
            goto Close;
          }
        }
      }
    ...
    Close:
      ...
      Ошибка = FT_Stroker_EndSubPath( stroker );
      if ( Ошибка )
        goto Exit;
...
#include "basepic.h"
                   ...
                   FT_Bool      destroy )
  {
...

    {
      ...
      Ошибка = FT_Glyph_Copy( glyph, &copy );
      if ( Ошибка )
        goto Exit;
...

    {
      ...
      Ошибка = FT_Stroker_ParseOutline( stroker, outline, FALSE );
      if ( Ошибка )
        goto Fail;
      ...
      Ошибка = FT_Outline_New( glyph->library,
