...
///
/// Defines a templated dual-quaternion тип and several dual-quaternion operations.
...
#	Ошибка "GLM: GLM_GTX_dual_quaternion is an experimental extension and may change in the future. Use #define GLM_ENABLE_EXPERIMENTAL before including it, if you really want to use it."
#endif
...
#else
#	Ошибка "GLM Ошибка: multiple default precision requested for single-precision floating-point types"
#endif
...
#else
#	Ошибка "GLM Ошибка: Multiple default precision requested for double-precision floating-point types"
#endif
