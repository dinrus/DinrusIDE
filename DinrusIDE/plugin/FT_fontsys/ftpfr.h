...
FT_BEGIN_HEADER
  ...
  *
  * @note:
  *   If the input face is not a PFR, this function will return an Ошибка.
  ...
  *
  *    left  :: Индекс of the left glyph.
  *
  *    right :: Индекс of the right glyph.
  *
  * @output:
  ...
  *
  *    You can use the значение of the `x_scale' and `y_scale' parameters
