...
#include <wxCtrls/list.h>        // for "template" list classes
#include <wxCtrls/window.h>      // base class for wxMenuBar
...
// ----------------------------------------------------------------------------
    ...
    #include <wxCtrls/univ/menu.h>
#elif defined(__WXPALMOS__)
    #include <wxCtrls/palmos/menu.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/menu.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/menu.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/menu.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/menu.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/menu.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/menu.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/menu.h>
#endif
