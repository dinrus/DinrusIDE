...
FT_BEGIN_HEADER
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    копируй a bitmap into another one.                                    */
  /*                                                                       */
  /* <Input>                                                               */
  ...
  /*                 Expressed in 26.6 pixel формат.                       */
  /*                                                                       */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    Преобр a bitmap object with depth 1bpp, 2bpp, 4bpp, or 8bpp to a  */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    сделай sure that a glyph slot owns `slot->bitmap'.                   */
  /*                                                                       */
  /* <Input>                                                               */
  /*    slot :: The glyph slot.                                            */
  /*                                                                       */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    разрушь a bitmap object created with @FT_Bitmap_New.               */
  /*                                                                       */
  /* <Input>                                                               */
  /*    library :: A handle to a library object.                           */
  /*                                                                       */
