...
// ----------------------------------------------------------------------------
    ...
    #include <wxCtrls/univ/statline.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/statline.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/statline.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/statline.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/statline.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/statline.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/statline.h>
#else // use generic implementation for all other platforms
    #include <wxCtrls/generic/statline.h>
#endif
