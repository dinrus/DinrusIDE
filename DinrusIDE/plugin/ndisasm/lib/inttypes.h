...
#Ошибка "Neither long nor long long is 64 bits in size"

#endif

/*** 32-bit тип: int or long ***/
...
#Ошибка "Neither int nor long is 32 bits in size"
...
#Ошибка "Neither short nor int is 16 bits in size"
...
#Ошибка "char is not 8 bits in size"
