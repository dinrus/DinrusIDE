...
#define  psh_corner_orientation  ft_corner_orientation
                  ...
                  PSH_Globals  globals )
  {
    ...
    Ошибка = psh_hint_table_init( &glyph->hint_tables [0],
    ...
    Ошибка = psh_hint_table_init( &glyph->hint_tables [1],
...
#define PSH_STRONG_THRESHOLD  32
  ...
  /* the maximum shift значение in font units */
...
#define  PSH_MAX_STRONG_INTERNAL  16
                  ...
                  FT_Render_Mode  hint_mode )
  {
    ...
    Ошибка = psh_glyph_init( glyph, outline, ps_hints, globals );
    if ( Ошибка )
      goto Exit;
