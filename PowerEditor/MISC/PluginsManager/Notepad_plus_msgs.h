...
#define NPPMSG  (WM_USER + 1000)
    ...
    #define NPPM_DMMGETPLUGINWindow&BYNAME (NPPMSG + 43)
    //Window* WM_DMM_GETPLUGINWindow&BYNAME(const char *windowName, const char *moduleName)
    // if moduleName is nullptr, then return value is nullptr
    // if windowName is nullptr, then the first found window handle which matches with the moduleName will be returned
    ...
    // Users should call it with "str" be nullptr to get the required number of char (not including the terminating nul character),
    ...
    // if destModule or info is nullptr, then return value is FALSE
    ...
    // User should call it with fullFilePath be nullptr to get the number of char (not including the nul character),
    ...
    // You should call this function 2 times - the first time you pass langName as nullptr to get the number of characters to copy.
    ...
    // Return value is the number of copied character / number of character to copy (\0 is not included)
    // You should call this function 2 times - the first time you pass langDesc as nullptr to get the number of characters to copy.
    ...
    // Returns the number of char copied/to copy.
    // Users should call it with pluginRootPath be nullptr to get the required number of char (not including the terminating nul character),
    ...
    // Users should call it with settingsCloudPath be nullptr to get the required number of char (not including the terminating nul character),
    ...
    // Returns the number of char copied/to copy.
    // Users should call it with commandLineStr as nullptr to get the required number of char (not including the terminating nul character),
...
#define NPPN_FIRST 1000
    ...
    //scnNotification->nmhdr.code = NPPN_FILEBEFOREOPEN;
    //scnNotification->nmhdr.hwndFrom = hwndNpp;
    //scnNotification->nmhdr.idFrom = nullptr;
    ...
    //scnNotification->nmhdr.hwndFrom = nullptr;
    //scnNotification->nmhdr.idFrom = BufferID;
