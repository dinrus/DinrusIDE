...
/*  autohint.h                                                             */
/*                                                                         */
/*    наибольш-level `autohint' module-specific interface (specification).     */
/*                                                                         */
...
/***************************************************************************/
  ...
  /* формат-specific hinter isn't available.                               */
  /*                                                                       */
  /*************************************************************************/
...
#define __AUTOHINT_H__
  ...
  /* to cache these too, you are simply in need of a new font формат,      */
