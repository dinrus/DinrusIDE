...
// implementation classes:
    ...
    #include <wxCtrls/msw/mimetype.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/mimetype.h>
#elif defined(__WXPM__) || defined (__EMX__)
    #include <wxCtrls/os2/mimetype.h>
    #undef __UNIX__
#elif defined(__DOS__)
    #include <wxCtrls/msdos/mimetype.h>
#else // Unix
    #include <wxCtrls/unix/mimetype.h>
#endif
