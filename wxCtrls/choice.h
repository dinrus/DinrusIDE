...
#include <wxCtrls/ctrlsub.h>     // the base class
...
// ----------------------------------------------------------------------------
    ...
    #include <wxCtrls/univ/choice.h>
#elif defined(__SMARTPHONE__) && defined(__WXWINCE__)
    #include <wxCtrls/msw/wince/choicece.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/choice.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/choice.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/choice.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/choice.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/choice.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/choice.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/choice.h>
#endif
