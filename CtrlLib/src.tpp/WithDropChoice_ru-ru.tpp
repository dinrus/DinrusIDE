...
&]
[s0;%RU-RU &]
[s9;%RU-RU This template class adds a list of choices, with drop 
down button placed at right side of the frame, to any widget 
with associated value accessible via SetData/GetData interface.&]
[s3;%RU-RU &]
[s0; &]
[ {{10000F(128)G(128)@1 [s0;%RU-RU [* Список Публичных Членов]]}}&]
[s3; &]
[s5;:WithDropChoice`:`:WhenDrop: [_^Callback^ Callback]_[* WhenDrop]&]
[s2;%RU-RU This callback is invoked when the drop button is pushed 
(before drop down list appears). Client code can use it to create 
or alter the list.&]
[s3;%RU-RU &]
[s4; &]
[s5;:WithDropChoice`:`:WhenSelect: [_^Callback^ Callback]_[* WhenSelect]&]
[s2;%RU-RU This callback is called after user selected an item from 
drop`-down list and this value was assigned to the base widget.&]
[s3;%RU-RU &]
[s4; &]
[s5;:WithDropChoice`:`:ClearList`(`): [@(0.0.255) void]_[* ClearList]()&]
[s2;%RU-RU Clears the drop`-down list.&]
[s3;%RU-RU &]
[s4; &]
[s5;:WithDropChoice`:`:AddList`(const Value`&`): [@(0.0.255) void]_[* AddList]([@(0.0.255) c
onst]_[_^Value^ Value][@(0.0.255) `&]_[*@3 data])&]
[s2;%RU-RU Adds [%-*@3 data] to the drop`-down list.&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Adds [%-*@3 data] to the drop`-down list, by only if it 
...
[s2;%RU-RU Finds the index of first list entry equal to [%-*@3 data].&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Устанавливает entry [%-*@3 i] in drop`-down 
list to [%-*@3 data] .&]
[s3;%RU-RU &]
[s4; &]
[s5;:Upp`:`:WithDropChoice`:`:Remove`(int`): [@(0.0.255) void]_[* Remove]([@(0.0.255) int]_
[*@3 i])&]
[s2;%RU-RU Removes entry [%-*@3 i] in drop`-down list.&]
[s3;%RU-RU &]
[s4; &]
[s5;:WithDropChoice`:`:SerializeList`(Stream`&`): [@(0.0.255) void]_[* SerializeList]([_^Stream^ S
tream][@(0.0.255) `&]_[*@3 s])&]
[s2;%RU-RU Serializes the drop`-down list content.&]
[s3;%RU-RU &]
[s4; &]
[s5;:WithDropChoice`:`:AddHistory`(int`): [@(0.0.255) void]_[* AddHistory]([@(0.0.255) int]_
[*@3 max]_`=_[@3 12])&]
[s2;%RU-RU This method puts the value to the begin of drop`-down 
list. If value is already in the list, it is removed first (values 
...
[s2;%RU-RU In this mode, drop button is visible. Can be used to temporarily 
...
[* NoDropFocus]()&]
[s2;%RU-RU If NoDropFocus is active, focus is not moved to base widget 
...
[s2;%RU-RU Устанавливает the maximum height of drop`-down 
list to accommodate [%-*@3 n] lines (scrollbar appears if there 
is more than that).&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Устанавливает the Display to be used with 
drop`-down list item [%-*@3 i].&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Устанавливает the Display to be used with 
drop`-down list, unless item`-specific Display is assigned.&]
[s3;%RU-RU &]
[s4; &]
[s5;:WithDropChoice`:`:SetLineCy`(int`): [_^WithDropChoice^ WithDropChoice][@(0.0.255) `&
]_[* SetLineCy]([@(0.0.255) int]_[*@3 lcy])&]
[s2;%RU-RU Устанавливает the line height of drop`-down 
display.&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Устанавливает the Convert to be used with 
drop`-down list item [%-*@3 i].&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Если активен, drop button is visible even if 
the list is empty (client code can fill it using WhenDrop callback).&]
[s3; &]
[s4; &]
...
[s2;%RU-RU Instead of disabling the drop arrow when the list is empty 
...
[s2;%RU-RU Если активен, allows changing value even by 
drop even if ReadOnly.&]
[s3;%RU-RU &]
[s4; &]
[s5;:WithDropChoice`:`:WithWheel`(bool`): [_^WithDropChoice^ WithDropChoice][@(0.0.255) `&
]_[* WithWheel]([@(0.0.255) bool]_[*@3 b]_`=_[@(0.0.255) true])&]
[s2;%RU-RU Widget reacts to mousewheel. This is active by default.&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Set the width of the drop down list to [%-*@3 w].&]
[s3;%RU-RU &]
[s4; &]
[s5;:WithDropChoice`:`:DropWidthZ`(int`): [_^WithDropChoice^ WithDropChoice][@(0.0.255) `&
]_[* DropWidthZ]([@(0.0.255) int]_[*@3 w])&]
[s2;%RU-RU Set the width of the drop down list to a value obtained 
by zooming [%-*@3 w] in accordance with font scaling.&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Если активен, Up and Down keys cycle through 
the history. Default is active..&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Устанавливает the frame style to [%-_^MultiButton`:`:Style^ Mul
tiButton`::Style] [%-*@3 s].&]
[s3;%RU-RU &]
[s0; ]]