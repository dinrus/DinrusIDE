...
#include <wxCtrls/defs.h>
    ...
    #pragma message <wxCtrls/wave.h header is deprecated, use wx/sound.h and wxSound"
#elif defined(__WATCOMC__) || defined(__VISUALC__)
    #pragma message (<<wxCtrls//wave.h header is deprecated, use wx/sound.h and wxSound")
#else
    #warning <wxCtrls/wave.h header is deprecated, use wx/sound.h and wxSound"
#endif
    #include <wxCtrls/sound.h>
    // wxSound used to be called wxWave before wxWidgets 2.5.1:
    typedef wxSound wxWave;
#else
    #error <wxCtrls/wave.h is only available in compatibility mode"
#endif
