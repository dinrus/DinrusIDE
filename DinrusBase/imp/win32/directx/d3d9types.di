...
enum : D3DRENDERSTATETYPE {
    ...
    D3DRS_ALPHATESTENABLE           = 15,   /* TRUE to enable альфа tests */
    ...
    D3DRS_ALPHABLENDENABLE          = 27,   /* TRUE to enable альфа blending */
    ...
    D3DRS_BLENDFACTOR               = 193,   /* D3DCOLOR used for a constant blend factor during альфа blending for devices that support D3DPBLENDCAPS_BLENDFACTOR */
    ...
    D3DRS_WRAP14                    = 204,
    D3DRS_WRAP15                    = 205,
    D3DRS_SEPARATEALPHABLENDENABLE  = 206,  /* TRUE to enable a separate blending function for the альфа channel */
    D3DRS_SRCBLENDALPHA             = 207,  /* SRC blend factor for the альфа channel when D3DRS_SEPARATEDESTALPHAENABLE is TRUE */
    D3DRS_DESTBLENDALPHA            = 208,  /* DST blend factor for the альфа channel when D3DRS_SEPARATEDESTALPHAENABLE is TRUE */
    D3DRS_BLENDOPALPHA              = 209   /* Blending operation for the альфа channel when D3DRS_SEPARATEDESTALPHAENABLE is TRUE */
}
...
enum : D3DTEXTURESTAGESTATETYPE {
    ...
    D3DTSS_ALPHAOP        =  4, /* D3DTEXTUREOP - per-stage blending controls for альфа channel */
...
enum : D3DTEXTUREOP {
    ...
    // Linear альфа blend: Arg1*(Alpha) + Arg2*(1-Alpha)
    D3DTOP_BLENDDIFFUSEALPHA    = 12, // iterated альфа
    D3DTOP_BLENDTEXTUREALPHA    = 13, // texture альфа
    D3DTOP_BLENDFACTORALPHA     = 14, // альфа from D3DRS_TEXTUREFACTOR

    // Linear альфа blend with pre-multiplied arg1 input: Arg1 + Arg2*(1-Alpha)
    D3DTOP_BLENDTEXTUREALPHAPM  = 15, // texture альфа
    D3DTOP_BLENDCURRENTALPHA    = 16, // by альфа of current color
    ...
    // The result is replicated into all four (including альфа) channels.
...
const D3DTA_ALPHAREPLICATE = 0x00000020;  // replicate альфа to color components (read modifier)
...
enum : D3DSHADER_PARAM_SRCMOD_TYPE {
    ...
    D3DSPSM_DW      = 10<<D3DSP_SRCMOD_ШИФТ, // divide through by ш component
