...
[s9;%RU-RU This class is a `'lexical`' parser of XML. It is intended 
...
[s2;%RU-RU Skips any whitespaces in the input XML.&]
[s3; &]
[s4; &]
...
[s2;%RU-RU Registers a new XML entity [%-*@3 id] with value [%-*@3 text].&]
[s3;%RU-RU &]
[s4; &]
[s5;:XmlParser`:`:IsEof`(`): [@(0.0.255) bool]_[* IsEof]()&]
[s2;%RU-RU Возвращает true, если parser reached the 
end of text.&]
[s3; &]
[s4; &]
[s5;:XmlParser`:`:GetPtr`(`)const: [@(0.0.255) const]_[@(0.0.255) char]_`*[* GetPtr]()_[@(0.0.255) c
onst]&]
[s2;%RU-RU Возвращает a pointer to the position in the 
text the parser reached.&]
[s3; &]
[s4; &]
[s5;:XmlParser`:`:IsTag`(`): [@(0.0.255) bool]_[* IsTag]()&]
[s2;%RU-RU Возвращает true, если the parser is at XML 
start`-tag.&]
[s3; &]
[s4; &]
[s5;:XmlParser`:`:PeekTag`(`): [_^String^ String]_[* PeekTag]()&]
[s2;%RU-RU Возвращает the next tag id, but does not advance. 
If the parser is not at start`-tag, XmlError is thrown.&]
[s3; &]
[s4; &]
[s5;:XmlParser`:`:ReadTag`(`): [_^String^ String]_[* ReadTag]()&]
[s2;%RU-RU Возвращает XML start`-tag id and advances. If 
the parser is not at start`-tag, XmlError is thrown.&]
[s3; &]
[s4; &]
...
har]_`*[*@3 tag])&]
[s2;%RU-RU If parser is at XML start`-[%-*@3 tag], advances and returns 
...
[s2;%RU-RU If parser is at XML start`-[%-*@3 tag], advances, otherwise 
throws XmlError exception.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:XmlParser`:`:IsEnd`(`): [@(0.0.255) bool]_[* IsEnd]()&]
[s2;%RU-RU Возвращает true, если the parser is at matching 
end`-tag. Note that encountering non`-matching tags invokes XmlError, 
unless the parser is in relaxed mode.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:XmlParser`:`:End`(`): [@(0.0.255) bool]_[* End]()&]
[s2; Возвращает true, если the parser is at matching 
end`-tag and advances. Note that encountering non`-matching tags 
throws XmlError, unless the parser is in relaxed mode.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:XmlParser`:`:PassEnd`(`): [@(0.0.255) void]_[* PassEnd]()&]
[s2;%RU-RU If parser is at matching end`-tag, advances, otherwise 
XmlError is thrown.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:XmlParser`:`:TagE`(const char`*`): [@(0.0.255) bool]_[* TagE]([@(0.0.255) const]_[@(0.0.255) c
har]_`*[*@3 tag])&]
[s2;%RU-RU Вызывает Tag([%-*@3 tag]) `- if it returns true, 
immediately calls PassTag. In other words, matches element with 
empty content.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:XmlParser`:`:PassTagE`(const char`*`): [@(0.0.255) void]_[* PassTagE]([@(0.0.255) cons
t]_[@(0.0.255) char]_`*[*@3 tag])&]
[s2;%RU-RU Вызывает PassTag([%-*@3 tag]) and then PassEnd(). 
In other words, requires to advance over element with empty content.&]
[s3;%RU-RU &]
[s4; &]
[s5;:XmlParser`:`:TagElseSkip`(const char`*`): [@(0.0.255) bool]_[* TagElseSkip]([@(0.0.255) c
onst]_[@(0.0.255) char]_`*[*@3 tag])&]
[s2;%RU-RU If call Tag([%-*@3 tag]).returns true. Otherwise calls Skip 
...
[@(0.0.255) char]_`*[*@3 tag])&]
[s2;%RU-RU If End call returns true, returns false. If call to Tag([%-*@3 tag]) 
...
[s2;%RU-RU Возвращает the value of attribute, converted 
to integer number, with the name [%-*@3 id] of the last start`-tag. 
If no such attribute exists or if attribute text cannot be converted 
...
t]&]
[s2;%RU-RU Возвращает the value of attribute, converted 
to floating point number, with the name [%-*@3 id] of the last 
start`-tag. If no such attribute exists or if attribute text 
cannot be converted to integer, returns [%-*@3 def].&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:XmlParser`:`:IsText`(`): [@(0.0.255) bool]_[* IsText]()&]
[s2;%RU-RU Возвращает  true, если parser is at text 
content of element.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:XmlParser`:`:ReadText`(`): [_^String^ String]_[* ReadText]()&]
[s2;%RU-RU Reads a single text content. If there are contained elements 
...
[s2;%RU-RU Reads all text content until end`-tag. If there are contained 
...
[s2;%RU-RU Возвращает true, если parser находится 
у декларации XML.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:XmlParser`:`:ReadDecl`(`): [_^String^ String]_[* ReadDecl]()&]
[s2;%RU-RU Reads XML declaration `- throws XmlError if parser is 
not at declaration.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:XmlParser`:`:IsPI`(`): [@(0.0.255) bool]_[* IsPI]()&]
[s2;%RU-RU Возвращает true, если parser is at XML processing 
info.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:XmlParser`:`:ReadPI`(`): [_^String^ String]_[* ReadPI]()&]
[s2;%RU-RU Reads XML processing `- throws XmlError if parser is not 
at any.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
...
[s2;%RU-RU Skips everything past the end`-tag of last parser start`-tag.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:XmlParser`:`:PickAttrs`(`)pick`_: [_^VectorMap^ VectorMap]<[_^String^ String], 
[_^String^ String]>_[* PickAttrs]()_[@(0.128.128) pick`_]&]
[s2;%RU-RU Picks all attributes of last passed start`-tag. No attribute`-related 
...
[s2;%RU-RU Activates the relaxed mode. In relaxed mode, XmlParser 
ignores mismatches of start`-tag and end`-tags. Unknown entities 
are replace with character `'`&`'. This mode was introduced to 
deal with broken XML files.&]
[s3;%RU-RU &]
[s4; &]
[s5;:XmlParser`:`:Raw`(bool`): [@(0.0.255) void]_[* Raw]([@(0.0.255) bool]_[*@3 b])&]
[s2;%RU-RU Activtes the raw mode. I raw mode, all logic about start`-tags 
...
xml [%-*@3 s]. The pointed text must be valid through the whole 
parsing process (XmlParser does not make copy of the text).&]
[s3; &]
[s4; &]
