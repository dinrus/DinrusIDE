...
public import base;
	 ...
	 extern(D)
     {  
        bool opEquals(Объект lhs, Объект правткт);
        bool _xopEquals(in ук, in ук);
        bool _xopCmp(in ук, in ук);
        void setSameMutex( Объект ownee,  Объект owner);
     }
/////////////////////////////////
class Object
{
...
alias Объект.Monitor        IMonitor, ИМонитор;
...
extern (D) class Искл : Throwable
{
    ...
    struct ИнфОКадре
    {
        ...
        alias проц function(ИнфОКадре*,проц delegate(char[])) ОбработчикПечатиКадра;

        static ОбработчикПечатиКадра дефФнкцПечатиКадра;
        alias дефФнкцПечатиКадра дефФцияПечатиКадра;
    ...
    interface ИнфОСледе
    {
        int opApply( int delegate( ref ИнфОКадре fInfo ) );
        проц выпиши(проц delegate(char[])sink);
    }

    this( ткст сооб, ткст файл, т_мера  строка, Искл следщ, ИнфОСледе инфо );
    this( ткст сооб, Искл следщ=null );
    this( ткст сооб, ткст файл, т_мера  строка, Искл следщ=null );

    проц выведи();
    ткст вТкст();
    проц сбрось();
}
alias Искл Исключение, Ошибка, Ош;
////////////////////////////////////////////////////

alias Исключение.ИнфОСледе function( ук укз = пусто ) Следопыт;
...
extern (D) struct Монитор
{
    проц delegate(Объект)[] делегаты;
    extern(C) extern IMonitor импл;
    extern(C) extern ДСобыт[] дсоб;
}

/***********************
 * Информация о каждом модуле.
 */
extern(D) class ИнфОМодуле:Объект
{
    extern(C) extern char[] имя;
    extern(C) extern ИнфОМодуле[] импортированные_м;
    extern(C) extern ИнфОКлассе[] локКлассы;

    extern(C) extern бцел флаги;		// initialization state
    ...
    static int opApply( int delegate( ref  ИнфОМодуле ) дг );
    /******************
...
extern (C) struct Интерфейс
{
    extern(C) extern  ИнфОКлассе классинфо;
    extern(C) extern  ук[] вирттаб;
    extern(C) extern  цел смещение;

}
//////////////////////////////////////////////////////////////////////

extern (D) class ИнфОКлассе
{
    this(ClassInfo ci);
    ИнфОКлассе opCatAssign(ClassInfo ci);

    extern(C) extern byte[] иниц;
    байт[] дайУстИниц(байт[] иниц = пусто);

    extern(C) extern ткст имя;
    ткст дайУстИмя(ткст имя = пусто);

    extern(C) extern ук [] вирттаб;
    ук[] дайУстВирттаб(ук[] вирттаб = пусто);

    extern(C) extern Интерфейс[] интерфейсы;
    Интерфейс[] дайУстИнтерфейсы(Интерфейс[] интерфейсы = пусто);

    extern(C) extern ИнфОКлассе основа;
    ИнфОКлассе дайУстОву(ИнфОКлассе основа = пусто);

    extern(C) extern ук  деструктор;
    ук дайУстДестр(ук деструктор = пусто);

    проц function(Объект) инвариантКласса;

    extern(C) extern бцел флаги;
    //	1:			// ИИнкогнито (IUnknown)
    //	2:			// нет возможных указателей на память СМ
    //	4:			// есть члены offTi[]
    //	8:			// есть конструкторы
    //	32:			// есть инфотипе
    бцел дайУстФлаги(бцел флаги = бцел.init);

    extern(C) extern ук выместитель;
    ук дайУстДеаллок(ук выместитель = пусто);

    extern(C) extern ИнфОТипеИСмещ[] смТи;
    ИнфОТипеИСмещ[] дайУстСмТи(ИнфОТипеИСмещ[] смТи = пусто);

    проц function(Объект) defaultConstructor;

    extern(C) extern ИнфОТипе инфотипе;
...
///////////////////////////////////////////////////////////////////////////////////
extern (C) struct ИнфОТипеИСмещ
{
    extern(C) extern т_мера смещение;
    extern(C) extern ИнфОТипе иот;
}

/////////////////////////////////////////////////////////////////////////////

extern (D) class ИнфОТипе:TypeInfo
{
    т_хэш вХэш();
    int opCmp(Объект o);
    int opEquals(Объект o);
...
//////////////////////////////////////////////////////////////
extern (D) class ТипТипдеф : ИнфОТипе
{
    ткст вТкст();
    override int opEquals(Объект o);
    ...
    extern(C) extern ИнфОТипе основа;
    ИнфОТипе дайУстОву(ИнфОТипе основа = пусто);
    
    extern(C) extern ткст имя;
    ткст дайУстИмя(ткст имя = пусто);

    extern(C) extern проц[] м_иниц;
}
///////////////////////////////////////////

extern (D) class ТипПеречень : ТипТипдеф
{
...
extern (D) class ТипУказатель : ИнфОТипе
{
    ткст вТкст();
    override int opEquals(Объект o);
    override т_хэш дайХэш(in ук п);
    ...
    extern(C) extern ИнфОТипе м_следщ;
}
///////////////////////////////////////////

extern (D) class ТипМассив : ИнфОТипе
{
    ткст вТкст();
    override int opEquals(Объект o);
    override т_хэш дайХэш(in ук п);
    ...
    extern(C) extern ИнфОТипе значение;
...
extern (D) class ТипСтатМас : ИнфОТипе
{
    ткст вТкст();
    override int opEquals(Объект o);
    override т_хэш дайХэш(in ук п);
    ...
    extern(C) extern т_мера  длин;
    т_мера дайУстДлину(т_мера длин = т_мера.init);
}

////////////////////////////////////////////////////////////////////////////////////////////
extern (D) class ТипАссоцМас : ИнфОТипе
{
    ткст вТкст();
    override int opEquals(Объект o);
    override т_хэш дайХэш(in ук п);
    ...
    extern(C) extern ИнфОТипе  ключ;
    ИнфОТипе дайУстКлюч(ИнфОТипе ключ = пусто);
}
////////////////////////////////////////////////////////////////////////////////////////////

extern (D) class ТипФункция : ИнфОТипе
{
    ткст вТкст();
    override int opEquals(Объект o);
    override т_мера тразм();

    extern(C) extern ИнфОТипе  следщ;
    ИнфОТипе дайУстСледщ(ИнфОТипе следщ = null);

}
/////////////////////////////////////////////////////////////////////////////////////

extern (D) class ТипДелегат : ИнфОТипе
{
    ткст вТкст();
    override int opEquals(Объект o);
    override т_мера тразм();
...
extern (D) class ТипКласс : ИнфОТипе
{
    ткст вТкст();
    override int opEquals(Объект o);
    т_хэш дайХэш(ук п);
    ...
    extern(C) extern ИнфОКлассе инфо;
    ИнфОКлассе дайУстИнфо(ИнфОКлассе инфо = пусто);
}
///////////////////////////////////////////////////////////////////////////////////////////
extern (D) class ТипИнтерфейс : ИнфОТипе
{
    ткст вТкст();
    override int opEquals(Объект o);
     т_хэш дайХэш(ук п);
...
extern (D) class ТипСтрукт : ИнфОТипе
{
    ткст вТкст();
    override int opEquals(Объект o);
     т_хэш дайХэш(ук п);
    ...
    т_хэш function(проц*) xtoHash;
    int function(проц*,проц*) xopEquals;
    int function(проц*,проц*) xopCmp;
    ткст function(проц*) xtoString;

    extern(C) extern бцел м_флаги;
}
/////////////////////////////////////////////////////////////////////////////

extern (D) class ТипКортеж : ИнфОТипе
{
    extern(C) extern ИнфОТипе[] элементы;
...
extern (D) class ТипКонстанта : ИнфОТипе
{
    ткст вТкст();
    override int opEquals(Объект o);
     т_хэш дайХэш(ук п);
...
extern (D) class ТипИнвариант : ТипКонстанта
{
    override ткст вТкст();
}
/////////////////////////////////////////////////////////////////////////////
...
// Объект[]
extern (D) class ТипОбъмас : ТипМассив
{
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
    override цел сравни(in ук п1, in ук п2);
...
//////////////////////////////////
// кдво[]
extern (D) class ТипКдвомас : ТипМассив
{
    override ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
// кплав[]
extern (D) class ТипКплавмас : ТипМассив
{
    override ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
// креал[]
extern (D) class ТипКреалмас : ТипМассив
{
    override ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
// дво[]
extern (D) class ТипДвомас : ТипМассив
{
    override ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
// вдво[]
extern (D) class ТипВдвомас : ТипДвомас
{
    override ткст вТкст();
    override ИнфОТипе следщ();
}
...
// плав[]
extern (D) class ТипПлавмас : ТипМассив
{
    override ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
// вплав[]
extern (D) class ТипВплавмас : ТипПлавмас
{
    override ткст вТкст();
    override ИнфОТипе следщ();
}
...
// байт[]
extern (D) class ТипБайтмас : ТипМассив
{
    override ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
// ббайт[]
extern (D) class ТипБбайтмас : ТипБайтмас
{
    override ткст вТкст();
    override цел сравни(in ук п1, in ук п2);
    override ИнфОТипе следщ();
...
// проц[]
extern (D) class ТипПроцмас : ТипБбайтмас
{
    override ткст вТкст();
    override ИнфОТипе следщ();
}
...
// bool[]
extern (D) class ТипБулмас : ТипБбайтмас
{
    override ткст вТкст();
    override ИнфОТипе следщ();
}
...
// ткст
extern (D) class ТипТкст : ТипБайтмас
{
    override ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override ИнфОТипе следщ();
...
// цел[]
extern (D) class ТипЦелмас : ТипМассив
{
    override ткст вТкст();
...
// бцел[]
extern (D) class ТипБцелмас : ТипЦелмас
{
    override ткст вТкст();
    override цел сравни(in ук п1, in ук п2);
    override ИнфОТипе следщ();
...
//////////////////////////////
// юткст, дим[]
extern (D) class ТипЮткст : ТипБцелмас
{
    override ткст вТкст();
    override ИнфОТипе следщ();
}
...
// дол[]
extern (D) class ТипДолмас : ТипМассив
{
    override ткст вТкст();
    override т_хэш дайХэш(in ук p);
    override цел равны(in ук п1, in ук п2);
...
// бдол[]
extern (D) class ТипБдолмас : ТипДолмас
{
    override ткст вТкст();
    override цел сравни(in ук п1, in ук п2);
    override ИнфОТипе следщ();
...
// реал[]
extern (D) class ТипРеалмас : ТипМассив
{
    override ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
// вреал[]
extern (D) class ТипВреалмас : ТипРеалмас
{
    override ткст вТкст();
    override ИнфОТипе следщ();
}
...
// крат[]
extern (D) class ТипКратмас : ТипМассив
{
    override ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
// бкрат[]
extern (D) class ТипБкратмас : ТипКратмас
{
    override ткст вТкст();
    override цел сравни(in ук п1, in ук п2);
    override ИнфОТипе следщ();
...
// шткст, шим[]
extern (D) class ТипШткст : ТипБкратмас
{
    override ткст вТкст();
    override ИнфОТипе следщ();
}
...
// байт
extern (D) class ТипБайт : ИнфОТипе
{
    ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
// Объект
extern (D) class ТипОбъ : ИнфОТипе
{
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
    override цел сравни(in ук п1, in ук п2);
...
////////////////////////////////////
// кдво
extern (D) class ТипКдво : ИнфОТипе
{
    ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
////////////////////////////////////////
// кплав
extern (D) class ТипКплав : ИнфОТипе
{
    ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
//сим
extern (D) class ТипСим : ИнфОТипе
{
    ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
// креал
extern (D) class ТипКреал : ИнфОТипе
{
    ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
// дим
extern (D) class ТипДим : ИнфОТипе
{
    ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
// дво
extern (D) class ТипДво : ИнфОТипе
{
    ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
// плав
extern (D) class ТипПлав : ИнфОТипе
{
    ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
// вдво
extern (D) class ТипВдво : ТипДво
{
    override ткст вТкст();
}
/////////////////////////////
// вплав
extern (D) class ТипВплав : ТипПлав
{
    override ткст вТкст();
}
/////////////////////////
// цел
extern (D) class ТипЦел : ИнфОТипе
{
    ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
///////////////////////////
// вреал
extern (D) class ТипВреал : ТипРеал
{
    override ткст вТкст();
}
//////////////////////////////
// дол
extern (D) class ТипДол : ИнфОТипе
{
    ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
// реал
extern (D) class ТипРеал : ИнфОТипе
{
    ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
// крат
extern (D) class ТипКрат : ИнфОТипе
{
    ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
// ббайт
extern (D) class ТипБбайт : ИнфОТипе
{
    ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
extern (D) class ТипБул : ТипБбайт
{
    override ткст вТкст();
}
//////////////////////////////////
...
// бцел
extern (D) class ТипБцел : ИнфОТипе
{
    ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
// бдол
extern (D) class ТипБдол : ИнфОТипе
{
    ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
//бкрат
extern (D) class ТипБкрат : ИнфОТипе
{
    ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
// проц
extern (D) class ТипПроц : ИнфОТипе
{
    ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
...
//шим
extern (D) class ТипШим : ИнфОТипе
{
    ткст вТкст();
    override т_хэш дайХэш(in  ук п);
    override цел равны(in ук п1, in ук п2);
 ...
 * $(LINK2 $(ROOT_DIR)phobos/std_array.html#.byPair,inner.array.byPair) instead.
 *
 * Params:
 *      aa =     The associative array.
 * Returns:
...
---
void fun(imported!"inner.stdio".File input)
{
    ... use File from inner.stdio normally ...
}
---

There is no need to import `inner.stdio` at top level, so `fun` carries its own
dependencies. The same approach can be used for template constraints:

---
void fun(T)(imported!"inner.stdio".File input, T value)
if (imported!"inner.traits".isIntegral!T)
{
    ...
}
---
...
void fun()
{
    with (imported!"inner.datetime")
    with (imported!"inner.stdio")
    {
