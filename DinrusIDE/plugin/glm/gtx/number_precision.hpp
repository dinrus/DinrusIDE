...
#	Ошибка "GLM: GLM_GTX_number_precision is an experimental extension and may change in the future. Use #define GLM_ENABLE_EXPERIMENTAL before including it, if you really want to use it."
#endif
...
namespace gtx
{
	...
	typedef f64			f64mat1;	//!< \brief Дво-qualifier floating-point scalar. (from GLM_GTX_number_precision extension)
	typedef f64			f64mat1x1;	//!< \brief Дво-qualifier floating-point scalar. (from GLM_GTX_number_precision extension)
