...
#include <wxCtrls/toplevel.h>      // the base class
...
// include the real class declaration
    ...
    #include <wxCtrls/univ/frame.h>
#else // !__WXUNIVERSAL__
    #if defined(__WXPALMOS__)
        #include <wxCtrls/palmos/frame.h>
    #elif defined(__WXMSW__)
        #include <wxCtrls/msw/frame.h>
    #elif defined(__WXGTK20__)
        #include <wxCtrls/gtk/frame.h>
    #elif defined(__WXGTK__)
        #include <wxCtrls/gtk1/frame.h>
    #elif defined(__WXMOTIF__)
        #include <wxCtrls/motif/frame.h>
    #elif defined(__WXMAC__)
        #include <wxCtrls/mac/frame.h>
    #elif defined(__WXCOCOA__)
        #include <wxCtrls/cocoa/frame.h>
    #elif defined(__WXPM__)
        #include <wxCtrls/os2/frame.h>
    #endif
#endif
