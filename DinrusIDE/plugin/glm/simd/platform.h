...
#		Ошибка "GLM requires ICC 2013 SP1 or newer"
...
#		Ошибка "GLM requires CUDA 7.0 or higher"
...
#			Ошибка "GLM requires Clang 3.4 / Apple Clang 6.0 or higher"
...
#			Ошибка "GLM requires Clang 3.4 or higher"
...
#	if _MSC_VER < 1800
#		Ошибка "GLM requires Visual C++ 12 - 2013 or higher"
#	elif _MSC_VER == 1800
...
#		Ошибка "GLM requires GCC 4.7 or higher"
...
#ifndef GLM_COMPILER
#	Ошибка "GLM_COMPILER undefined, your compiler may not be supported by GLM. добавь #define GLM_COMPILER 0 to ignore this message."
#endif//GLM_COMPILER
