...
[s7; [*/ Возвратное значение]-|true indicates success.&]
[s3; &]
[s4;%- &]
...
[s7; [%-*C@3 serialize]-|Callback to the serialization function.&]
[s7; [%-*C@3 stream]-|Stream.&]
[s7; [*/ Возвратное значение]-|true if data were properly stored to the stream.&]
[s3; &]
[s4;%- &]
...
[s7; [*C@4 T]-|Type of object to store.&]
[s7; [%-*C@3 x]-|Reference to the object.&]
[s7; [*/ Возвратное значение]-|String containing serialized [@3 x].&]
[s3; &]
[s4;%- &]
