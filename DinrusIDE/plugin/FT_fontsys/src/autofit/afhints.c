...
#include FT_INTERNAL_CALC_H
  ...
  /* дай new segment for given axis. */
  ...
  /* дай new edge for given axis, direction, and position. */
...
#define AF_INDEX_NUM( ptr, base )  ( (ptr) ? ( (ptr) - (base) ) : -1 )
  ...
  /* Compute the direction значение of a given vector. */
                         ...
                         FT_Outline*    outline )
  {
    ...
    /* We can't rely on the значение of `FT_Outline.flags' to know the fill   */
  ...
  /* сохрани the hinted outline in an FT_Outline structure. */
  ...
  /* Align all points of an edge to the same coordinate значение, */
