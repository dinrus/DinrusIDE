...
class Аргументы
{
    ...
    ***********************************************************************/
    ...
    final бул разбор (ткст[] ввод, бул полого=нет)
    {
        ...
        debug(Аргументы) стдвыв.фмтнс ("\ncmdline: '{}'", ввод);
        стэк.сунь (получи(пусто));
        foreach (s; ввод)
        {
            debug(Аргументы) стдвыв.фмтнс ("'{}'", s);
            if (готово is нет)
                if (s == "--")
                {
                    готово=да;
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            delegate в_ фмт the вывод. You would typically пароль
    ...
    ***********************************************************************/
    ...
    /***********************************************************************
            ...
            индекс 2: configured минимум параметры
    ...
    class Аргумент
    {
        ...
        ***************************************************************/
        ...
        /***************************************************************
                ...
                Набор Всё the минимум и maximum parameter counts
        ...
        ***************************************************************/
        ...
        private цел действителен ()
        {
            ...
            debug(Аргументы) стдвыв.фмтнс ("{}: ошибка={}, установлен={}, мин={}, макс={}, "
