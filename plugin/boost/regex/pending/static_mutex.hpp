...
#include <plugin/boost/regex/config.hpp> // dll import/export options.
...
#include <plugin/boost/cstdint.hpp>
...
//
#define BOOST_REGEX_H1 <plugin/boost/thread/once.hpp>
#define BOOST_REGEX_H2 <plugin/boost/thread/recursive_mutex.hpp>
#define BOOST_REGEX_H3 <plugin/boost/thread/lock_types.hpp>
