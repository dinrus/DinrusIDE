...
// ----------------------------------------------------------------------------
    ...
    #include <wxCtrls/generic/accel.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/accel.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/accel.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/accel.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/accel.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/accel.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/generic/accel.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/accel.h>
#endif
