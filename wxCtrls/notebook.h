...
// ----------------------------------------------------------------------------
    ...
    #include <wxCtrls/univ/notebook.h>
#elif defined(__WXMSW__)
    #include  <wxCtrls/msw/notebook.h>
#elif defined(__WXMOTIF__)
    #include  <wxCtrls/generic/notebook.h>
#elif defined(__WXGTK20__)
    #include  <wxCtrls/gtk/notebook.h>
#elif defined(__WXGTK__)
    #include  <wxCtrls/gtk1/notebook.h>
#elif defined(__WXMAC__)
    #include  <wxCtrls/mac/notebook.h>
#elif defined(__WXCOCOA__)
    #include  <wxCtrls/cocoa/notebook.h>
#elif defined(__WXPM__)
    #include  <wxCtrls/os2/notebook.h>
#endif
