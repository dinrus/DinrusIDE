...
static void загрузиИниФайл(const char *имяф, ВекторМап<Ткст, Ткст>& ret)
{
	ФайлВвод in(имяф);
...
ВекторМап<Ткст, Ткст> загрузиИниФайл(const char *имяф)
{
    ВекторМап<Ткст, Ткст> ret;
...
void НастройкиТекста::грузи(const char *имяф)
{
	ФайлВвод in(имяф);
	int themei = 0;
	настройки.добавь("");
