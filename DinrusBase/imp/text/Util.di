/*******************************************************************************
        ...
        вместо него тип цел. Это типичная причина ошибки "wаблон не найден".
        ...
        выкладка (приёмник, фмт ...)            // featherweight printf
...
/******************************************************************************
        ...
        If you are hashing n strings (ub1 **)ключ, do it like this:
                    ...
                    for (i=0, в=0; i<n; ++i) в = хэш( ключ[i], длин[i], в);
...
debug (UnitTest)
{
        ...
        ткст в, t;
        в =  голова ("one:two:three", ":", t);
        assert (в == "one" && t == "two:three");
        в = голова ("one:::two:three", ":::", t);
        assert (в == "one" && t == "two:three");
        в = голова ("one:two:three", "*", t);
        assert (в == "one:two:three" && t is пусто);

        t =  хвост ("one:two:three", ":", в);
        assert (в == "one:two" && t == "three");
        t = хвост ("one:::two:three", ":::", в);
        assert (в == "one" && t == "two:three");
        t = хвост ("one:two:three", "*", в);
        assert (t == "one:two:three" && в is пусто);
