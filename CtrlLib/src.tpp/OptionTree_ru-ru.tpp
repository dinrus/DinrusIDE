...
[{_} 
[ {{10000@3 [s0;%RU-RU [*@(229)4 Класс OptionTree]]}}&]
[s3;%RU-RU &]
...
&]
[s3;%RU-RU &]
[s9;%RU-RU Специализирует TreeCtrl для представления 
дерева опций. Статус опции родительского 
узла в 3`-х состояниях, представляя 
все элементы`-отпрыски отключенными, 
смешанными и включенными. Дерево 
опций позволяет использовать внешние 
виджеты Option в качестве узлов или предоставля
ет внешние виджеты Option, если никакой 
внешней Option не указано.&]
[s3;%RU-RU &]
[s0; &]
[ {{10000F(128)G(128)@1 [s0;%RU-RU [* Список Публичных Членов]]}}&]
[s3;%RU-RU &]
[s5;:OptionTree`:`:WhenOption: [_^Callback^ Callback]_[* WhenOption]&]
[s2;%RU-RU Какая`-то из опций изменена.&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Устанавливает корневой элемент.&]
[s3;%RU-RU &]
[s4; &]
...
&]
[s2; [%RU-RU Вставляет элемент в позиции ][*@3 i][%RU-RU  
в родителя ][*@3 parent.]&]
[s3;%RU-RU &]
[s4; &]
[s5;:OptionTree`:`:Get`(int`)const: [@(0.0.255) virtual] [@(0.0.255) int]_[* Get]([@(0.0.255) i
nt]_[*@3 id])_[@(0.0.255) const]&]
[s2;%RU-RU Возвращает настройку опции для 
элемента с идентификатором [%-*@3 id]. 
Возвращает 1, 0 или Null, если узел смешанный.&]
[s3;%RU-RU &]
[s4; &]
