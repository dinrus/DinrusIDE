...
[s0; &]
[s0; [^topic`:`/`/Draw`/srcdoc`/UhdAndDarkTheme`_ru`-ru`#1^ 1. GUI 
mode detection]&]
[s0; [^topic`:`/`/Draw`/srcdoc`/UhdAndDarkTheme`_ru`-ru`#2^ 2. Activating 
Dark mode support]&]
[s0; [^topic`:`/`/Draw`/srcdoc`/UhdAndDarkTheme`_ru`-ru`#3^ 3. Scaling 
GUI for actual GUI font and UHD resolution]&]
[s0; [^topic`:`/`/Draw`/srcdoc`/UhdAndDarkTheme`_ru`-ru`#4^ 4. Color 
adjustment]&]
[s0; [^topic`:`/`/Draw`/srcdoc`/UhdAndDarkTheme`_ru`-ru`#5^ 5. Iml 
files]&]
[s0; &]
...
[* IMAGEFILE`_UHD], [* IMAGEFILE`_DARK`_UHD]. Note that DinrusIDE tool 
