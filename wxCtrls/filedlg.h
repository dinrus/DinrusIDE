...
#include <wxCtrls/generic/filedlgg.h>
#elif defined(__WXMSW__)
#include <wxCtrls/msw/filedlg.h>
#elif defined(__WXMOTIF__)
#include <wxCtrls/motif/filedlg.h>
#elif defined(__WXGTK24__)
#include <wxCtrls/gtk/filedlg.h>     // GTK+ > 2.4 has native version
#elif defined(__WXGTK20__)
#define wxUSE_GENERIC_FILEDIALOG
#include <wxCtrls/generic/filedlgg.h>
#elif defined(__WXGTK__)
#include <wxCtrls/gtk1/filedlg.h>
#elif defined(__WXMAC__)
#include <wxCtrls/mac/filedlg.h>
#elif defined(__WXCOCOA__)
#include <wxCtrls/cocoa/filedlg.h>
#elif defined(__WXPM__)
#include <wxCtrls/os2/filedlg.h>
#endif
