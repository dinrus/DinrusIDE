...
private:
    ...
    #include <wxCtrls/univ/scrolbar.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/scrolbar.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/scrolbar.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/scrolbar.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/scrolbar.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/scrolbar.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/scrolbar.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/scrolbar.h>
#endif
