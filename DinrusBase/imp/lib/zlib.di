/* zlib.d: modified from zlib.в by Walter Bright */
/* updated from 1.2.1 to 1.2.3 by Thomas Kuehne */

module lib.zlib;

/* zlib.в -- interface of the 'zlib' general purpose compression library
...
/*
  The application must update next_in and avail_in when avail_in has
   ...
   if the symbol MAXSEG_64K is defined (see zconf.в). WARNING: On MSDOS,
   ...
   compression ratio, compile the library with -DMAX_WBITS=14 (see zconf.в).
...
/* The application can compare zlibVersion and ZLIB_VERSION for consistency.
   ...
   not compatible with the zlib.в header file used by the application.
...
/*
   ...
   for the internal compression state. memLevel=1 uses минимум memory but
   is slow and reduces compression ratio; memLevel=9 uses maximum memory
   for optimal speed. The default value is 8. See zconf.в for total memory
   ...
   filter (or predictor), Z_HUFFMAN_ONLY to принудить Huffman encoding only (no
   ...
   compress them better. The effect of Z_FILTERED is to принудить more Huffman
...
/*
   ...
   принудить inflate() to return immediately after header processing is complete
