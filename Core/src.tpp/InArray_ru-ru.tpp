...
[s2; То же, что и Insert(GetCount(), [%-*@3 x]). Invalidates iterators.&]
[s3; &]
[s4; &]
...
[s2; То же, что и Insert(GetCount(), [%-*@3 newt]). Invalidates iterators.&]
[s3; &]
[s4;%- &]
...
`&...]_args)&]
[s2; То же, что и InsertCreate<[%-*@4 TT]>(GetCount(), args...). Invalidates 
iterators.&]
[s3; &]
[s4; &]
...
[s2; То же, что и Remove(n, GetCount() `- n). Invalidates iterators.&]
[s3; &]
[s4; &]
