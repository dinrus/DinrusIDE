...
#include <wxCtrls/window.h>      // base class
...
// ----------------------------------------------------------------------------
    ...
    #include <wxCtrls/univ/control.h>
#elif defined(__WXPALMOS__)
    #include <wxCtrls/palmos/control.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/control.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/control.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/control.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/control.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/control.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/control.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/control.h>
#endif
