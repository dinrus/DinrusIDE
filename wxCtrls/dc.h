...
#include <wxCtrls/object.h>          // the base class

#include <wxCtrls/intl.h>            // for wxLayoutDirection
...
#include <wxCtrls/bitmap.h>          // for wxNullBitmap
#include <wxCtrls/brush.h>
#include <wxCtrls/pen.h>
#include <wxCtrls/palette.h>
#include <wxCtrls/list.h>            // we use wxList in inline functions
...
// ----------------------------------------------------------------------------
    ...
    #include <wxCtrls/palmos/dc.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/dc.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/dc.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/dc.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/dc.h>
#elif defined(__WXX11__)
    #include <wxCtrls/x11/dc.h>
#elif defined(__WXMGL__)
    #include <wxCtrls/mgl/dc.h>
#elif defined(__WXDFB__)
    #include <wxCtrls/dfb/dc.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/dc.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/dc.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/dc.h>
#endif

#if wxUSE_GRAPHICS_CONTEXT
    #include <wxCtrls/dcgraph.h>
#endif
