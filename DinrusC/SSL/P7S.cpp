...
Ткст GetP7Signature_imp(const void *данные, int length, const Ткст& cert_pem, const Ткст& pkey_pem)
{
	SslCertificate x509;
	SslKey pkey;
...
extern Ткст (*GetP7Signature__)(const void *данные, int length, const Ткст& cert_pem, const Ткст& pkey_pem);
