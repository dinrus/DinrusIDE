...
public class Локаль : Выкладка!(сим)
{
    ...
    ***********************************************************************/
    ...
    protected override ткст неизвестное (ткст вывод, ткст фмт, ИнфОТипе тип, Арг p)
    {
        ...
        case КодТипа.СТРУКТ:
            if (тип is typeid(Время))
                return форматируйДатуВремя (вывод, *cast(Время*) p, фмт, форматДаты);
    ...
    **********************************************************************/
    ...
    protected override ткст целое (ткст вывод, дол знач, ткст alt, бдол маска=бдол.max, ткст фмт=пусто)
    {
    ...
    **********************************************************************/
    ...
    protected override ткст плавающее (ткст вывод, реал знач, ткст фмт)
    {
        return форматируйДво (вывод, знач, фмт, форматЧисла);
    }
}
