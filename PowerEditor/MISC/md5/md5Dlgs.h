...
protected :
	...
	static LRESULT CALLBACK HashPathEditStaticProc(Window* hwnd, UINT message, WPARAM wParam, LPARAM lParam) {
	...
	static LRESULT CALLBACK HashResultStaticProc(Window* hwnd, UINT message, WPARAM wParam, LPARAM lParam) {
		const auto dlg = (HashFromFilesDlg *)(::GetWindowLongPtr(hwnd, GWLP_USERDATA));
...
protected :
	...
	static LRESULT CALLBACK HashTextEditStaticProc(Window* hwnd, UINT message, WPARAM wParam, LPARAM lParam) {
