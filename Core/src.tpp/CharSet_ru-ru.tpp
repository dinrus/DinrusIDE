...
(гарнитур)]]}}&]
[s9;%RU-RU While in ideal world every text resource would be encoded 
...
[s2;%RU-RU Represents `"default`" charset. Default charset can be 
set using SetDefaultCharset and used instead `"real`" charset 
in most charset`-related operations (and is usually used as default 
value of parameter). Guaranteed to be equal to 0.&]
[s3; &]
[s4; &]
[s5;:CHARSET`_TOASCII: [* CHARSET`_TOASCII]&]
[s2;%RU-RU This charset, used in charset conversion&]
[s3; &]
[s4; &]
[s5;:CHARSET`_UTF8: [* CHARSET`_UTF8]&]
[s2;%RU-RU UTF`-8 encoding.&]
[s3;%RU-RU &]
[s4; &]
[s5;:DEFAULTCHAR: [@(0.0.255) enum]_[* DEFAULTCHAR]_`=_[@3 0]x1f_&]
[s2;%RU-RU This special value is used as result of conversion in 
place of characters that do not exist in target charset.&]
[s3; &]
[s0; &]
[ {{10000F(128)G(128)@1 [s0;%RU-RU [* Function List]]}}&]
[s3;^byte^ &]
[s5;:GetDefaultCharset`(`): [_^byte^ byte]_[* GetDefaultCharset]()&]
[s2;%RU-RU Returns the current default charset.&]
[s3; &]
[s4; &]
[s5;:SetDefaultCharset`(byte`): [@(0.0.255) void]_[* SetDefaultCharset]([_^byte^ byte]_[*@3 c
harset])&]
[s2;%RU-RU Sets the default [%-*@3 charset]. This is to support legacy 
...
[s2;%RU-RU If [%-*@3 charset].is DEFAULT`_CHARSET, returns GetDefaultCharset(), 
...
[s2;%RU-RU Adds a new charset named [%-*@3 name]. [%-*@3 table] must 
point to 128 elements and contains UNICODE code`-points for character 
...
[s2;%RU-RU This is similar to [^topic`:`/`/Core`/src`/CharSet`$en`-us`#AddCharSet`(const char`*`,const word`*`,byte`)^ A
...
e]_[*@3 charset])&]
[s2;%RU-RU Returns the name of [%-*@3 charset ]code.&]
[s3;%RU-RU &]
[s4; &]
[s5;:CharsetCount`(`): [@(0.0.255) int]_[* CharsetCount]()&]
[s2;%RU-RU Returns the total count of charset (UTF`-8 excluded). 
It is guaranteed that charset code numeric value for `"real`" 
charset is in range 1...CharsetCount().&]
[s3; &]
[s4; &]
[s5;:CharsetByName`(const char`*`): [@(0.0.255) int]_[* CharsetByName]([@(0.0.255) const]_[@(0.0.255) c
har]_`*[*@3 name])&]
[s2;%RU-RU Tries to find charset code by [%-*@3 name]. Comparison is 
case insensitive and ignores any characters other that digits 
and alphas. If charset is not identified, returns 0 (which is 
the same as CHARSET`_DEFAULT).&]
[s3;%RU-RU &]
[s4; &]
[s5;:SystemCharset`(byte`): [_^byte^ byte]_[* SystemCharset]([_^byte^ byte]_[*@3 charset])&]
[s2;%RU-RU Attempt to retrieve host platform typical charset for 
[%-*@3 charset]. If unsuccessful, returns 0.&]
[s3;%RU-RU &]
[s4; &]
[s5;:ToUnicode`(int`,byte`): [@(0.0.255) int]_[* ToUnicode]([@(0.0.255) int]_[*@3 chr], 
[_^byte^ byte]_[*@3 charset])&]
[s2;%RU-RU Convert 8`-bit encoded character to unicode. [%-*@3 charset 
...
[s2;%RU-RU Converts unicode character to 8`-bit encoding. If codepoint 
...
[_^byte^ byte]_[*@3 charset])&]
[s2;%RU-RU Converts an array of 8`-bit characters to UNICODE. Both 
arrays, [%-*@3 ws] and [%-*@3 s], must have (at least) [%-*@3 n] elements. 
[%-*@3 charset ]cannot be CHARSET`_UTF8.&]
[s3;%RU-RU &]
[s4; &]
...
[@(0.0.255) int]_[*@3 n])&]
[s2;%RU-RU Converts an array of 8`-bit characters [%-*@3 s] with encoding 
...
[s2;%RU-RU Converts [%-*@3 src] encoded in [%-*@3 charset] to UNICODE. 
[%-*@3 charset] [*/ can] be CHARSET`_UTF8. Invalid bytes are error`-escaped 
using 0xEExx private range.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
...
[s2;%RU-RU Converts [%-*@3 n] characters starting at [%-*@3 src] encoded 
...
LTCHAR)&]
[s2;%RU-RU Converts [%-*@3 len] UNICODE characters from [%-*@3 src] to 
8`-bit encoding [%-*@3 charset]. [%-*@3 charset] [*/ can] be CHARSET`_UTF8. 
...
[s2;%RU-RU Converts UNICODE [%-*@3 src] to 8`-bit encoding [%-*@3 charset]. 
...
ULTCHAR)&]
[s2;%RU-RU Converts [%-*@3 src] encoded in [%-*@3 scharset] to [%-*@3 charset]. 
[%-*@3 charset] [*/ can] be CHARSET`_UTF8. Error`-escape characters 
...
[s2;%RU-RU Returns true if [%-*@3 c] < 2048 and it represents a letter.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:IsUpper`(int`): [@(0.0.255) bool]_[* IsUpper]([@(0.0.255) int]_[*@3 c])&]
[s2;%RU-RU Returns true if [%-*@3 c] < 2048 and it is upper`-case UNICODE 
code`-point.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:IsLower`(int`): [@(0.0.255) bool]_[* IsLower]([@(0.0.255) int]_[*@3 c])&]
[s2;%RU-RU Returns true if [%-*@3 c] < 2048 and it is lower`-case UNICODE 
code`-point.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:ToUpper`(int`): [@(0.0.255) int]_[* ToUpper]([@(0.0.255) int]_[*@3 c])&]
[s2;%RU-RU If [%-*@3 c] < 2048 and it is lower`-case, returns respective 
UNICODE upper`-case character, otherwise returns [%-*@3 c].&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:ToLower`(int`): [@(0.0.255) int]_[* ToLower]([@(0.0.255) int]_[*@3 c])&]
[s2;%RU-RU If [%-*@3 c] < 2048 and it is upper`-case, returns respective 
UNICODE lower`-case character, otherwise returns [%-*@3 c].&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:ToAscii`(int`): [@(0.0.255) int]_[* ToAscii]([@(0.0.255) int]_[*@3 c])&]
[s2;%RU-RU Returns UNICODE [%-*@3 c] `'converted`' to basic ASCII. 
Conversion is performed by removing any diacritical marks. If 
such conversion is not possible, returns 32 (space).&]
[s3;%RU-RU &]
[s4; &]
...
har]_[*@3 c])&]
[s2;%RU-RU Returns [^topic`:`/`/Core`/src`/CharSet`$en`-us`#IsLetter`(int`)^ IsLetter](
(byte)[%-*@3 c]).&]
[s3;%RU-RU &]
[s4;%RU-RU &]
...
ar]_[*@3 c])&]
[s2;%RU-RU Returns [^topic`:`/`/Core`/src`/CharSet`$en`-us`#IsUpper`(int`)^ IsUpper]((b
yte)[%-*@3 c]).&]
[s3;%RU-RU &]
[s4;%RU-RU &]
...
ar]_[*@3 c])&]
[s2;%RU-RU Returns [^topic`:`/`/Core`/src`/CharSet`$en`-us`#IsLower`(int`)^ IsLower]((b
yte)[%-*@3 c]).&]
[s3;%RU-RU &]
[s4;%RU-RU &]
...
r]_[*@3 c])&]
[s2;%RU-RU Returns [^topic`:`/`/Core`/src`/CharSet`$en`-us`#ToUpper`(int`)^ ToUpper]((b
yte)[%-*@3 c]).&]
[s3;%RU-RU &]
[s4;%RU-RU &]
...
r]_[*@3 c])&]
[s2;%RU-RU Returns [^topic`:`/`/Core`/src`/CharSet`$en`-us`#ToLower`(int`)^ ToLower]((b
yte)[%-*@3 c]).&]
[s3;%RU-RU &]
[s4;%RU-RU &]
...
r]_[*@3 c])&]
[s2;%RU-RU Returns [^topic`:`/`/Core`/src`/CharSet`$en`-us`#ToAscii`(int`)^ ToAscii]((b
yte)[%-*@3 c]).&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Returns [^topic`:`/`/Core`/src`/CharSet`$en`-us`#IsUpper`(int`)^ IsUpper]([%-*@3 c
]).&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:IsLower`(wchar`): [@(0.0.255) bool]_[* IsLower]([_^wchar^ wchar]_[*@3 c])&]
[s2;%RU-RU Returns [^topic`:`/`/Core`/src`/CharSet`$en`-us`#IsLower`(int`)^ IsLower]([%-*@3 c
]).&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:ToUpper`(wchar`): [@(0.0.255) int]_[* ToUpper]([_^wchar^ wchar]_[*@3 c])&]
[s2;%RU-RU Returns [^topic`:`/`/Core`/src`/CharSet`$en`-us`#ToUpper`(int`)^ ToUpper]([%-*@3 c
]).&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:ToLower`(wchar`): [@(0.0.255) int]_[* ToLower]([_^wchar^ wchar]_[*@3 c])&]
[s2;%RU-RU Returns [^topic`:`/`/Core`/src`/CharSet`$en`-us`#ToLower`(int`)^ ToLower]([%-*@3 c
]).&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:ToAscii`(wchar`): [@(0.0.255) int]_[* ToAscii]([_^wchar^ wchar]_[*@3 c])&]
[s2;%RU-RU Returns [^topic`:`/`/Core`/src`/CharSet`$en`-us`#ToAscii`(int`)^ ToAscii]([%-*@3 c
]).&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Returns true if [%-*@3 c] is a digit: [%-*@3 c] >`= `'0`' `&`& 
[%-*@3 c] <`= `'9`'.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:IsAlpha`(int`): [@(0.0.255) bool]_[* IsAlpha]([@(0.0.255) int]_[*@3 c])&]
[s2;%RU-RU Returns true if [%-*@3 c].is [*/ ASCII] alphabetic character: 
[%-*@3 c] >`= `'A`' `&`& [%-*@3 c] <`= `'Z`' `|`| [%-*@3 c] >`= `'a`' 
`&`& [%-*@3 c] <`= `'z`'.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:IsAlNum`(int`): [@(0.0.255) bool]_[* IsAlNum]([@(0.0.255) int]_[*@3 c])&]
[s2;%RU-RU Returns true if [%-*@3 c].is either digit or [*/ ASCII ]alphabetic 
character.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:IsLeNum`(int`): [@(0.0.255) bool]_[* IsLeNum]([@(0.0.255) int]_[*@3 c])&]
[s2;%RU-RU Returns true if [%-*@3 c].is either digit or [*/ UNICODE] 
letter < 2048.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:IsPunct`(int`): [@(0.0.255) bool]_[* IsPunct]([@(0.0.255) int]_[*@3 c])&]
[s2;%RU-RU Returns true if: [%-*@3 c] !`= `' `' `&`& !IsAlNum([%-*@3 c]).&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:IsSpace`(int`): [@(0.0.255) bool]_[* IsSpace]([@(0.0.255) int]_[*@3 c])&]
[s2;%RU-RU Returns true [%-*@3 c ]is one of `' `', `'`\f`', `'`\n`', 
`'`\r`', `'`\v`', `'`\t`'.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:IsXDigit`(int`): [@(0.0.255) bool]_[* IsXDigit]([@(0.0.255) int]_[*@3 c])&]
[s2;%RU-RU Returns true [%-*@3 c].is hexadecimal digit (0`-9, a`-f, 
A`-F).&]
[s3;%RU-RU &]
[s4; &]
[s5;:Upp`:`:IsDoubleWidth`(int`): [@(0.0.255) bool]_[* IsDoubleWidth]([@(0.0.255) int]_[*@3 c
])&]
[s2;%RU-RU Returns true if [%-*@3 c] is a double`-width UNICODE character 
(like CJK ideograph).&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Returns UTF`-8 String `'converted`' to basic ASCII. Conversion 
...
[s2;%RU-RU Converts UNICODE array to upper`-case.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:ToLower`(wchar`*`,const wchar`*`,int`): [@(0.0.255) void]_[* ToLower]([_^wchar^ wchar]_
`*[*@3 t], [@(0.0.255) const]_[_^wchar^ wchar]_`*[*@3 s], [@(0.0.255) int]_[*@3 len])&]
[s2;%RU-RU Converts UNICODE array to lower`-case.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
[s5;:ToAscii`(wchar`*`,const wchar`*`,int`): [@(0.0.255) void]_[* ToAscii]([_^wchar^ wchar]_
`*[*@3 t], [@(0.0.255) const]_[_^wchar^ wchar]_`*[*@3 s], [@(0.0.255) int]_[*@3 len])&]
[s2;%RU-RU Converts UNICODE array to basic ASCII (see [^topic`:`/`/Core`/src`/CharSet`$en`-us`#ToAscii`(int`)^ T
oAscii]).&]
[s3;%RU-RU &]
[s4;%RU-RU &]
...
[_^byte^ byte]_[*@3 charset])&]
[s2;%RU-RU Returns true if character [%-*@3 c] encoded using 8`-bit 
[%-*@3 charset] is letter.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
...
[_^byte^ byte]_[*@3 charset])&]
[s2;%RU-RU Converts character [%-*@3 c] encoded using 8`-bit charset 
to upper`-case if it is letter, otherwise returns it unchanged.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
...
[s2; [%RU-RU Converts array ][*@3 s ][%RU-RU of ][*@3 len][%RU-RU  characters 
with encoding ][*@3 charset][%RU-RU  to upper`-case (using ][%RU-RU^topic`:`/`/Core`/src`/CharSet`$en`-us`#IsUpper`(int`,byte`)^ T
oUpper][%RU-RU ). Stores result to ][*@3 t].&]
[s3;%RU-RU &]
[s4;%RU-RU &]
...
char]_`*[*@3 s])&]
[s2;%RU-RU Converts input zero`-terminated UNICODE string.so that 
first letters in each word (letters that are next to whitespace) 
are upper`-case, rest is lower`-case.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
...
[s2;%RU-RU Converts UNICODE string to upper`-case.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
...
har]_`*[*@3 s], [_^byte^ byte]_[*@3 charset]_`=_CHARSET`_DEFAULT)&]
[s2;%RU-RU Converts input zero`-terminated 8`-bit string.encoded 
in charset to basic ASCII by removing diacritical markings. charset 
can be CHARSET`_UTF8.&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Reads stream into UNICODE string, granting optional BOM 
UNICODE mark. If there is no BOM, text is considered to be in 
[%-*@3 def`_charset].&]
[s3;%RU-RU &]
[s4;%RU-RU &]
...
[s2;%RU-RU Reads stream into UNICODE string, granting optional BOM 
UNICODE mark. If there is no BOM, text is considered to be in 
host defined encoding. (e.g. set by linux locale).&]
[s3;%RU-RU &]
[s4; &]
[s5;:LoadStreamBOM`(Stream`&`,byte`): [_^String^ String]_[* LoadStreamBOM]([_^Stream^ Strea
m][@(0.0.255) `&]_[*@3 in], [_^byte^ byte]_[*@3 def`_charset])&]
[s2;%RU-RU [%- Reads stream into 8`-bit string with default encoding, 
granting optional BOM UNICODE mark. If there is no BOM, text 
is considered to be in ][%-*@3 def`_charset] .&]
[s3;%RU-RU &]
[s4;%RU-RU &]
...
optional BOM UNICODE mark. If there is no BOM, text is considered 
to be in ][*@3 def`_charset][%RU-RU  . ]If the file cannot be read, 
returns String`::GetVoid().&]
[s3;%RU-RU &]
[s4;%RU-RU &]
...
ata])&]
[s2;%RU-RU Saves stream in 16`-bit UNICODE format, with BOM header. 
...
[s2; [%RU-RU Saves 8`-bit string in default encoding to the stream.] 
Returns true on success.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
