...
/*  ttgxvar.h                                                              */
/*                                                                         */
/*    TrueType GX Шрифт Variation loader (specification)                    */
/*                                                                         */
/*  Copyright 2004 by                                                      */
...
FT_BEGIN_HEADER
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    Данные from the segment field of `avar' table.                       */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    Данные for interpolating a font from a distortable font specified    */
  ...
  /*                         may happen                                    */
  /*                                                                       */
  /*    normalizedcoords :: A normalized значение (between [-1,1]) indicating */
