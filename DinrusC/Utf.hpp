...
force_inline dword достаньУтф8(const char *&_s, bool nolim, const char *_lim, bool& ok)
{
...
force_inline dword достаньУтф8(const char *&s, const char *lim, bool& ok)
{
	return достаньУтф8(s, false, lim, ok);
}

force_inline dword достаньУтф8(const char *&s, bool& ok)
{
...
force_inline wchar читайСуррогПару(const char16 *s, const char16 *lim)
{
