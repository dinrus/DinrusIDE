...
#define FT_END_HEADER  /* nothing */
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    The following macros are defined to the имя of specific           */
  ...
  /*    }                                                                  */
  /*                                                                       */
  /*    There are several reasons why we are now using macros to имя      */
   ...
   *
   * @description:
   *   A macro used in #include statements to имя the file containing
...
#define FT_CONFIG_OPTIONS_H  <plugin/FT_fontsys/config/ftoption.h>
   ...
   *
   * @description:
   *   A macro used in #include statements to имя the file containing the
...
#define FT_FREETYPE_H  <plugin/FT_fontsys/freetype.h>
   ...
   * @description:
   *   A macro used in #include statements to имя the file containing the
   *   list of FreeType~2 Ошибка codes (and messages).
   *
...
#define FT_ERRORS_H  <plugin/FT_fontsys/fterrors.h>
   ...
   * @description:
   *   A macro used in #include statements to имя the file containing the
   *   list of FreeType~2 module Ошибка offsets (and messages).
   *
   */
...
#define FT_SYSTEM_H  <plugin/FT_fontsys/ftsystem.h>
   ...
   *
   * @description:
   *   A macro used in #include statements to имя the file containing тип
...
#define FT_RENDER_H  <plugin/FT_fontsys/ftrender.h>
   ...
   * @description:
   *   A macro used in #include statements to имя the file containing the
   *   types and API specific to the Type~1 формат.
   *
   */
#define FT_TYPE1_TABLES_H  <plugin/FT_fontsys/t1tables.h>
   ...
   * @description:
   *   A macro used in #include statements to имя the file containing the
   *   enumeration values which identify имя strings, languages, encodings,
...
#define FT_TRUETYPE_IDS_H  <plugin/FT_fontsys/ttnameid.h>
   ...
   * @description:
   *   A macro used in #include statements to имя the file containing the
   *   types and API specific to the TrueType (as well as OpenType) формат.
   *
   */
...
#define FT_MULTIPLE_MASTERS_H  <plugin/FT_fontsys/ftmm.h>
   ...
   * @description:
   *   A macro used in #include statements to имя the file containing the
   *   optional FreeType~2 API which accesses embedded `имя' strings in
   *   SFNT-based font formats (i.e., TrueType and OpenType).
   *
   */
