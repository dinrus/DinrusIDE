...
#define FT_COMPONENT  trace_gloader
  ...
  /*                                                                       */
  /*   loader.base     является really the bottom of the stack.  It describes a  */
  ...
  /*                   image.                                              */
  /*   добавь             добавь the `current' glyph image to the `base' one,    */
                             ...
                             FT_GlyphLoader  source )
  {
    ...
    Ошибка = FT_GlyphLoader_CheckPoints( target, num_points, num_contours );
    if ( !Ошибка )
    {
