...
#include <wxCtrls/defs.h>        // for wxDEFAULT &c
#include <wxCtrls/fontenc.h>     // the font encoding constants
#include <wxCtrls/gdiobj.h>      // the base class
...
// include the real class declaration
    ...
    #include <wxCtrls/palmos/font.h>
#elif defined(__WXMSW__)
    #include <wxCtrls/msw/font.h>
#elif defined(__WXMOTIF__)
    #include <wxCtrls/motif/font.h>
#elif defined(__WXGTK20__)
    #include <wxCtrls/gtk/font.h>
#elif defined(__WXGTK__)
    #include <wxCtrls/gtk1/font.h>
#elif defined(__WXX11__)
    #include <wxCtrls/x11/font.h>
#elif defined(__WXMGL__)
    #include <wxCtrls/mgl/font.h>
#elif defined(__WXDFB__)
    #include <wxCtrls/dfb/font.h>
#elif defined(__WXMAC__)
    #include <wxCtrls/mac/font.h>
#elif defined(__WXCOCOA__)
    #include <wxCtrls/cocoa/font.h>
#elif defined(__WXPM__)
    #include <wxCtrls/os2/font.h>
#endif
