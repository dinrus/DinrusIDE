...
#include <wxCtrls/toolbar.h>
    ...
    #include <wxCtrls/app.h>         // for GetComCtl32Version
    ...
    else // do show icons
    {
        ...
        if ( oldToolBarBitmap )
        {
            ...
            if ( wxApp::GetComCtl32Version() >= 400 )
            {
                ...
                replaceBitmap.nIDOld = (UINT)(WXLPARAM) oldToolBarBitmap;
                replaceBitmap.nIDNew = (UINT)(WXLPARAM) hBitmap;
        ...
        if ( addBitmap ) // no old bitmap or we can't replace it
        {
            ...
            addBitmap.hInst = 0;
            addBitmap.nID = (UINT)(WXLPARAM) hBitmap;
        ...
        switch ( tool->GetStyle() )
        {
            ...
            case wxTOOL_STYLE_BUTTON:
                ...
                if ( HasFlag(wxTB_TEXT) )
                {
                    ...
                    if ( !label.empty() )
                        button.iString = (int)(WXLPARAM)label.c_str();
                }
