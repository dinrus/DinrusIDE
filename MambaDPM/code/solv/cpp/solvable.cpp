...
namespace mamba::solv
{
    ...
    {
        return aux::ptr_to_strview(::solvable_lookup_str(const_cast<::Solvable*>(raw()), SOLVABLE_NAME));
    }
    ...
    {
        return aux::ptr_to_strview(::solvable_lookup_str(const_cast<::Solvable*>(raw()), SOLVABLE_EVR));
    }
...
namespace mamba::solv
{
    auto ObjSolvableViewConst::build_number() const -> std::size_t
    {
        return to_int_or<std::size_t>(
            aux::ptr_to_strview(::solvable_lookup_str(const_cast<::Solvable*>(raw()), SOLVABLE_BUILDVERSION)
            ),
            0
        );
    }
    ...
    {
        return aux::ptr_to_strview(::solvable_lookup_str(const_cast<::Solvable*>(raw()), SOLVABLE_MEDIAFILE)
        );
    }
    ...
    {
        return aux::ptr_to_strview(::solvable_lookup_str(const_cast<::Solvable*>(raw()), SOLVABLE_LICENSE));
    }
    ...
    auto ObjSolvableViewConst::md5() const -> std::string_view
    {
        ...
        return aux::ptr_to_strview(hash);
    }
    ...
    {
        return aux::ptr_to_strview(::solvable_lookup_str(const_cast<::Solvable*>(raw()), SOLVABLE_URL));
    }
    ...
    {
        return aux::ptr_to_strview(::solvable_lookup_str(const_cast<::Solvable*>(raw()), SOLVABLE_PACKAGER)
        );
    }
    ...
    {
        return aux::ptr_to_strview(::solvable_lookup_str(const_cast<::Solvable*>(raw()), SOLVABLE_MEDIADIR)
        );
    }
    ...
    {
        raw()->requires_ = ::repo_addid_dep(raw()->repo, raw()->requires_, dep, marker);
    }
